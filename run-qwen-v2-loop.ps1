...
param(
  ...
  [ValidateSet("sql-basics", "nosql-basics", "cli-git", "node-basics", "api-basics")][string]$CourseId = "sql-basics",
  [string]$ProjectId = "",
...
$promptFile = if ($CourseId -eq "cli-git") { Join-Path $repo "QWEN_CLI_GIT_AUTHORING_PROMPT.md" } elseif ($CourseId -eq "node-basics") { Join-Path $repo "QWEN_NODE_AUTHORING_PROMPT.md" } elseif ($CourseId -eq "api-basics") { Join-Path $repo "QWEN_API_AUTHORING_PROMPT.md" } else { Join-Path $repo "QWEN_V2_AUTHORING_PROMPT.md" }
...
const isLocal = ["cli-git", "node-basics", "api-basics"].includes(courseId);
if (!["sql-basics", "nosql-basics", "cli-git", "node-basics", "api-basics"].includes(courseId)) throw Error("Unknown course.");
