...
const references = {
  ...
  "computer-shop-1": { estimatedMinutes: 4, solution: js("const greeting = \"Welcome to CodeCraft\";\n") },
  "computer-shop-2": { estimatedMinutes: 4, solution: js("const greeting = \"Welcome to CodeCraft\";\nfunction greet() {\n  return greeting;\n}\n") },
  "computer-shop-3": { estimatedMinutes: 4, solution: js("const greeting = \"Welcome to CodeCraft\";\nfunction greet() {\n  return greeting;\n}\nconst welcome = greet();\n") },
  "computer-shop-4": { estimatedMinutes: 4, solution: js("const greeting = \"Welcome to CodeCraft\";\nfunction greet() {\n  return greeting;\n}\nconst welcome = greet();\nconst shout = welcome.toUpperCase();\n") },
  "computer-shop-5": { estimatedMinutes: 4, solution: js("const greeting = \"Welcome to CodeCraft\";\nfunction greet() {\n  return greeting;\n}\nconst welcome = greet();\nconst shout = welcome.toUpperCase();\nconsole.log(shout);\n") },
  "fiesta-committee-1": { estimatedMinutes: 4, solution: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\n") },
  "fiesta-committee-2": { estimatedMinutes: 4, solution: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\nconst first = greetPerson(\"Juan\");\n") },
  "fiesta-committee-3": { estimatedMinutes: 4, solution: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\nconst first = greetPerson(\"Juan\");\nconst second = greetPerson(\"Maria\");\n") },
  "fiesta-committee-4": { estimatedMinutes: 4, solution: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\nconst first = greetPerson(\"Juan\");\nconst second = greetPerson(\"Maria\");\nconst both = first + \" and \" + second;\n") },
  "fiesta-committee-5": { estimatedMinutes: 4, solution: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\nconst first = greetPerson(\"Juan\");\nconst second = greetPerson(\"Maria\");\nconst both = first + \" and \" + second;\nconsole.log(both);\n") },
  "rice-retailer-1": { estimatedMinutes: 4, solution: js("const service = \"rice delivery\";\n") },
  "rice-retailer-2": { estimatedMinutes: 4, solution: js("const service = \"rice delivery\";\nconst label = (text) => \"Service: \" + text;\n") },
  "rice-retailer-3": { estimatedMinutes: 4, solution: js("const service = \"rice delivery\";\nconst label = (text) => \"Service: \" + text;\nconst labelled = label(service);\n") },
  "rice-retailer-4": { estimatedMinutes: 4, solution: js("const service = \"rice delivery\";\nconst label = (text) => \"Service: \" + text;\nconst labelled = label(service);\nconst short = labelled.length;\n") },
  "rice-retailer-5": { estimatedMinutes: 4, solution: js("const service = \"rice delivery\";\nconst label = (text) => \"Service: \" + text;\nconst labelled = label(service);\nconst short = labelled.length;\nconsole.log(labelled);\n") },
  "laundry-shop-1": { estimatedMinutes: 4, solution: js("function deskName(name = \"Front desk\") {\n  return name;\n}\n") },
  "laundry-shop-2": { estimatedMinutes: 4, solution: js("function deskName(name = \"Front desk\") {\n  return name;\n}\nconst fallback = deskName();\n") },
  "laundry-shop-3": { estimatedMinutes: 4, solution: js("function deskName(name = \"Front desk\") {\n  return name;\n}\nconst fallback = deskName();\nconst named = deskName(\"Front Desk\");\n") },
  "laundry-shop-4": { estimatedMinutes: 4, solution: js("function deskName(name = \"Front desk\") {\n  return name;\n}\nconst fallback = deskName();\nconst named = deskName(\"Front Desk\");\nconst both = fallback + \" / \" + named;\n") },
  "laundry-shop-5": { estimatedMinutes: 4, solution: js("function deskName(name = \"Front desk\") {\n  return name;\n}\nconst fallback = deskName();\nconst named = deskName(\"Front Desk\");\nconst both = fallback + \" / \" + named;\nconsole.log(both);\n") },
  "pharmacy-counter-1": { estimatedMinutes: 4, solution: js("const item = \"Medicine\";\n") },
  "pharmacy-counter-2": { estimatedMinutes: 4, solution: js("const item = \"Medicine\";\nconst price = 50;\n") },
  "pharmacy-counter-3": { estimatedMinutes: 4, solution: js("const item = \"Medicine\";\nconst price = 50;\nconst line = `${item} costs PHP ${price}`;\n") },
  "pharmacy-counter-4": { estimatedMinutes: 4, solution: js("const item = \"Medicine\";\nconst price = 50;\nconst line = `${item} costs PHP ${price}`;\nconst shout = line.toUpperCase();\n") },
  "pharmacy-counter-5": { estimatedMinutes: 4, solution: js("const item = \"Medicine\";\nconst price = 50;\nconst line = `${item} costs PHP ${price}`;\nconst shout = line.toUpperCase();\nconsole.log(line);\n") },
  "barangay-id-1": { estimatedMinutes: 4, solution: js("const queue = [\"Juan\", \"Maria\", \"Jose\"];\n") },
  "barangay-id-2": { estimatedMinutes: 4, solution: js("const queue = [\"Juan\", \"Maria\", \"Jose\"];\nconst [firstUp, secondUp] = queue;\n") },
  "barangay-id-3": { estimatedMinutes: 4, solution: js("const queue = [\"Juan\", \"Maria\", \"Jose\"];\nconst [firstUp, secondUp] = queue;\nconst waiting = queue.length - 2;\n") },
  "barangay-id-4": { estimatedMinutes: 4, solution: js("const queue = [\"Juan\", \"Maria\", \"Jose\"];\nconst [firstUp, secondUp] = queue;\nconst waiting = queue.length - 2;\nconst callNext = `Now serving ${firstUp}, then ${secondUp}`;\n") },
  "barangay-id-5": { estimatedMinutes: 4, solution: js("const queue = [\"Juan\", \"Maria\", \"Jose\"];\nconst [firstUp, secondUp] = queue;\nconst waiting = queue.length - 2;\nconst callNext = `Now serving ${firstUp}, then ${secondUp}`;\nconsole.log(callNext);\n") },
  "relief-goods-1": { estimatedMinutes: 4, solution: js("const office = { name: \"Sampaguita\", phone: \"09175550101\" };\n") },
  "relief-goods-2": { estimatedMinutes: 4, solution: js("const office = { name: \"Sampaguita\", phone: \"09175550101\" };\nconst { name, phone } = office;\n") },
  "relief-goods-3": { estimatedMinutes: 4, solution: js("const office = { name: \"Sampaguita\", phone: \"09175550101\" };\nconst { name, phone } = office;\nconst contact = `${name}: ${phone}`;\n") },
  "relief-goods-4": { estimatedMinutes: 4, solution: js("const office = { name: \"Sampaguita\", phone: \"09175550101\" };\nconst { name, phone } = office;\nconst contact = `${name}: ${phone}`;\nconst digits = phone.replace(/ /g, \"\");\n") },
  "relief-goods-5": { estimatedMinutes: 4, solution: js("const office = { name: \"Sampaguita\", phone: \"09175550101\" };\nconst { name, phone } = office;\nconst contact = `${name}: ${phone}`;\nconst digits = phone.replace(/ /g, \"\");\nconsole.log(contact);\n") },
  "barangay-help-1": { estimatedMinutes: 4, solution: js("const boxA = [\"food\"];\n") },
  "barangay-help-2": { estimatedMinutes: 4, solution: js("const boxA = [\"food\"];\nconst boxB = [\"water\"];\n") },
  "barangay-help-3": { estimatedMinutes: 4, solution: js("const boxA = [\"food\"];\nconst boxB = [\"water\"];\nconst combined = [...boxA, ...boxB];\n") },
  "barangay-help-4": { estimatedMinutes: 4, solution: js("const boxA = [\"food\"];\nconst boxB = [\"water\"];\nconst combined = [...boxA, ...boxB];\nconst count = combined.length;\n") },
  "barangay-help-5": { estimatedMinutes: 4, solution: js("const boxA = [\"food\"];\nconst boxB = [\"water\"];\nconst combined = [...boxA, ...boxB];\nconst count = combined.length;\nconsole.log(count);\n") },
  "sari-sari-1": { estimatedMinutes: 4, solution: js("function addAll(...amounts) {\n  return amounts.length;\n}\n") },
  "sari-sari-2": { estimatedMinutes: 4, solution: js("function addAll(...amounts) {\n  return amounts.length;\n}\nconst two = addAll(5, 7);\n") },
  "sari-sari-3": { estimatedMinutes: 4, solution: js("function addAll(...amounts) {\n  return amounts.length;\n}\nconst two = addAll(5, 7);\nconst three = addAll(5, 7, 5);\n") },
  "sari-sari-4": { estimatedMinutes: 4, solution: js("function addAll(...amounts) {\n  return amounts.length;\n}\nconst two = addAll(5, 7);\nconst three = addAll(5, 7, 5);\nconst grew = three - two;\n") },
  "sari-sari-5": { estimatedMinutes: 4, solution: js("function addAll(...amounts) {\n  return amounts.length;\n}\nconst two = addAll(5, 7);\nconst three = addAll(5, 7, 5);\nconst grew = three - two;\nconsole.log(three);\n") },
  "palengke-stall-1": { estimatedMinutes: 4, solution: js("const raw = \"Pangunahing Barangay\";\n") },
  "palengke-stall-2": { estimatedMinutes: 4, solution: js("const raw = \"Pangunahing Barangay\";\nlet status = \"\";\ntry {\n  status = raw.toUpperCase();\n} catch (error) {\n  status = \"unreadable\";\n}\n") },
  "palengke-stall-3": { estimatedMinutes: 4, solution: js("const raw = \"Pangunahing Barangay\";\nlet status = \"\";\ntry {\n  status = raw.toUpperCase();\n} catch (error) {\n  status = \"unreadable\";\n}\nconst worked = status !== \"unreadable\";\n") },
  "palengke-stall-4": { estimatedMinutes: 4, solution: js("const raw = \"Pangunahing Barangay\";\nlet status = \"\";\ntry {\n  status = raw.toUpperCase();\n} catch (error) {\n  status = \"unreadable\";\n}\nconst worked = status !== \"unreadable\";\nconst report = `Record ${status} read: ${worked}`;\n") },
  "palengke-stall-5": { estimatedMinutes: 4, solution: js("const raw = \"Pangunahing Barangay\";\nlet status = \"\";\ntry {\n  status = raw.toUpperCase();\n} catch (error) {\n  status = \"unreadable\";\n}\nconst worked = status !== \"unreadable\";\nconst report = `Record ${status} read: ${worked}`;\nconsole.log(report);\n") },
  "jeepney-terminal-1": { estimatedMinutes: 4, solution: js("function checkAge(age) {\n  if (age < 0) {\n    throw new Error(\"Age cannot be negative\");\n  }\n  return age;\n}\n") },
  "jeepney-terminal-2": { estimatedMinutes: 4, solution: js("function checkAge(age) {\n  if (age < 0) {\n    throw new Error(\"Age cannot be negative\");\n  }\n  return age;\n}\nconst good = checkAge(7);\n") },
  "jeepney-terminal-3": { estimatedMinutes: 4, solution: js("function checkAge(age) {\n  if (age < 0) {\n    throw new Error(\"Age cannot be negative\");\n  }\n  return age;\n}\nconst good = checkAge(7);\nlet message = \"\";\ntry {\n  checkAge(-1);\n} catch (error) {\n  message = error.message;\n}\n") },
  "jeepney-terminal-4": { estimatedMinutes: 4, solution: js("function checkAge(age) {\n  if (age < 0) {\n    throw new Error(\"Age cannot be negative\");\n  }\n  return age;\n}\nconst good = checkAge(7);\nlet message = \"\";\ntry {\n  checkAge(-1);\n} catch (error) {\n  message = error.message;\n}\nconst summary = `Checked ${good}, refused: ${message}`;\n") },
  "jeepney-terminal-5": { estimatedMinutes: 4, solution: js("function checkAge(age) {\n  if (age < 0) {\n    throw new Error(\"Age cannot be negative\");\n  }\n  return age;\n}\nconst good = checkAge(7);\nlet message = \"\";\ntry {\n  checkAge(-1);\n} catch (error) {\n  message = error.message;\n}\nconst summary = `Checked ${good}, refused: ${message}`;\nconsole.log(summary);\n") },
  "turo-turo-1": { estimatedMinutes: 4, solution: js("class Resident {\n  constructor(name, age) {\n    this.name = name;\n    this.age = age;\n  }\n}\n") },
  "turo-turo-2": { estimatedMinutes: 4, solution: js("class Resident {\n  constructor(name, age) {\n    this.name = name;\n    this.age = age;\n  }\n}\nconst one = new Resident(\"John\", 35);\n") },
  "turo-turo-3": { estimatedMinutes: 4, solution: js("class Resident {\n  constructor(name, age) {\n    this.name = name;\n    this.age = age;\n  }\n}\nconst one = new Resident(\"John\", 35);\nconst years = one.age;\n") },
  "turo-turo-4": { estimatedMinutes: 4, solution: js("class Resident {\n  constructor(name, age) {\n    this.name = name;\n    this.age = age;\n  }\n}\nconst one = new Resident(\"John\", 35);\nconst years = one.age;\nconst line = `${one.name} is ${years}`;\n") },
  "turo-turo-5": { estimatedMinutes: 4, solution: js("class Resident {\n  constructor(name, age) {\n    this.name = name;\n    this.age = age;\n  }\n}\nconst one = new Resident(\"John\", 35);\nconst years = one.age;\nconst line = `${one.name} is ${years}`;\nconsole.log(line);\n") },
  "barangay-health-1": { estimatedMinutes: 4, solution: js("class Desk {\n  constructor(name) {\n    this.name = name;\n  }\n  label() {\n    return \"Desk: \" + this.name;\n  }\n}\n") },
  "barangay-health-2": { estimatedMinutes: 4, solution: js("class Desk {\n  constructor(name) {\n    this.name = name;\n  }\n  label() {\n    return \"Desk: \" + this.name;\n  }\n}\nconst desk = new Desk(\"Village Aid\");\n") },
  "barangay-health-3": { estimatedMinutes: 4, solution: js("class Desk {\n  constructor(name) {\n    this.name = name;\n  }\n  label() {\n    return \"Desk: \" + this.name;\n  }\n}\nconst desk = new Desk(\"Village Aid\");\nconst labelled = desk.label();\n") },
  "barangay-health-4": { estimatedMinutes: 4, solution: js("class Desk {\n  constructor(name) {\n    this.name = name;\n  }\n  label() {\n    return \"Desk: \" + this.name;\n  }\n}\nconst desk = new Desk(\"Village Aid\");\nconst labelled = desk.label();\nconst shout = labelled.toUpperCase();\n") },
  "barangay-health-5": { estimatedMinutes: 4, solution: js("class Desk {\n  constructor(name) {\n    this.name = name;\n  }\n  label() {\n    return \"Desk: \" + this.name;\n  }\n}\nconst desk = new Desk(\"Village Aid\");\nconst labelled = desk.label();\nconst shout = labelled.toUpperCase();\nconsole.log(labelled);\n") },
  "school-registration-1": { estimatedMinutes: 4, solution: js("const record = { office: \"Barangay Center\", queue: 35 };\n") },
  "school-registration-2": { estimatedMinutes: 4, solution: js("const record = { office: \"Barangay Center\", queue: 35 };\nconst text = JSON.stringify(record);\n") },
  "school-registration-3": { estimatedMinutes: 4, solution: js("const record = { office: \"Barangay Center\", queue: 35 };\nconst text = JSON.stringify(record);\nconst back = JSON.parse(text);\n") },
  "school-registration-4": { estimatedMinutes: 4, solution: js("const record = { office: \"Barangay Center\", queue: 35 };\nconst text = JSON.stringify(record);\nconst back = JSON.parse(text);\nconst same = back.queue === record.queue;\n") },
  "school-registration-5": { estimatedMinutes: 4, solution: js("const record = { office: \"Barangay Center\", queue: 35 };\nconst text = JSON.stringify(record);\nconst back = JSON.parse(text);\nconst same = back.queue === record.queue;\nconsole.log(text);\n") },
  "tricycle-queue-1": { estimatedMinutes: 4, solution: js("const signups = [\"Jorge\", \"Maria\", \"Jorge\"];\n") },
  "tricycle-queue-2": { estimatedMinutes: 4, solution: js("const signups = [\"Jorge\", \"Maria\", \"Jorge\"];\nconst unique = new Set(signups);\n") },
  "tricycle-queue-3": { estimatedMinutes: 4, solution: js("const signups = [\"Jorge\", \"Maria\", \"Jorge\"];\nconst unique = new Set(signups);\nconst count = unique.size;\n") },
  "tricycle-queue-4": { estimatedMinutes: 4, solution: js("const signups = [\"Jorge\", \"Maria\", \"Jorge\"];\nconst unique = new Set(signups);\nconst count = unique.size;\nconst names = [...unique];\n") },
  "tricycle-queue-5": { estimatedMinutes: 4, solution: js("const signups = [\"Jorge\", \"Maria\", \"Jorge\"];\nconst unique = new Set(signups);\nconst count = unique.size;\nconst names = [...unique];\nconsole.log(count);\n") },
  "bakery-counter-1": { estimatedMinutes: 4, solution: js("const greeting = \"Welcome to Sweet Bakery!\";\n") },
  "bakery-counter-2": { estimatedMinutes: 4, solution: js("const greeting = \"Welcome to Sweet Bakery!\";\nfunction greet() {\n  return greeting;\n}\n") },
  "bakery-counter-3": { estimatedMinutes: 4, solution: js("const greeting = \"Welcome to Sweet Bakery!\";\nfunction greet() {\n  return greeting;\n}\nconst welcome = greet();\n") },
  "bakery-counter-4": { estimatedMinutes: 4, solution: js("const greeting = \"Welcome to Sweet Bakery!\";\nfunction greet() {\n  return greeting;\n}\nconst welcome = greet();\nconst shout = welcome.toUpperCase();\n") },
  "bakery-counter-5": { estimatedMinutes: 4, solution: js("const greeting = \"Welcome to Sweet Bakery!\";\nfunction greet() {\n  return greeting;\n}\nconst welcome = greet();\nconst shout = welcome.toUpperCase();\nconsole.log(shout);\n") },
  "water-refill-1": { estimatedMinutes: 4, solution: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\n") },
  "water-refill-2": { estimatedMinutes: 4, solution: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\nconst first = greetPerson(\"John\");\n") },
  "water-refill-3": { estimatedMinutes: 4, solution: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\nconst first = greetPerson(\"John\");\nconst second = greetPerson(\"Alice\");\n") },
  "water-refill-4": { estimatedMinutes: 4, solution: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\nconst first = greetPerson(\"John\");\nconst second = greetPerson(\"Alice\");\nconst both = first + \" and \" + second;\n") },
  "water-refill-5": { estimatedMinutes: 4, solution: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\nconst first = greetPerson(\"John\");\nconst second = greetPerson(\"Alice\");\nconst both = first + \" and \" + second;\nconsole.log(both);\n") },
  "barangay-clean-1": { estimatedMinutes: 4, solution: js("const service = \"Barangay Clean-Up\";\n") },
  "barangay-clean-2": { estimatedMinutes: 4, solution: js("const service = \"Barangay Clean-Up\";\nconst label = (text) => \"Service: \" + text;\n") },
  "barangay-clean-3": { estimatedMinutes: 4, solution: js("const service = \"Barangay Clean-Up\";\nconst label = (text) => \"Service: \" + text;\nconst labelled = label(service);\n") },
  "barangay-clean-4": { estimatedMinutes: 4, solution: js("const service = \"Barangay Clean-Up\";\nconst label = (text) => \"Service: \" + text;\nconst labelled = label(service);\nconst short = labelled.length;\n") },
  "barangay-clean-5": { estimatedMinutes: 4, solution: js("const service = \"Barangay Clean-Up\";\nconst label = (text) => \"Service: \" + text;\nconst labelled = label(service);\nconst short = labelled.length;\nconsole.log(labelled);\n") },
  "default-parameters-1": { estimatedMinutes: 4, solution: js("function deskName(name = \"Front desk\") {\n  return name;\n}\n") },
  "default-parameters-2": { estimatedMinutes: 4, solution: js("function deskName(name = \"Front desk\") {\n  return name;\n}\nconst fallback = deskName();\n") },
  "default-parameters-3": { estimatedMinutes: 4, solution: js("function deskName(name = \"Front desk\") {\n  return name;\n}\nconst fallback = deskName();\nconst named = deskName(\"Help Desk\");\n") },
  "default-parameters-4": { estimatedMinutes: 4, solution: js("function deskName(name = \"Front desk\") {\n  return name;\n}\nconst fallback = deskName();\nconst named = deskName(\"Help Desk\");\nconst both = fallback + \" / \" + named;\n") },
  "default-parameters-5": { estimatedMinutes: 4, solution: js("function deskName(name = \"Front desk\") {\n  return name;\n}\nconst fallback = deskName();\nconst named = deskName(\"Help Desk\");\nconst both = fallback + \" / \" + named;\nconsole.log(both);\n") },
  "template-literal-1": { estimatedMinutes: 4, solution: js("const item = \"leche flan\";\n") },
  "template-literal-2": { estimatedMinutes: 4, solution: js("const item = \"leche flan\";\nconst price = 50;\n") },
  "template-literal-3": { estimatedMinutes: 4, solution: js("const item = \"leche flan\";\nconst price = 50;\nconst line = `${item} costs PHP ${price}`;\n") },
  "template-literal-4": { estimatedMinutes: 4, solution: js("const item = \"leche flan\";\nconst price = 50;\nconst line = `${item} costs PHP ${price}`;\nconst shout = line.toUpperCase();\n") },
  "template-literal-5": { estimatedMinutes: 4, solution: js("const item = \"leche flan\";\nconst price = 50;\nconst line = `${item} costs PHP ${price}`;\nconst shout = line.toUpperCase();\nconsole.log(line);\n") },
  "destructuring-array-1": { estimatedMinutes: 4, solution: js("const queue = [\"John\", \"Jane\", \"Alice\"];\n") },
  "destructuring-array-2": { estimatedMinutes: 4, solution: js("const queue = [\"John\", \"Jane\", \"Alice\"];\nconst [firstUp, secondUp] = queue;\n") },
  "destructuring-array-3": { estimatedMinutes: 4, solution: js("const queue = [\"John\", \"Jane\", \"Alice\"];\nconst [firstUp, secondUp] = queue;\nconst waiting = queue.length - 2;\n") },
  "destructuring-array-4": { estimatedMinutes: 4, solution: js("const queue = [\"John\", \"Jane\", \"Alice\"];\nconst [firstUp, secondUp] = queue;\nconst waiting = queue.length - 2;\nconst callNext = `Now serving ${firstUp}, then ${secondUp}`;\n") },
  "destructuring-array-5": { estimatedMinutes: 4, solution: js("const queue = [\"John\", \"Jane\", \"Alice\"];\nconst [firstUp, secondUp] = queue;\nconst waiting = queue.length - 2;\nconst callNext = `Now serving ${firstUp}, then ${secondUp}`;\nconsole.log(callNext);\n") },
  "destructuring-object-1": { estimatedMinutes: 4, solution: js("const office = { name: \"Barangay Central\", phone: \"09175550101\" };\n") },
  "destructuring-object-2": { estimatedMinutes: 4, solution: js("const office = { name: \"Barangay Central\", phone: \"09175550101\" };\nconst { name, phone } = office;\n") },
  "destructuring-object-3": { estimatedMinutes: 4, solution: js("const office = { name: \"Barangay Central\", phone: \"09175550101\" };\nconst { name, phone } = office;\nconst contact = `${name}: ${phone}`;\n") },
  "destructuring-object-4": { estimatedMinutes: 4, solution: js("const office = { name: \"Barangay Central\", phone: \"09175550101\" };\nconst { name, phone } = office;\nconst contact = `${name}: ${phone}`;\nconst digits = phone.replace(/ /g, \"\");\n") },
  "destructuring-object-5": { estimatedMinutes: 4, solution: js("const office = { name: \"Barangay Central\", phone: \"09175550101\" };\nconst { name, phone } = office;\nconst contact = `${name}: ${phone}`;\nconst digits = phone.replace(/ /g, \"\");\nconsole.log(contact);\n") },
  "spread-array-1": { estimatedMinutes: 4, solution: js("const boxA = [\"Aspirin\"];\n") },
  "spread-array-2": { estimatedMinutes: 4, solution: js("const boxA = [\"Aspirin\"];\nconst boxB = [\"Paracetamol\"];\n") },
  "spread-array-3": { estimatedMinutes: 4, solution: js("const boxA = [\"Aspirin\"];\nconst boxB = [\"Paracetamol\"];\nconst combined = [...boxA, ...boxB];\n") },
  "spread-array-4": { estimatedMinutes: 4, solution: js("const boxA = [\"Aspirin\"];\nconst boxB = [\"Paracetamol\"];\nconst combined = [...boxA, ...boxB];\nconst count = combined.length;\n") },
  "spread-array-5": { estimatedMinutes: 4, solution: js("const boxA = [\"Aspirin\"];\nconst boxB = [\"Paracetamol\"];\nconst combined = [...boxA, ...boxB];\nconst count = combined.length;\nconsole.log(count);\n") },
  "id-desk-1": { estimatedMinutes: 4, solution: js("function addAll(...amounts) {\n  return amounts.length;\n}\n") },
  "id-desk-2": { estimatedMinutes: 4, solution: js("function addAll(...amounts) {\n  return amounts.length;\n}\nconst two = addAll(23, 45);\n") },
  "id-desk-3": { estimatedMinutes: 4, solution: js("function addAll(...amounts) {\n  return amounts.length;\n}\nconst two = addAll(23, 45);\nconst three = addAll(23, 45, 23);\n") },
  "id-desk-4": { estimatedMinutes: 4, solution: js("function addAll(...amounts) {\n  return amounts.length;\n}\nconst two = addAll(23, 45);\nconst three = addAll(23, 45, 23);\nconst grew = three - two;\n") },
  "id-desk-5": { estimatedMinutes: 4, solution: js("function addAll(...amounts) {\n  return amounts.length;\n}\nconst two = addAll(23, 45);\nconst three = addAll(23, 45, 23);\nconst grew = three - two;\nconsole.log(three);\n") },
...
/* js-topic: function-declaration */
const PROJECT_85_ID = "computer-shop";
/* js-topic: function-parameters */
const PROJECT_86_ID = "fiesta-committee";
/* js-topic: arrow-function */
const PROJECT_87_ID = "rice-retailer";
/* js-topic: default-parameters */
const PROJECT_88_ID = "laundry-shop";
/* js-topic: template-literal */
const PROJECT_89_ID = "pharmacy-counter";
/* js-topic: destructuring-array */
const PROJECT_90_ID = "barangay-id";
/* js-topic: destructuring-object */
const PROJECT_91_ID = "relief-goods";
/* js-topic: spread-array */
const PROJECT_92_ID = "barangay-help";
/* js-topic: rest-parameters */
const PROJECT_93_ID = "sari-sari";
/* js-topic: try-catch */
const PROJECT_94_ID = "palengke-stall";
/* js-topic: throw-error */
const PROJECT_95_ID = "jeepney-terminal";
/* js-topic: class-basics */
const PROJECT_96_ID = "turo-turo";
/* js-topic: class-method */
const PROJECT_97_ID = "barangay-health";
/* js-topic: json */
const PROJECT_98_ID = "school-registration";
/* js-topic: set-unique */
const PROJECT_99_ID = "tricycle-queue";
/* js-topic: function-declaration */
const PROJECT_100_ID = "bakery-counter";
/* js-topic: function-parameters */
const PROJECT_101_ID = "water-refill";
/* js-topic: arrow-function */
const PROJECT_102_ID = "barangay-clean";
/* js-topic: default-parameters */
const PROJECT_103_ID = "computer-shop-default-parameters";
/* js-topic: template-literal */
const PROJECT_104_ID = "fiesta-committee-template-literal";
/* js-topic: destructuring-array */
const PROJECT_105_ID = "rice-retailer-destructuring-array";
/* js-topic: destructuring-object */
const PROJECT_106_ID = "laundry-shop-destructuring-object";
/* js-topic: spread-array */
const PROJECT_107_ID = "pharmacy-counter-spread-array";
/* js-topic: rest-parameters */
const PROJECT_108_ID = "barangay-id-desk";
...
const s85 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_85_ID }; };

const s86 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_86_ID }; };

const s87 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_87_ID }; };

const s88 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_88_ID }; };

const s89 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_89_ID }; };

const s90 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_90_ID }; };

const s91 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_91_ID }; };

const s92 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_92_ID }; };

const s93 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_93_ID }; };

const s94 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_94_ID }; };

const s95 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_95_ID }; };

const s96 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_96_ID }; };

const s97 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_97_ID }; };

const s98 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_98_ID }; };

const s99 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_99_ID }; };

const s100 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_100_ID }; };

const s101 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_101_ID }; };

const s102 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_102_ID }; };

const s103 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_103_ID }; };

const s104 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_104_ID }; };

const s105 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_105_ID }; };

const s106 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_106_ID }; };

const s107 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_107_ID }; };

const s108 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for JS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "js", projectId: PROJECT_108_ID }; };
...
export const jsCourse: Course = {
  ...
  steps: [
    ...
    s85({ id: "computer-shop-1", task: "Store the greeting Welcome to CodeCraft.", inputMode: "guided", files: js("const greeting = ;\n"), activeFile: "script.js", highlightToken: "const greeting = ;", tests: [{ id: "computer-shop-1-check", label: "greeting is Welcome to CodeCraft", kind: "js-value", expression: "greeting", equals: "Welcome to CodeCraft" }], hints: [{ level: 1, text: "Put the words in quotes after the equals sign." }, { level: 2, text: "Write \"Welcome to CodeCraft\" after the equals sign." }], xp: 50 }),
    s85({ id: "computer-shop-2", task: "Make the function hand back the greeting.", inputMode: "guided", files: js("const greeting = \"Welcome to CodeCraft\";\nfunction greet() {\n  return ;\n}\n"), activeFile: "script.js", highlightToken: "return ;", tests: [{ id: "computer-shop-2-check", label: "greet() gives back Welcome to CodeCraft", kind: "js-returns", fn: "greet", args: [], equals: "Welcome to CodeCraft" }], hints: [{ level: 1, text: "A function hands a value back with return." }, { level: 2, text: "Write greeting after return." }], xp: 50 }),
    s85({ id: "computer-shop-3", task: "Call the function and keep what it gives back.", inputMode: "guided", files: js("const greeting = \"Welcome to CodeCraft\";\nfunction greet() {\n  return greeting;\n}\nconst welcome = ;\n"), activeFile: "script.js", highlightToken: "const welcome = ;", tests: [{ id: "computer-shop-3-check", label: "welcome is Welcome to CodeCraft", kind: "js-value", expression: "welcome", equals: "Welcome to CodeCraft" }], hints: [{ level: 1, text: "Write the function name followed by round brackets." }, { level: 2, text: "Write greet() after the equals sign." }], xp: 50 }),
    s85({ id: "computer-shop-4", task: "Make a loud version of the greeting.", inputMode: "guided", files: js("const greeting = \"Welcome to CodeCraft\";\nfunction greet() {\n  return greeting;\n}\nconst welcome = greet();\nconst shout = ;\n"), activeFile: "script.js", highlightToken: "const shout = ;", tests: [{ id: "computer-shop-4-check", label: "shout is WELCOME TO CODECRAFT", kind: "js-value", expression: "shout", equals: "WELCOME TO CODECRAFT" }], hints: [{ level: 1, text: "Use the string method that returns capitals." }, { level: 2, text: "Write welcome.toUpperCase() after the equals sign." }], xp: 50 }),
    s85({ id: "computer-shop-5", task: "Print the loud greeting.", inputMode: "guided", files: js("const greeting = \"Welcome to CodeCraft\";\nfunction greet() {\n  return greeting;\n}\nconst welcome = greet();\nconst shout = welcome.toUpperCase();\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "computer-shop-5-check", label: "It prints WELCOME TO CODECRAFT", kind: "js-logs", values: ["WELCOME TO CODECRAFT"] }], hints: [{ level: 1, text: "Put shout inside console.log." }, { level: 2, text: "Write console.log(shout);" }], xp: 40 }),
    s86({ id: "fiesta-committee-1", task: "Make the function greet whoever it is given.", inputMode: "guided", files: js("function greetPerson(name) {\n  return ;\n}\n"), activeFile: "script.js", highlightToken: "return ;", tests: [{ id: "fiesta-committee-1-check", label: "greetPerson() gives back Hello, Juan", kind: "js-returns", fn: "greetPerson", args: ["Juan"], equals: "Hello, Juan" }], hints: [{ level: 1, text: "Join the fixed words to the name it was handed." }, { level: 2, text: "Write \"Hello, \" + name after return." }], xp: 50 }),
    s86({ id: "fiesta-committee-2", task: "Greet Juan.", inputMode: "guided", files: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\nconst first = ;\n"), activeFile: "script.js", highlightToken: "const first = ;", tests: [{ id: "fiesta-committee-2-check", label: "first is Hello, Juan", kind: "js-value", expression: "first", equals: "Hello, Juan" }], hints: [{ level: 1, text: "Put the name in quotes inside the brackets." }, { level: 2, text: "Write greetPerson(\"Juan\") after the equals sign." }], xp: 50 }),
    s86({ id: "fiesta-committee-3", task: "Greet Maria with the same function.", inputMode: "guided", files: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\nconst first = greetPerson(\"Juan\");\nconst second = ;\n"), activeFile: "script.js", highlightToken: "const second = ;", tests: [{ id: "fiesta-committee-3-check", label: "second is Hello, Maria", kind: "js-value", expression: "second", equals: "Hello, Maria" }], hints: [{ level: 1, text: "Call it again with a different name." }, { level: 2, text: "Write greetPerson(\"Maria\") after the equals sign." }], xp: 50 }),
    s86({ id: "fiesta-committee-4", task: "Join the two greetings into one line.", inputMode: "guided", files: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\nconst first = greetPerson(\"Juan\");\nconst second = greetPerson(\"Maria\");\nconst both = ;\n"), activeFile: "script.js", highlightToken: "const both = ;", tests: [{ id: "fiesta-committee-4-check", label: "both is Hello, Juan and Hello, Maria", kind: "js-value", expression: "both", equals: "Hello, Juan and Hello, Maria" }], hints: [{ level: 1, text: "Join the two with the words in between." }, { level: 2, text: "Write first + \" and \" + second after the equals sign." }], xp: 50 }),
    s86({ id: "fiesta-committee-5", task: "Print both greetings.", inputMode: "guided", files: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\nconst first = greetPerson(\"Juan\");\nconst second = greetPerson(\"Maria\");\nconst both = first + \" and \" + second;\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "fiesta-committee-5-check", label: "It prints Hello, Juan and Hello, Maria", kind: "js-logs", values: ["Hello, Juan and Hello, Maria"] }], hints: [{ level: 1, text: "Put both inside console.log." }, { level: 2, text: "Write console.log(both);" }], xp: 40 }),
    s87({ id: "rice-retailer-1", task: "Store the service name rice delivery.", inputMode: "guided", files: js("const service = ;\n"), activeFile: "script.js", highlightToken: "const service = ;", tests: [{ id: "rice-retailer-1-check", label: "service is rice delivery", kind: "js-value", expression: "service", equals: "rice delivery" }], hints: [{ level: 1, text: "Put the words in quotes." }, { level: 2, text: "Write \"rice delivery\" after the equals sign." }], xp: 50 }),
    s87({ id: "rice-retailer-2", task: "Write a short function that labels any service name.", inputMode: "guided", files: js("const service = \"rice delivery\";\nconst label = (text) => ;;\n"), activeFile: "script.js", highlightToken: "(text) => ;", tests: [{ id: "rice-retailer-2-check", label: "The script runs without stopping", kind: "js-runs" }], hints: [{ level: 1, text: "After the arrow, give the value the function hands back." }, { level: 2, text: "Write (text) => \"Service: \" + text after the equals sign." }], xp: 50 }),
    s87({ id: "rice-retailer-3", task: "Label the stored service.", inputMode: "guided", files: js("const service = \"rice delivery\";\nconst label = (text) => \"Service: \" + text;\nconst labelled = ;\n"), activeFile: "script.js", highlightToken: "const labelled = ;", tests: [{ id: "rice-retailer-3-check", label: "labelled is Service: rice delivery", kind: "js-value", expression: "labelled", equals: "Service: rice delivery" }], hints: [{ level: 1, text: "Call the short function with the service." }, { level: 2, text: "Write label(service) after the equals sign." }], xp: 50 }),
    s87({ id: "rice-retailer-4", task: "Count the letters in the labelled service.", inputMode: "guided", files: js("const service = \"rice delivery\";\nconst label = (text) => \"Service: \" + text;\nconst labelled = label(service);\nconst short = ;\n"), activeFile: "script.js", highlightToken: "const short = ;", tests: [{ id: "rice-retailer-4-check", label: "short is 22", kind: "js-value", expression: "short", equals: 22 }], hints: [{ level: 1, text: "Use the property that gives a string's length." }, { level: 2, text: "Write labelled.length after the equals sign." }], xp: 50 }),
    s87({ id: "rice-retailer-5", task: "Print the labelled service.", inputMode: "guided", files: js("const service = \"rice delivery\";\nconst label = (text) => \"Service: \" + text;\nconst labelled = label(service);\nconst short = labelled.length;\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "rice-retailer-5-check", label: "It prints Service: rice delivery", kind: "js-logs", values: ["Service: rice delivery"] }], hints: [{ level: 1, text: "Put labelled inside console.log." }, { level: 2, text: "Write console.log(labelled);" }], xp: 40 }),
    s88({ id: "laundry-shop-1", task: "Give the function a fallback name to use when it is called with nothing.", inputMode: "guided", files: js("function deskName(name = ) {\n  return name;\n}\n"), activeFile: "script.js", highlightToken: "name = )", tests: [{ id: "laundry-shop-1-check", label: "deskName() gives back Front desk", kind: "js-returns", fn: "deskName", args: [], equals: "Front desk" }], hints: [{ level: 1, text: "Put the fallback after the equals sign in the brackets." }, { level: 2, text: "Write \"Front desk\" after the equals sign." }], xp: 50 }),
    s88({ id: "laundry-shop-2", task: "Call the function with nothing at all.", inputMode: "guided", files: js("function deskName(name = \"Front desk\") {\n  return name;\n}\nconst fallback = ;\n"), activeFile: "script.js", highlightToken: "const fallback = ;", tests: [{ id: "laundry-shop-2-check", label: "fallback is Front desk", kind: "js-value", expression: "fallback", equals: "Front desk" }], hints: [{ level: 1, text: "Leave the round brackets empty." }, { level: 2, text: "Write deskName() after the equals sign." }], xp: 50 }),
    s88({ id: "laundry-shop-3", task: "Call it again with Front Desk.", inputMode: "guided", files: js("function deskName(name = \"Front desk\") {\n  return name;\n}\nconst fallback = deskName();\nconst named = ;\n"), activeFile: "script.js", highlightToken: "const named = ;", tests: [{ id: "laundry-shop-3-check", label: "named is Front Desk", kind: "js-value", expression: "named", equals: "Front Desk" }], hints: [{ level: 1, text: "Put the name in quotes inside the brackets." }, { level: 2, text: "Write deskName(\"Front Desk\") after the equals sign." }], xp: 50 }),
    s88({ id: "laundry-shop-4", task: "Join the two results with a slash between them.", inputMode: "guided", files: js("function deskName(name = \"Front desk\") {\n  return name;\n}\nconst fallback = deskName();\nconst named = deskName(\"Front Desk\");\nconst both = ;\n"), activeFile: "script.js", highlightToken: "const both = ;", tests: [{ id: "laundry-shop-4-check", label: "both is Front desk / Front Desk", kind: "js-value", expression: "both", equals: "Front desk / Front Desk" }], hints: [{ level: 1, text: "Join the two with the slash in quotes between them." }, { level: 2, text: "Write fallback + \" / \" + named after the equals sign." }], xp: 50 }),
    s88({ id: "laundry-shop-5", task: "Print both desk names.", inputMode: "guided", files: js("function deskName(name = \"Front desk\") {\n  return name;\n}\nconst fallback = deskName();\nconst named = deskName(\"Front Desk\");\nconst both = fallback + \" / \" + named;\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "laundry-shop-5-check", label: "It prints Front desk / Front Desk", kind: "js-logs", values: ["Front desk / Front Desk"] }], hints: [{ level: 1, text: "Put both inside console.log." }, { level: 2, text: "Write console.log(both);" }], xp: 40 }),
    s89({ id: "pharmacy-counter-1", task: "Store the item name Medicine.", inputMode: "guided", files: js("const item = ;\n"), activeFile: "script.js", highlightToken: "const item = ;", tests: [{ id: "pharmacy-counter-1-check", label: "item is Medicine", kind: "js-value", expression: "item", equals: "Medicine" }], hints: [{ level: 1, text: "Put the words in quotes." }, { level: 2, text: "Write \"Medicine\" after the equals sign." }], xp: 50 }),
    s89({ id: "pharmacy-counter-2", task: "Store the price 50.", inputMode: "guided", files: js("const item = \"Medicine\";\nconst price = ;\n"), activeFile: "script.js", highlightToken: "const price = ;", tests: [{ id: "pharmacy-counter-2-check", label: "price is 50", kind: "js-value", expression: "price", equals: 50 }], hints: [{ level: 1, text: "A number needs no quotes." }, { level: 2, text: "Write 50 after the equals sign." }], xp: 50 }),
    s89({ id: "pharmacy-counter-3", task: "Build the price line using backticks instead of joining with plus signs.", inputMode: "guided", files: js("const item = \"Medicine\";\nconst price = 50;\nconst line = ``;\n"), activeFile: "script.js", highlightToken: "``", tests: [{ id: "pharmacy-counter-3-check", label: "line is Medicine costs PHP 50", kind: "js-value", expression: "line", equals: "Medicine costs PHP 50" }], hints: [{ level: 1, text: "Inside backticks, a value goes in a dollar sign and curly brackets." }, { level: 2, text: "Write ${item} costs PHP ${price} between the backticks." }], xp: 50 }),
    s89({ id: "pharmacy-counter-4", task: "Make a loud version of the price line.", inputMode: "guided", files: js("const item = \"Medicine\";\nconst price = 50;\nconst line = `${item} costs PHP ${price}`;\nconst shout = ;\n"), activeFile: "script.js", highlightToken: "const shout = ;", tests: [{ id: "pharmacy-counter-4-check", label: "shout is MEDICINE COSTS PHP 50", kind: "js-value", expression: "shout", equals: "MEDICINE COSTS PHP 50" }], hints: [{ level: 1, text: "Use the string method that returns capitals." }, { level: 2, text: "Write line.toUpperCase() after the equals sign." }], xp: 50 }),
    s89({ id: "pharmacy-counter-5", task: "Print the price line.", inputMode: "guided", files: js("const item = \"Medicine\";\nconst price = 50;\nconst line = `${item} costs PHP ${price}`;\nconst shout = line.toUpperCase();\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "pharmacy-counter-5-check", label: "It prints Medicine costs PHP 50", kind: "js-logs", values: ["Medicine costs PHP 50"] }], hints: [{ level: 1, text: "Put line inside console.log." }, { level: 2, text: "Write console.log(line);" }], xp: 40 }),
    s90({ id: "barangay-id-1", task: "Store the three people waiting.", inputMode: "guided", files: js("const queue = ;\n"), activeFile: "script.js", highlightToken: "const queue = ;", tests: [{ id: "barangay-id-1-check", label: "queue is Juan, Maria, Jose", kind: "js-value", expression: "queue", equals: ["Juan","Maria","Jose"] }], hints: [{ level: 1, text: "Use square brackets and quote each name." }, { level: 2, text: "Write [\"Juan\", \"Maria\", \"Jose\"] after the equals sign." }], xp: 50 }),
    s90({ id: "barangay-id-2", task: "Unpack the first two people into their own names.", inputMode: "guided", files: js("const queue = [\"Juan\", \"Maria\", \"Jose\"];\nconst [firstUp, secondUp] = ;\n"), activeFile: "script.js", highlightToken: "= ;", tests: [{ id: "barangay-id-2-check", label: "firstUp is Juan", kind: "js-value", expression: "firstUp", equals: "Juan" }], hints: [{ level: 1, text: "Name the list the two names come out of." }, { level: 2, text: "Write queue after the equals sign." }], xp: 50 }),
    s90({ id: "barangay-id-3", task: "Work out how many are still waiting after those two.", inputMode: "guided", files: js("const queue = [\"Juan\", \"Maria\", \"Jose\"];\nconst [firstUp, secondUp] = queue;\nconst waiting = ;\n"), activeFile: "script.js", highlightToken: "const waiting = ;", tests: [{ id: "barangay-id-3-check", label: "waiting is 1", kind: "js-value", expression: "waiting", equals: 1 }], hints: [{ level: 1, text: "Take two away from the list length." }, { level: 2, text: "Write queue.length - 2 after the equals sign." }], xp: 50 }),
    s90({ id: "barangay-id-4", task: "Build the announcement for the first two.", inputMode: "guided", files: js("const queue = [\"Juan\", \"Maria\", \"Jose\"];\nconst [firstUp, secondUp] = queue;\nconst waiting = queue.length - 2;\nconst callNext = ``;\n"), activeFile: "script.js", highlightToken: "``", tests: [{ id: "barangay-id-4-check", label: "callNext is Now serving Juan, then Maria", kind: "js-value", expression: "callNext", equals: "Now serving Juan, then Maria" }], hints: [{ level: 1, text: "Use backticks and put each name in a dollar sign and curly brackets." }, { level: 2, text: "Write Now serving ${firstUp}, then ${secondUp} between the backticks." }], xp: 50 }),
    s90({ id: "barangay-id-5", task: "Print the announcement.", inputMode: "guided", files: js("const queue = [\"Juan\", \"Maria\", \"Jose\"];\nconst [firstUp, secondUp] = queue;\nconst waiting = queue.length - 2;\nconst callNext = `Now serving ${firstUp}, then ${secondUp}`;\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "barangay-id-5-check", label: "It prints Now serving Juan, then Maria", kind: "js-logs", values: ["Now serving Juan, then Maria"] }], hints: [{ level: 1, text: "Put callNext inside console.log." }, { level: 2, text: "Write console.log(callNext);" }], xp: 40 }),
    s91({ id: "relief-goods-1", task: "Store the office name and phone number together in one record.", inputMode: "guided", files: js("const office = ;\n"), activeFile: "script.js", highlightToken: "const office = ;", tests: [{ id: "relief-goods-1-check", label: "office.name is Sampaguita", kind: "js-value", expression: "office.name", equals: "Sampaguita" }], hints: [{ level: 1, text: "Use curly brackets with name and phone inside." }, { level: 2, text: "Write { name: \"Sampaguita\", phone: \"09175550101\" } after the equals sign." }], xp: 50 }),
    s91({ id: "relief-goods-2", task: "Unpack the record into two plain names.", inputMode: "guided", files: js("const office = { name: \"Sampaguita\", phone: \"09175550101\" };\nconst { name, phone } = ;\n"), activeFile: "script.js", highlightToken: "= ;", tests: [{ id: "relief-goods-2-check", label: "name is Sampaguita", kind: "js-value", expression: "name", equals: "Sampaguita" }], hints: [{ level: 1, text: "Name the record the two values come out of." }, { level: 2, text: "Write office after the equals sign." }], xp: 50 }),
    s91({ id: "relief-goods-3", task: "Build one contact line from the two unpacked values.", inputMode: "guided", files: js("const office = { name: \"Sampaguita\", phone: \"09175550101\" };\nconst { name, phone } = office;\nconst contact = ``;\n"), activeFile: "script.js", highlightToken: "``", tests: [{ id: "relief-goods-3-check", label: "contact is Sampaguita: 09175550101", kind: "js-value", expression: "contact", equals: "Sampaguita: 09175550101" }], hints: [{ level: 1, text: "Use backticks with each value in a dollar sign and curly brackets." }, { level: 2, text: "Write ${name}: ${phone} between the backticks." }], xp: 50 }),
    s91({ id: "relief-goods-4", task: "Make a version of the number with no spaces.", inputMode: "guided", files: js("const office = { name: \"Sampaguita\", phone: \"09175550101\" };\nconst { name, phone } = office;\nconst contact = `${name}: ${phone}`;\nconst digits = ;\n"), activeFile: "script.js", highlightToken: "const digits = ;", tests: [{ id: "relief-goods-4-check", label: "digits is 09175550101", kind: "js-value", expression: "digits", equals: "09175550101" }], hints: [{ level: 1, text: "Replace every space with nothing." }, { level: 2, text: "Write phone.replace(/ /g, \"\") after the equals sign." }], xp: 50 }),
    s91({ id: "relief-goods-5", task: "Print the contact line.", inputMode: "guided", files: js("const office = { name: \"Sampaguita\", phone: \"09175550101\" };\nconst { name, phone } = office;\nconst contact = `${name}: ${phone}`;\nconst digits = phone.replace(/ /g, \"\");\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "relief-goods-5-check", label: "It prints Sampaguita: 09175550101", kind: "js-logs", values: ["Sampaguita: 09175550101"] }], hints: [{ level: 1, text: "Put contact inside console.log." }, { level: 2, text: "Write console.log(contact);" }], xp: 40 }),
    s92({ id: "barangay-help-1", task: "Store a list holding only food.", inputMode: "guided", files: js("const boxA = ;\n"), activeFile: "script.js", highlightToken: "const boxA = ;", tests: [{ id: "barangay-help-1-check", label: "boxA is food", kind: "js-value", expression: "boxA", equals: ["food"] }], hints: [{ level: 1, text: "Use square brackets with one quoted item." }, { level: 2, text: "Write [\"food\"] after the equals sign." }], xp: 50 }),
    s92({ id: "barangay-help-2", task: "Store a second list holding only water.", inputMode: "guided", files: js("const boxA = [\"food\"];\nconst boxB = ;\n"), activeFile: "script.js", highlightToken: "const boxB = ;", tests: [{ id: "barangay-help-2-check", label: "boxB is water", kind: "js-value", expression: "boxB", equals: ["water"] }], hints: [{ level: 1, text: "Use square brackets with one quoted item." }, { level: 2, text: "Write [\"water\"] after the equals sign." }], xp: 50 }),
    s92({ id: "barangay-help-3", task: "Pour both lists into one new list.", inputMode: "guided", files: js("const boxA = [\"food\"];\nconst boxB = [\"water\"];\nconst combined = ;\n"), activeFile: "script.js", highlightToken: "const combined = ;", tests: [{ id: "barangay-help-3-check", label: "combined is food, water", kind: "js-value", expression: "combined", equals: ["food","water"] }], hints: [{ level: 1, text: "Three dots before a list pours its items out." }, { level: 2, text: "Write [...boxA, ...boxB] after the equals sign." }], xp: 50 }),
    s92({ id: "barangay-help-4", task: "Count what the combined list holds.", inputMode: "guided", files: js("const boxA = [\"food\"];\nconst boxB = [\"water\"];\nconst combined = [...boxA, ...boxB];\nconst count = ;\n"), activeFile: "script.js", highlightToken: "const count = ;", tests: [{ id: "barangay-help-4-check", label: "count is 2", kind: "js-value", expression: "count", equals: 2 }], hints: [{ level: 1, text: "Use the property that gives a list's length." }, { level: 2, text: "Write combined.length after the equals sign." }], xp: 50 }),
    s92({ id: "barangay-help-5", task: "Print how many items there are.", inputMode: "guided", files: js("const boxA = [\"food\"];\nconst boxB = [\"water\"];\nconst combined = [...boxA, ...boxB];\nconst count = combined.length;\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "barangay-help-5-check", label: "It prints 2", kind: "js-logs", values: ["2"] }], hints: [{ level: 1, text: "Put count inside console.log." }, { level: 2, text: "Write console.log(count);" }], xp: 40 }),
    s93({ id: "sari-sari-1", task: "Let the function accept however many amounts it is given.", inputMode: "guided", files: js("function addAll() {\n  return amounts.length;\n}\n"), activeFile: "script.js", highlightToken: "addAll()", tests: [{ id: "sari-sari-1-check", label: "addAll() gives back 3", kind: "js-returns", fn: "addAll", args: [1,2,3], equals: 3 }], hints: [{ level: 1, text: "Three dots before a parameter name gathers everything into a list." }, { level: 2, text: "Write ...amounts inside the brackets." }], xp: 50 }),
    s93({ id: "sari-sari-2", task: "Call it with two amounts.", inputMode: "guided", files: js("function addAll(...amounts) {\n  return amounts.length;\n}\nconst two = ;\n"), activeFile: "script.js", highlightToken: "const two = ;", tests: [{ id: "sari-sari-2-check", label: "two is 2", kind: "js-value", expression: "two", equals: 2 }], hints: [{ level: 1, text: "Put both numbers inside the brackets, separated by a comma." }, { level: 2, text: "Write addAll(5, 7) after the equals sign." }], xp: 50 }),
    s93({ id: "sari-sari-3", task: "Call it again with three amounts.", inputMode: "guided", files: js("function addAll(...amounts) {\n  return amounts.length;\n}\nconst two = addAll(5, 7);\nconst three = ;\n"), activeFile: "script.js", highlightToken: "const three = ;", tests: [{ id: "sari-sari-3-check", label: "three is 3", kind: "js-value", expression: "three", equals: 3 }], hints: [{ level: 1, text: "Add one more number inside the brackets." }, { level: 2, text: "Write addAll(5, 7, 5) after the equals sign." }], xp: 50 }),
    s93({ id: "sari-sari-4", task: "Work out how many more the second call counted.", inputMode: "guided", files: js("function addAll(...amounts) {\n  return amounts.length;\n}\nconst two = addAll(5, 7);\nconst three = addAll(5, 7, 5);\nconst grew = ;\n"), activeFile: "script.js", highlightToken: "const grew = ;", tests: [{ id: "sari-sari-4-check", label: "grew is 1", kind: "js-value", expression: "grew", equals: 1 }], hints: [{ level: 1, text: "Take the first count away from the second." }, { level: 2, text: "Write three - two after the equals sign." }], xp: 50 }),
    s93({ id: "sari-sari-5", task: "Print the larger count.", inputMode: "guided", files: js("function addAll(...amounts) {\n  return amounts.length;\n}\nconst two = addAll(5, 7);\nconst three = addAll(5, 7, 5);\nconst grew = three - two;\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "sari-sari-5-check", label: "It prints 3", kind: "js-logs", values: ["3"] }], hints: [{ level: 1, text: "Put three inside console.log." }, { level: 2, text: "Write console.log(three);" }], xp: 40 }),
    s94({ id: "palengke-stall-1", task: "Store the record name Pangunahing Barangay.", inputMode: "guided", files: js("const raw = ;\n"), activeFile: "script.js", highlightToken: "const raw = ;", tests: [{ id: "palengke-stall-1-check", label: "raw is Pangunahing Barangay", kind: "js-value", expression: "raw", equals: "Pangunahing Barangay" }], hints: [{ level: 1, text: "Put the words in quotes." }, { level: 2, text: "Write \"Pangunahing Barangay\" after the equals sign." }], xp: 50 }),
    s94({ id: "palengke-stall-2", task: "Inside the attempt, make a capitalised version of the record name.", inputMode: "guided", files: js("const raw = \"Pangunahing Barangay\";\nlet status = \"\";\ntry {\n  status = ;\n} catch (error) {\n  status = \"unreadable\";\n}\n"), activeFile: "script.js", highlightToken: "status = ;", tests: [{ id: "palengke-stall-2-check", label: "status is PANGUNAHING BARANGAY", kind: "js-value", expression: "status", equals: "PANGUNAHING BARANGAY" }], hints: [{ level: 1, text: "Use the string method that returns capitals." }, { level: 2, text: "Write raw.toUpperCase() after the equals sign." }], xp: 50 }),
    s94({ id: "palengke-stall-3", task: "Check whether the attempt succeeded.", inputMode: "guided", files: js("const raw = \"Pangunahing Barangay\";\nlet status = \"\";\ntry {\n  status = raw.toUpperCase();\n} catch (error) {\n  status = \"unreadable\";\n}\nconst worked = ;\n"), activeFile: "script.js", highlightToken: "const worked = ;", tests: [{ id: "palengke-stall-3-check", label: "worked is true", kind: "js-value", expression: "worked", equals: true }], hints: [{ level: 1, text: "Compare the status against the failure word." }, { level: 2, text: "Write status !== \"unreadable\" after the equals sign." }], xp: 50 }),
    s94({ id: "palengke-stall-4", task: "Build a line naming the record and whether it was read.", inputMode: "guided", files: js("const raw = \"Pangunahing Barangay\";\nlet status = \"\";\ntry {\n  status = raw.toUpperCase();\n} catch (error) {\n  status = \"unreadable\";\n}\nconst worked = status !== \"unreadable\";\nconst report = ``;\n"), activeFile: "script.js", highlightToken: "``", tests: [{ id: "palengke-stall-4-check", label: "report is Record PANGUNAHING BARANGAY read: true", kind: "js-value", expression: "report", equals: "Record PANGUNAHING BARANGAY read: true" }], hints: [{ level: 1, text: "Use backticks with each value in a dollar sign and curly brackets." }, { level: 2, text: "Write Record ${status} read: ${worked} between the backticks." }], xp: 50 }),
    s94({ id: "palengke-stall-5", task: "Print the report.", inputMode: "guided", files: js("const raw = \"Pangunahing Barangay\";\nlet status = \"\";\ntry {\n  status = raw.toUpperCase();\n} catch (error) {\n  status = \"unreadable\";\n}\nconst worked = status !== \"unreadable\";\nconst report = `Record ${status} read: ${worked}`;\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "palengke-stall-5-check", label: "It prints Record PANGUNAHING BARANGAY read: true", kind: "js-logs", values: ["Record PANGUNAHING BARANGAY read: true"] }], hints: [{ level: 1, text: "Put report inside console.log." }, { level: 2, text: "Write console.log(report);" }], xp: 40 }),
    s95({ id: "jeepney-terminal-1", task: "Refuse a negative age by raising an error.", inputMode: "guided", files: js("function checkAge(age) {\n  if (age < 0) {\n    throw ;\n  }\n  return age;\n}\n"), activeFile: "script.js", highlightToken: "throw ;", tests: [{ id: "jeepney-terminal-1-check", label: "checkAge() gives back 7", kind: "js-returns", fn: "checkAge", args: [7], equals: 7 }], hints: [{ level: 1, text: "Raise a new Error with a message explaining the refusal." }, { level: 2, text: "Write new Error(\"Age cannot be negative\") after throw." }], xp: 50 }),
    s95({ id: "jeepney-terminal-2", task: "Check the age 7, which is fine.", inputMode: "guided", files: js("function checkAge(age) {\n  if (age < 0) {\n    throw new Error(\"Age cannot be negative\");\n  }\n  return age;\n}\nconst good = ;\n"), activeFile: "script.js", highlightToken: "const good = ;", tests: [{ id: "jeepney-terminal-2-check", label: "good is 7", kind: "js-value", expression: "good", equals: 7 }], hints: [{ level: 1, text: "Put the number inside the brackets." }, { level: 2, text: "Write checkAge(7) after the equals sign." }], xp: 50 }),
    s95({ id: "jeepney-terminal-3", task: "Catch the refusal and keep the reason it gave.", inputMode: "guided", files: js("function checkAge(age) {\n  if (age < 0) {\n    throw new Error(\"Age cannot be negative\");\n  }\n  return age;\n}\nconst good = checkAge(7);\nlet message = \"\";\ntry {\n  checkAge(-1);\n} catch (error) {\n  message = ;\n}\n"), activeFile: "script.js", highlightToken: "message = ;", tests: [{ id: "jeepney-terminal-3-check", label: "message is Age cannot be negative", kind: "js-value", expression: "message", equals: "Age cannot be negative" }], hints: [{ level: 1, text: "An error carries its reason on a property." }, { level: 2, text: "Write error.message after the equals sign." }], xp: 50 }),
    s95({ id: "jeepney-terminal-4", task: "Build a line naming the good value and the refusal.", inputMode: "guided", files: js("function checkAge(age) {\n  if (age < 0) {\n    throw new Error(\"Age cannot be negative\");\n  }\n  return age;\n}\nconst good = checkAge(7);\nlet message = \"\";\ntry {\n  checkAge(-1);\n} catch (error) {\n  message = error.message;\n}\nconst summary = ``;\n"), activeFile: "script.js", highlightToken: "``", tests: [{ id: "jeepney-terminal-4-check", label: "summary is Checked 7, refused: Age cannot be negative", kind: "js-value", expression: "summary", equals: "Checked 7, refused: Age cannot be negative" }], hints: [{ level: 1, text: "Use backticks with each value in a dollar sign and curly brackets." }, { level: 2, text: "Write Checked ${good}, refused: ${message} between the backticks." }], xp: 50 }),
    s95({ id: "jeepney-terminal-5", task: "Print the summary.", inputMode: "guided", files: js("function checkAge(age) {\n  if (age < 0) {\n    throw new Error(\"Age cannot be negative\");\n  }\n  return age;\n}\nconst good = checkAge(7);\nlet message = \"\";\ntry {\n  checkAge(-1);\n} catch (error) {\n  message = error.message;\n}\nconst summary = `Checked ${good}, refused: ${message}`;\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "jeepney-terminal-5-check", label: "It prints Checked 7, refused: Age cannot be negative", kind: "js-logs", values: ["Checked 7, refused: Age cannot be negative"] }], hints: [{ level: 1, text: "Put summary inside console.log." }, { level: 2, text: "Write console.log(summary);" }], xp: 40 }),
    s96({ id: "turo-turo-1", task: "Store the name that the blueprint is handed.", inputMode: "guided", files: js("class Resident {\n  constructor(name, age) {\n    this.name = ;\n    this.age = age;\n  }\n}\n"), activeFile: "script.js", highlightToken: "this.name = ;", tests: [{ id: "turo-turo-1-check", label: "new Resident(\"John\", 35).name is John", kind: "js-value", expression: "new Resident(\"John\", 35).name", equals: "John" }], hints: [{ level: 1, text: "The value handed in is the parameter of the same name." }, { level: 2, text: "Write name after the equals sign." }], xp: 50 }),
    s96({ id: "turo-turo-2", task: "Make a record for John.", inputMode: "guided", files: js("class Resident {\n  constructor(name, age) {\n    this.name = name;\n    this.age = age;\n  }\n}\nconst one = ;\n"), activeFile: "script.js", highlightToken: "const one = ;", tests: [{ id: "turo-turo-2-check", label: "one.name is John", kind: "js-value", expression: "one.name", equals: "John" }], hints: [{ level: 1, text: "Use new followed by the blueprint name and the two values." }, { level: 2, text: "Write new Resident(\"John\", 35) after the equals sign." }], xp: 50 }),
    s96({ id: "turo-turo-3", task: "Read the age off the record.", inputMode: "guided", files: js("class Resident {\n  constructor(name, age) {\n    this.name = name;\n    this.age = age;\n  }\n}\nconst one = new Resident(\"John\", 35);\nconst years = ;\n"), activeFile: "script.js", highlightToken: "const years = ;", tests: [{ id: "turo-turo-3-check", label: "years is 35", kind: "js-value", expression: "years", equals: 35 }], hints: [{ level: 1, text: "Reach into the record with a dot." }, { level: 2, text: "Write one.age after the equals sign." }], xp: 50 }),
    s96({ id: "turo-turo-4", task: "Build a line naming the resident and their age.", inputMode: "guided", files: js("class Resident {\n  constructor(name, age) {\n    this.name = name;\n    this.age = age;\n  }\n}\nconst one = new Resident(\"John\", 35);\nconst years = one.age;\nconst line = ``;\n"), activeFile: "script.js", highlightToken: "``", tests: [{ id: "turo-turo-4-check", label: "line is John is 35", kind: "js-value", expression: "line", equals: "John is 35" }], hints: [{ level: 1, text: "Use backticks with each value in a dollar sign and curly brackets." }, { level: 2, text: "Write ${one.name} is ${years} between the backticks." }], xp: 50 }),
    s96({ id: "turo-turo-5", task: "Print the resident line.", inputMode: "guided", files: js("class Resident {\n  constructor(name, age) {\n    this.name = name;\n    this.age = age;\n  }\n}\nconst one = new Resident(\"John\", 35);\nconst years = one.age;\nconst line = `${one.name} is ${years}`;\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "turo-turo-5-check", label: "It prints John is 35", kind: "js-logs", values: ["John is 35"] }], hints: [{ level: 1, text: "Put line inside console.log." }, { level: 2, text: "Write console.log(line);" }], xp: 40 }),
    s97({ id: "barangay-health-1", task: "Make the blueprint able to label itself.", inputMode: "guided", files: js("class Desk {\n  constructor(name) {\n    this.name = name;\n  }\n  label() {\n    return ;\n  }\n}\n"), activeFile: "script.js", highlightToken: "return ;", tests: [{ id: "barangay-health-1-check", label: "new Desk(\"Village Aid\").label() is Desk: Village Aid", kind: "js-value", expression: "new Desk(\"Village Aid\").label()", equals: "Desk: Village Aid" }], hints: [{ level: 1, text: "Join the fixed words to the record's own name." }, { level: 2, text: "Write \"Desk: \" + this.name after return." }], xp: 50 }),
    s97({ id: "barangay-health-2", task: "Make a desk record for Village Aid.", inputMode: "guided", files: js("class Desk {\n  constructor(name) {\n    this.name = name;\n  }\n  label() {\n    return \"Desk: \" + this.name;\n  }\n}\nconst desk = ;\n"), activeFile: "script.js", highlightToken: "const desk = ;", tests: [{ id: "barangay-health-2-check", label: "desk.name is Village Aid", kind: "js-value", expression: "desk.name", equals: "Village Aid" }], hints: [{ level: 1, text: "Use new followed by the blueprint name and the desk name." }, { level: 2, text: "Write new Desk(\"Village Aid\") after the equals sign." }], xp: 50 }),
    s97({ id: "barangay-health-3", task: "Ask the desk to label itself.", inputMode: "guided", files: js("class Desk {\n  constructor(name) {\n    this.name = name;\n  }\n  label() {\n    return \"Desk: \" + this.name;\n  }\n}\nconst desk = new Desk(\"Village Aid\");\nconst labelled = ;\n"), activeFile: "script.js", highlightToken: "const labelled = ;", tests: [{ id: "barangay-health-3-check", label: "labelled is Desk: Village Aid", kind: "js-value", expression: "labelled", equals: "Desk: Village Aid" }], hints: [{ level: 1, text: "Call the method with a dot and round brackets." }, { level: 2, text: "Write desk.label() after the equals sign." }], xp: 50 }),
    s97({ id: "barangay-health-4", task: "Make a loud version of the label.", inputMode: "guided", files: js("class Desk {\n  constructor(name) {\n    this.name = name;\n  }\n  label() {\n    return \"Desk: \" + this.name;\n  }\n}\nconst desk = new Desk(\"Village Aid\");\nconst labelled = desk.label();\nconst shout = ;\n"), activeFile: "script.js", highlightToken: "const shout = ;", tests: [{ id: "barangay-health-4-check", label: "shout is DESK: VILLAGE AID", kind: "js-value", expression: "shout", equals: "DESK: VILLAGE AID" }], hints: [{ level: 1, text: "Use the string method that returns capitals." }, { level: 2, text: "Write labelled.toUpperCase() after the equals sign." }], xp: 50 }),
    s97({ id: "barangay-health-5", task: "Print the desk label.", inputMode: "guided", files: js("class Desk {\n  constructor(name) {\n    this.name = name;\n  }\n  label() {\n    return \"Desk: \" + this.name;\n  }\n}\nconst desk = new Desk(\"Village Aid\");\nconst labelled = desk.label();\nconst shout = labelled.toUpperCase();\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "barangay-health-5-check", label: "It prints Desk: Village Aid", kind: "js-logs", values: ["Desk: Village Aid"] }], hints: [{ level: 1, text: "Put labelled inside console.log." }, { level: 2, text: "Write console.log(labelled);" }], xp: 40 }),
    s98({ id: "school-registration-1", task: "Store the office and how many are queueing.", inputMode: "guided", files: js("const record = ;\n"), activeFile: "script.js", highlightToken: "const record = ;", tests: [{ id: "school-registration-1-check", label: "record.office is Barangay Center", kind: "js-value", expression: "record.office", equals: "Barangay Center" }], hints: [{ level: 1, text: "Use curly brackets with office and queue inside." }, { level: 2, text: "Write { office: \"Barangay Center\", queue: 35 } after the equals sign." }], xp: 50 }),
    s98({ id: "school-registration-2", task: "Turn the record into text that can be saved or sent.", inputMode: "guided", files: js("const record = { office: \"Barangay Center\", queue: 35 };\nconst text = ;\n"), activeFile: "script.js", highlightToken: "const text = ;", tests: [{ id: "school-registration-2-check", label: "text is {\"office\":\"Barangay Center\",\"queue\":35}", kind: "js-value", expression: "text", equals: "{\"office\":\"Barangay Center\",\"queue\":35}" }], hints: [{ level: 1, text: "JSON has a method that turns a value into text." }, { level: 2, text: "Write JSON.stringify(record) after the equals sign." }], xp: 50 }),
    s98({ id: "school-registration-3", task: "Turn that text back into a record.", inputMode: "guided", files: js("const record = { office: \"Barangay Center\", queue: 35 };\nconst text = JSON.stringify(record);\nconst back = ;\n"), activeFile: "script.js", highlightToken: "const back = ;", tests: [{ id: "school-registration-3-check", label: "back.office is Barangay Center", kind: "js-value", expression: "back.office", equals: "Barangay Center" }], hints: [{ level: 1, text: "JSON has a matching method that reads text back." }, { level: 2, text: "Write JSON.parse(text) after the equals sign." }], xp: 50 }),
    s98({ id: "school-registration-4", task: "Check the queue survived the round trip.", inputMode: "guided", files: js("const record = { office: \"Barangay Center\", queue: 35 };\nconst text = JSON.stringify(record);\nconst back = JSON.parse(text);\nconst same = ;\n"), activeFile: "script.js", highlightToken: "const same = ;", tests: [{ id: "school-registration-4-check", label: "same is true", kind: "js-value", expression: "same", equals: true }], hints: [{ level: 1, text: "Compare the two queue values with three equals signs." }, { level: 2, text: "Write back.queue === record.queue after the equals sign." }], xp: 50 }),
    s98({ id: "school-registration-5", task: "Print the record as text.", inputMode: "guided", files: js("const record = { office: \"Barangay Center\", queue: 35 };\nconst text = JSON.stringify(record);\nconst back = JSON.parse(text);\nconst same = back.queue === record.queue;\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "school-registration-5-check", label: "It prints {\"office\":\"Barangay Center\",\"queue\":35}", kind: "js-logs", values: ["{\"office\":\"Barangay Center\",\"queue\":35}"] }], hints: [{ level: 1, text: "Put text inside console.log." }, { level: 2, text: "Write console.log(text);" }], xp: 40 }),
    s99({ id: "tricycle-queue-1", task: "Store the sign-up list, where one person signed twice.", inputMode: "guided", files: js("const signups = ;\n"), activeFile: "script.js", highlightToken: "const signups = ;", tests: [{ id: "tricycle-queue-1-check", label: "signups.length is 3", kind: "js-value", expression: "signups.length", equals: 3 }], hints: [{ level: 1, text: "Use square brackets and quote each name." }, { level: 2, text: "Write [\"Jorge\", \"Maria\", \"Jorge\"] after the equals sign." }], xp: 50 }),
    s99({ id: "tricycle-queue-2", task: "Make a collection that keeps each name only once.", inputMode: "guided", files: js("const signups = [\"Jorge\", \"Maria\", \"Jorge\"];\nconst unique = ;\n"), activeFile: "script.js", highlightToken: "const unique = ;", tests: [{ id: "tricycle-queue-2-check", label: "unique.size is 2", kind: "js-value", expression: "unique.size", equals: 2 }], hints: [{ level: 1, text: "Use new followed by the collection type that refuses duplicates." }, { level: 2, text: "Write new Set(signups) after the equals sign." }], xp: 50 }),
    s99({ id: "tricycle-queue-3", task: "Count how many different people signed up.", inputMode: "guided", files: js("const signups = [\"Jorge\", \"Maria\", \"Jorge\"];\nconst unique = new Set(signups);\nconst count = ;\n"), activeFile: "script.js", highlightToken: "const count = ;", tests: [{ id: "tricycle-queue-3-check", label: "count is 2", kind: "js-value", expression: "count", equals: 2 }], hints: [{ level: 1, text: "This collection reports its size, not its length." }, { level: 2, text: "Write unique.size after the equals sign." }], xp: 50 }),
    s99({ id: "tricycle-queue-4", task: "Turn the collection back into a plain list.", inputMode: "guided", files: js("const signups = [\"Jorge\", \"Maria\", \"Jorge\"];\nconst unique = new Set(signups);\nconst count = unique.size;\nconst names = ;\n"), activeFile: "script.js", highlightToken: "const names = ;", tests: [{ id: "tricycle-queue-4-check", label: "names is Jorge, Maria", kind: "js-value", expression: "names", equals: ["Jorge","Maria"] }], hints: [{ level: 1, text: "Three dots pour a collection into a list." }, { level: 2, text: "Write [...unique] after the equals sign." }], xp: 50 }),
    s99({ id: "tricycle-queue-5", task: "Print how many different people signed up.", inputMode: "guided", files: js("const signups = [\"Jorge\", \"Maria\", \"Jorge\"];\nconst unique = new Set(signups);\nconst count = unique.size;\nconst names = [...unique];\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "tricycle-queue-5-check", label: "It prints 2", kind: "js-logs", values: ["2"] }], hints: [{ level: 1, text: "Put count inside console.log." }, { level: 2, text: "Write console.log(count);" }], xp: 40 }),
    s100({ id: "bakery-counter-1", task: "Store the greeting Welcome to Sweet Bakery!.", inputMode: "guided", files: js("const greeting = ;\n"), activeFile: "script.js", highlightToken: "const greeting = ;", tests: [{ id: "bakery-counter-1-check", label: "greeting is Welcome to Sweet Bakery!", kind: "js-value", expression: "greeting", equals: "Welcome to Sweet Bakery!" }], hints: [{ level: 1, text: "Put the words in quotes after the equals sign." }, { level: 2, text: "Write \"Welcome to Sweet Bakery!\" after the equals sign." }], xp: 50 }),
    s100({ id: "bakery-counter-2", task: "Make the function hand back the greeting.", inputMode: "guided", files: js("const greeting = \"Welcome to Sweet Bakery!\";\nfunction greet() {\n  return ;\n}\n"), activeFile: "script.js", highlightToken: "return ;", tests: [{ id: "bakery-counter-2-check", label: "greet() gives back Welcome to Sweet Bakery!", kind: "js-returns", fn: "greet", args: [], equals: "Welcome to Sweet Bakery!" }], hints: [{ level: 1, text: "A function hands a value back with return." }, { level: 2, text: "Write greeting after return." }], xp: 50 }),
    s100({ id: "bakery-counter-3", task: "Call the function and keep what it gives back.", inputMode: "guided", files: js("const greeting = \"Welcome to Sweet Bakery!\";\nfunction greet() {\n  return greeting;\n}\nconst welcome = ;\n"), activeFile: "script.js", highlightToken: "const welcome = ;", tests: [{ id: "bakery-counter-3-check", label: "welcome is Welcome to Sweet Bakery!", kind: "js-value", expression: "welcome", equals: "Welcome to Sweet Bakery!" }], hints: [{ level: 1, text: "Write the function name followed by round brackets." }, { level: 2, text: "Write greet() after the equals sign." }], xp: 50 }),
    s100({ id: "bakery-counter-4", task: "Make a loud version of the greeting.", inputMode: "guided", files: js("const greeting = \"Welcome to Sweet Bakery!\";\nfunction greet() {\n  return greeting;\n}\nconst welcome = greet();\nconst shout = ;\n"), activeFile: "script.js", highlightToken: "const shout = ;", tests: [{ id: "bakery-counter-4-check", label: "shout is WELCOME TO SWEET BAKERY!", kind: "js-value", expression: "shout", equals: "WELCOME TO SWEET BAKERY!" }], hints: [{ level: 1, text: "Use the string method that returns capitals." }, { level: 2, text: "Write welcome.toUpperCase() after the equals sign." }], xp: 50 }),
    s100({ id: "bakery-counter-5", task: "Print the loud greeting.", inputMode: "guided", files: js("const greeting = \"Welcome to Sweet Bakery!\";\nfunction greet() {\n  return greeting;\n}\nconst welcome = greet();\nconst shout = welcome.toUpperCase();\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "bakery-counter-5-check", label: "It prints WELCOME TO SWEET BAKERY!", kind: "js-logs", values: ["WELCOME TO SWEET BAKERY!"] }], hints: [{ level: 1, text: "Put shout inside console.log." }, { level: 2, text: "Write console.log(shout);" }], xp: 40 }),
    s101({ id: "water-refill-1", task: "Make the function greet whoever it is given.", inputMode: "guided", files: js("function greetPerson(name) {\n  return ;\n}\n"), activeFile: "script.js", highlightToken: "return ;", tests: [{ id: "water-refill-1-check", label: "greetPerson() gives back Hello, John", kind: "js-returns", fn: "greetPerson", args: ["John"], equals: "Hello, John" }], hints: [{ level: 1, text: "Join the fixed words to the name it was handed." }, { level: 2, text: "Write \"Hello, \" + name after return." }], xp: 50 }),
    s101({ id: "water-refill-2", task: "Greet John.", inputMode: "guided", files: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\nconst first = ;\n"), activeFile: "script.js", highlightToken: "const first = ;", tests: [{ id: "water-refill-2-check", label: "first is Hello, John", kind: "js-value", expression: "first", equals: "Hello, John" }], hints: [{ level: 1, text: "Put the name in quotes inside the brackets." }, { level: 2, text: "Write greetPerson(\"John\") after the equals sign." }], xp: 50 }),
    s101({ id: "water-refill-3", task: "Greet Alice with the same function.", inputMode: "guided", files: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\nconst first = greetPerson(\"John\");\nconst second = ;\n"), activeFile: "script.js", highlightToken: "const second = ;", tests: [{ id: "water-refill-3-check", label: "second is Hello, Alice", kind: "js-value", expression: "second", equals: "Hello, Alice" }], hints: [{ level: 1, text: "Call it again with a different name." }, { level: 2, text: "Write greetPerson(\"Alice\") after the equals sign." }], xp: 50 }),
    s101({ id: "water-refill-4", task: "Join the two greetings into one line.", inputMode: "guided", files: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\nconst first = greetPerson(\"John\");\nconst second = greetPerson(\"Alice\");\nconst both = ;\n"), activeFile: "script.js", highlightToken: "const both = ;", tests: [{ id: "water-refill-4-check", label: "both is Hello, John and Hello, Alice", kind: "js-value", expression: "both", equals: "Hello, John and Hello, Alice" }], hints: [{ level: 1, text: "Join the two with the words in between." }, { level: 2, text: "Write first + \" and \" + second after the equals sign." }], xp: 50 }),
    s101({ id: "water-refill-5", task: "Print both greetings.", inputMode: "guided", files: js("function greetPerson(name) {\n  return \"Hello, \" + name;\n}\nconst first = greetPerson(\"John\");\nconst second = greetPerson(\"Alice\");\nconst both = first + \" and \" + second;\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "water-refill-5-check", label: "It prints Hello, John and Hello, Alice", kind: "js-logs", values: ["Hello, John and Hello, Alice"] }], hints: [{ level: 1, text: "Put both inside console.log." }, { level: 2, text: "Write console.log(both);" }], xp: 40 }),
    s102({ id: "barangay-clean-1", task: "Store the service name Barangay Clean-Up.", inputMode: "guided", files: js("const service = ;\n"), activeFile: "script.js", highlightToken: "const service = ;", tests: [{ id: "barangay-clean-1-check", label: "service is Barangay Clean-Up", kind: "js-value", expression: "service", equals: "Barangay Clean-Up" }], hints: [{ level: 1, text: "Put the words in quotes." }, { level: 2, text: "Write \"Barangay Clean-Up\" after the equals sign." }], xp: 50 }),
    s102({ id: "barangay-clean-2", task: "Write a short function that labels any service name.", inputMode: "guided", files: js("const service = \"Barangay Clean-Up\";\nconst label = (text) => ;;\n"), activeFile: "script.js", highlightToken: "(text) => ;", tests: [{ id: "barangay-clean-2-check", label: "The script runs without stopping", kind: "js-runs" }], hints: [{ level: 1, text: "After the arrow, give the value the function hands back." }, { level: 2, text: "Write (text) => \"Service: \" + text after the equals sign." }], xp: 50 }),
    s102({ id: "barangay-clean-3", task: "Label the stored service.", inputMode: "guided", files: js("const service = \"Barangay Clean-Up\";\nconst label = (text) => \"Service: \" + text;\nconst labelled = ;\n"), activeFile: "script.js", highlightToken: "const labelled = ;", tests: [{ id: "barangay-clean-3-check", label: "labelled is Service: Barangay Clean-Up", kind: "js-value", expression: "labelled", equals: "Service: Barangay Clean-Up" }], hints: [{ level: 1, text: "Call the short function with the service." }, { level: 2, text: "Write label(service) after the equals sign." }], xp: 50 }),
    s102({ id: "barangay-clean-4", task: "Count the letters in the labelled service.", inputMode: "guided", files: js("const service = \"Barangay Clean-Up\";\nconst label = (text) => \"Service: \" + text;\nconst labelled = label(service);\nconst short = ;\n"), activeFile: "script.js", highlightToken: "const short = ;", tests: [{ id: "barangay-clean-4-check", label: "short is 26", kind: "js-value", expression: "short", equals: 26 }], hints: [{ level: 1, text: "Use the property that gives a string's length." }, { level: 2, text: "Write labelled.length after the equals sign." }], xp: 50 }),
    s102({ id: "barangay-clean-5", task: "Print the labelled service.", inputMode: "guided", files: js("const service = \"Barangay Clean-Up\";\nconst label = (text) => \"Service: \" + text;\nconst labelled = label(service);\nconst short = labelled.length;\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "barangay-clean-5-check", label: "It prints Service: Barangay Clean-Up", kind: "js-logs", values: ["Service: Barangay Clean-Up"] }], hints: [{ level: 1, text: "Put labelled inside console.log." }, { level: 2, text: "Write console.log(labelled);" }], xp: 40 }),
    s103({ id: "default-parameters-1", task: "Give the function a fallback name to use when it is called with nothing.", inputMode: "guided", files: js("function deskName(name = ) {\n  return name;\n}\n"), activeFile: "script.js", highlightToken: "name = )", tests: [{ id: "default-parameters-1-check", label: "deskName() gives back Front desk", kind: "js-returns", fn: "deskName", args: [], equals: "Front desk" }], hints: [{ level: 1, text: "Put the fallback after the equals sign in the brackets." }, { level: 2, text: "Write \"Front desk\" after the equals sign." }], xp: 50 }),
    s103({ id: "default-parameters-2", task: "Call the function with nothing at all.", inputMode: "guided", files: js("function deskName(name = \"Front desk\") {\n  return name;\n}\nconst fallback = ;\n"), activeFile: "script.js", highlightToken: "const fallback = ;", tests: [{ id: "default-parameters-2-check", label: "fallback is Front desk", kind: "js-value", expression: "fallback", equals: "Front desk" }], hints: [{ level: 1, text: "Leave the round brackets empty." }, { level: 2, text: "Write deskName() after the equals sign." }], xp: 50 }),
    s103({ id: "default-parameters-3", task: "Call it again with Help Desk.", inputMode: "guided", files: js("function deskName(name = \"Front desk\") {\n  return name;\n}\nconst fallback = deskName();\nconst named = ;\n"), activeFile: "script.js", highlightToken: "const named = ;", tests: [{ id: "default-parameters-3-check", label: "named is Help Desk", kind: "js-value", expression: "named", equals: "Help Desk" }], hints: [{ level: 1, text: "Put the name in quotes inside the brackets." }, { level: 2, text: "Write deskName(\"Help Desk\") after the equals sign." }], xp: 50 }),
    s103({ id: "default-parameters-4", task: "Join the two results with a slash between them.", inputMode: "guided", files: js("function deskName(name = \"Front desk\") {\n  return name;\n}\nconst fallback = deskName();\nconst named = deskName(\"Help Desk\");\nconst both = ;\n"), activeFile: "script.js", highlightToken: "const both = ;", tests: [{ id: "default-parameters-4-check", label: "both is Front desk / Help Desk", kind: "js-value", expression: "both", equals: "Front desk / Help Desk" }], hints: [{ level: 1, text: "Join the two with the slash in quotes between them." }, { level: 2, text: "Write fallback + \" / \" + named after the equals sign." }], xp: 50 }),
    s103({ id: "default-parameters-5", task: "Print both desk names.", inputMode: "guided", files: js("function deskName(name = \"Front desk\") {\n  return name;\n}\nconst fallback = deskName();\nconst named = deskName(\"Help Desk\");\nconst both = fallback + \" / \" + named;\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "default-parameters-5-check", label: "It prints Front desk / Help Desk", kind: "js-logs", values: ["Front desk / Help Desk"] }], hints: [{ level: 1, text: "Put both inside console.log." }, { level: 2, text: "Write console.log(both);" }], xp: 40 }),
    s104({ id: "template-literal-1", task: "Store the item name leche flan.", inputMode: "guided", files: js("const item = ;\n"), activeFile: "script.js", highlightToken: "const item = ;", tests: [{ id: "template-literal-1-check", label: "item is leche flan", kind: "js-value", expression: "item", equals: "leche flan" }], hints: [{ level: 1, text: "Put the words in quotes." }, { level: 2, text: "Write \"leche flan\" after the equals sign." }], xp: 50 }),
    s104({ id: "template-literal-2", task: "Store the price 50.", inputMode: "guided", files: js("const item = \"leche flan\";\nconst price = ;\n"), activeFile: "script.js", highlightToken: "const price = ;", tests: [{ id: "template-literal-2-check", label: "price is 50", kind: "js-value", expression: "price", equals: 50 }], hints: [{ level: 1, text: "A number needs no quotes." }, { level: 2, text: "Write 50 after the equals sign." }], xp: 50 }),
    s104({ id: "template-literal-3", task: "Build the price line using backticks instead of joining with plus signs.", inputMode: "guided", files: js("const item = \"leche flan\";\nconst price = 50;\nconst line = ``;\n"), activeFile: "script.js", highlightToken: "``", tests: [{ id: "template-literal-3-check", label: "line is leche flan costs PHP 50", kind: "js-value", expression: "line", equals: "leche flan costs PHP 50" }], hints: [{ level: 1, text: "Inside backticks, a value goes in a dollar sign and curly brackets." }, { level: 2, text: "Write ${item} costs PHP ${price} between the backticks." }], xp: 50 }),
    s104({ id: "template-literal-4", task: "Make a loud version of the price line.", inputMode: "guided", files: js("const item = \"leche flan\";\nconst price = 50;\nconst line = `${item} costs PHP ${price}`;\nconst shout = ;\n"), activeFile: "script.js", highlightToken: "const shout = ;", tests: [{ id: "template-literal-4-check", label: "shout is LECHE FLAN COSTS PHP 50", kind: "js-value", expression: "shout", equals: "LECHE FLAN COSTS PHP 50" }], hints: [{ level: 1, text: "Use the string method that returns capitals." }, { level: 2, text: "Write line.toUpperCase() after the equals sign." }], xp: 50 }),
    s104({ id: "template-literal-5", task: "Print the price line.", inputMode: "guided", files: js("const item = \"leche flan\";\nconst price = 50;\nconst line = `${item} costs PHP ${price}`;\nconst shout = line.toUpperCase();\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "template-literal-5-check", label: "It prints leche flan costs PHP 50", kind: "js-logs", values: ["leche flan costs PHP 50"] }], hints: [{ level: 1, text: "Put line inside console.log." }, { level: 2, text: "Write console.log(line);" }], xp: 40 }),
    s105({ id: "destructuring-array-1", task: "Store the three people waiting.", inputMode: "guided", files: js("const queue = ;\n"), activeFile: "script.js", highlightToken: "const queue = ;", tests: [{ id: "destructuring-array-1-check", label: "queue is John, Jane, Alice", kind: "js-value", expression: "queue", equals: ["John","Jane","Alice"] }], hints: [{ level: 1, text: "Use square brackets and quote each name." }, { level: 2, text: "Write [\"John\", \"Jane\", \"Alice\"] after the equals sign." }], xp: 50 }),
    s105({ id: "destructuring-array-2", task: "Unpack the first two people into their own names.", inputMode: "guided", files: js("const queue = [\"John\", \"Jane\", \"Alice\"];\nconst [firstUp, secondUp] = ;\n"), activeFile: "script.js", highlightToken: "= ;", tests: [{ id: "destructuring-array-2-check", label: "firstUp is John", kind: "js-value", expression: "firstUp", equals: "John" }], hints: [{ level: 1, text: "Name the list the two names come out of." }, { level: 2, text: "Write queue after the equals sign." }], xp: 50 }),
    s105({ id: "destructuring-array-3", task: "Work out how many are still waiting after those two.", inputMode: "guided", files: js("const queue = [\"John\", \"Jane\", \"Alice\"];\nconst [firstUp, secondUp] = queue;\nconst waiting = ;\n"), activeFile: "script.js", highlightToken: "const waiting = ;", tests: [{ id: "destructuring-array-3-check", label: "waiting is 1", kind: "js-value", expression: "waiting", equals: 1 }], hints: [{ level: 1, text: "Take two away from the list length." }, { level: 2, text: "Write queue.length - 2 after the equals sign." }], xp: 50 }),
    s105({ id: "destructuring-array-4", task: "Build the announcement for the first two.", inputMode: "guided", files: js("const queue = [\"John\", \"Jane\", \"Alice\"];\nconst [firstUp, secondUp] = queue;\nconst waiting = queue.length - 2;\nconst callNext = ``;\n"), activeFile: "script.js", highlightToken: "``", tests: [{ id: "destructuring-array-4-check", label: "callNext is Now serving John, then Jane", kind: "js-value", expression: "callNext", equals: "Now serving John, then Jane" }], hints: [{ level: 1, text: "Use backticks and put each name in a dollar sign and curly brackets." }, { level: 2, text: "Write Now serving ${firstUp}, then ${secondUp} between the backticks." }], xp: 50 }),
    s105({ id: "destructuring-array-5", task: "Print the announcement.", inputMode: "guided", files: js("const queue = [\"John\", \"Jane\", \"Alice\"];\nconst [firstUp, secondUp] = queue;\nconst waiting = queue.length - 2;\nconst callNext = `Now serving ${firstUp}, then ${secondUp}`;\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "destructuring-array-5-check", label: "It prints Now serving John, then Jane", kind: "js-logs", values: ["Now serving John, then Jane"] }], hints: [{ level: 1, text: "Put callNext inside console.log." }, { level: 2, text: "Write console.log(callNext);" }], xp: 40 }),
    s106({ id: "destructuring-object-1", task: "Store the office name and phone number together in one record.", inputMode: "guided", files: js("const office = ;\n"), activeFile: "script.js", highlightToken: "const office = ;", tests: [{ id: "destructuring-object-1-check", label: "office.name is Barangay Central", kind: "js-value", expression: "office.name", equals: "Barangay Central" }], hints: [{ level: 1, text: "Use curly brackets with name and phone inside." }, { level: 2, text: "Write { name: \"Barangay Central\", phone: \"09175550101\" } after the equals sign." }], xp: 50 }),
    s106({ id: "destructuring-object-2", task: "Unpack the record into two plain names.", inputMode: "guided", files: js("const office = { name: \"Barangay Central\", phone: \"09175550101\" };\nconst { name, phone } = ;\n"), activeFile: "script.js", highlightToken: "= ;", tests: [{ id: "destructuring-object-2-check", label: "name is Barangay Central", kind: "js-value", expression: "name", equals: "Barangay Central" }], hints: [{ level: 1, text: "Name the record the two values come out of." }, { level: 2, text: "Write office after the equals sign." }], xp: 50 }),
    s106({ id: "destructuring-object-3", task: "Build one contact line from the two unpacked values.", inputMode: "guided", files: js("const office = { name: \"Barangay Central\", phone: \"09175550101\" };\nconst { name, phone } = office;\nconst contact = ``;\n"), activeFile: "script.js", highlightToken: "``", tests: [{ id: "destructuring-object-3-check", label: "contact is Barangay Central: 09175550101", kind: "js-value", expression: "contact", equals: "Barangay Central: 09175550101" }], hints: [{ level: 1, text: "Use backticks with each value in a dollar sign and curly brackets." }, { level: 2, text: "Write ${name}: ${phone} between the backticks." }], xp: 50 }),
    s106({ id: "destructuring-object-4", task: "Make a version of the number with no spaces.", inputMode: "guided", files: js("const office = { name: \"Barangay Central\", phone: \"09175550101\" };\nconst { name, phone } = office;\nconst contact = `${name}: ${phone}`;\nconst digits = ;\n"), activeFile: "script.js", highlightToken: "const digits = ;", tests: [{ id: "destructuring-object-4-check", label: "digits is 09175550101", kind: "js-value", expression: "digits", equals: "09175550101" }], hints: [{ level: 1, text: "Replace every space with nothing." }, { level: 2, text: "Write phone.replace(/ /g, \"\") after the equals sign." }], xp: 50 }),
    s106({ id: "destructuring-object-5", task: "Print the contact line.", inputMode: "guided", files: js("const office = { name: \"Barangay Central\", phone: \"09175550101\" };\nconst { name, phone } = office;\nconst contact = `${name}: ${phone}`;\nconst digits = phone.replace(/ /g, \"\");\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "destructuring-object-5-check", label: "It prints Barangay Central: 09175550101", kind: "js-logs", values: ["Barangay Central: 09175550101"] }], hints: [{ level: 1, text: "Put contact inside console.log." }, { level: 2, text: "Write console.log(contact);" }], xp: 40 }),
    s107({ id: "spread-array-1", task: "Store a list holding only Aspirin.", inputMode: "guided", files: js("const boxA = ;\n"), activeFile: "script.js", highlightToken: "const boxA = ;", tests: [{ id: "spread-array-1-check", label: "boxA is Aspirin", kind: "js-value", expression: "boxA", equals: ["Aspirin"] }], hints: [{ level: 1, text: "Use square brackets with one quoted item." }, { level: 2, text: "Write [\"Aspirin\"] after the equals sign." }], xp: 50 }),
    s107({ id: "spread-array-2", task: "Store a second list holding only Paracetamol.", inputMode: "guided", files: js("const boxA = [\"Aspirin\"];\nconst boxB = ;\n"), activeFile: "script.js", highlightToken: "const boxB = ;", tests: [{ id: "spread-array-2-check", label: "boxB is Paracetamol", kind: "js-value", expression: "boxB", equals: ["Paracetamol"] }], hints: [{ level: 1, text: "Use square brackets with one quoted item." }, { level: 2, text: "Write [\"Paracetamol\"] after the equals sign." }], xp: 50 }),
    s107({ id: "spread-array-3", task: "Pour both lists into one new list.", inputMode: "guided", files: js("const boxA = [\"Aspirin\"];\nconst boxB = [\"Paracetamol\"];\nconst combined = ;\n"), activeFile: "script.js", highlightToken: "const combined = ;", tests: [{ id: "spread-array-3-check", label: "combined is Aspirin, Paracetamol", kind: "js-value", expression: "combined", equals: ["Aspirin","Paracetamol"] }], hints: [{ level: 1, text: "Three dots before a list pours its items out." }, { level: 2, text: "Write [...boxA, ...boxB] after the equals sign." }], xp: 50 }),
    s107({ id: "spread-array-4", task: "Count what the combined list holds.", inputMode: "guided", files: js("const boxA = [\"Aspirin\"];\nconst boxB = [\"Paracetamol\"];\nconst combined = [...boxA, ...boxB];\nconst count = ;\n"), activeFile: "script.js", highlightToken: "const count = ;", tests: [{ id: "spread-array-4-check", label: "count is 2", kind: "js-value", expression: "count", equals: 2 }], hints: [{ level: 1, text: "Use the property that gives a list's length." }, { level: 2, text: "Write combined.length after the equals sign." }], xp: 50 }),
    s107({ id: "spread-array-5", task: "Print how many items there are.", inputMode: "guided", files: js("const boxA = [\"Aspirin\"];\nconst boxB = [\"Paracetamol\"];\nconst combined = [...boxA, ...boxB];\nconst count = combined.length;\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "spread-array-5-check", label: "It prints 2", kind: "js-logs", values: ["2"] }], hints: [{ level: 1, text: "Put count inside console.log." }, { level: 2, text: "Write console.log(count);" }], xp: 40 }),
    s108({ id: "id-desk-1", task: "Let the function accept however many amounts it is given.", inputMode: "guided", files: js("function addAll() {\n  return amounts.length;\n}\n"), activeFile: "script.js", highlightToken: "addAll()", tests: [{ id: "id-desk-1-check", label: "addAll() gives back 3", kind: "js-returns", fn: "addAll", args: [1,2,3], equals: 3 }], hints: [{ level: 1, text: "Three dots before a parameter name gathers everything into a list." }, { level: 2, text: "Write ...amounts inside the brackets." }], xp: 50 }),
    s108({ id: "id-desk-2", task: "Call it with two amounts.", inputMode: "guided", files: js("function addAll(...amounts) {\n  return amounts.length;\n}\nconst two = ;\n"), activeFile: "script.js", highlightToken: "const two = ;", tests: [{ id: "id-desk-2-check", label: "two is 2", kind: "js-value", expression: "two", equals: 2 }], hints: [{ level: 1, text: "Put both numbers inside the brackets, separated by a comma." }, { level: 2, text: "Write addAll(23, 45) after the equals sign." }], xp: 50 }),
    s108({ id: "id-desk-3", task: "Call it again with three amounts.", inputMode: "guided", files: js("function addAll(...amounts) {\n  return amounts.length;\n}\nconst two = addAll(23, 45);\nconst three = ;\n"), activeFile: "script.js", highlightToken: "const three = ;", tests: [{ id: "id-desk-3-check", label: "three is 3", kind: "js-value", expression: "three", equals: 3 }], hints: [{ level: 1, text: "Add one more number inside the brackets." }, { level: 2, text: "Write addAll(23, 45, 23) after the equals sign." }], xp: 50 }),
    s108({ id: "id-desk-4", task: "Work out how many more the second call counted.", inputMode: "guided", files: js("function addAll(...amounts) {\n  return amounts.length;\n}\nconst two = addAll(23, 45);\nconst three = addAll(23, 45, 23);\nconst grew = ;\n"), activeFile: "script.js", highlightToken: "const grew = ;", tests: [{ id: "id-desk-4-check", label: "grew is 1", kind: "js-value", expression: "grew", equals: 1 }], hints: [{ level: 1, text: "Take the first count away from the second." }, { level: 2, text: "Write three - two after the equals sign." }], xp: 50 }),
    s108({ id: "id-desk-5", task: "Print the larger count.", inputMode: "guided", files: js("function addAll(...amounts) {\n  return amounts.length;\n}\nconst two = addAll(23, 45);\nconst three = addAll(23, 45, 23);\nconst grew = three - two;\n// Print it below\n"), activeFile: "script.js", highlightToken: "// Print it below", tests: [{ id: "id-desk-5-check", label: "It prints 3", kind: "js-logs", values: ["3"] }], hints: [{ level: 1, text: "Put three inside console.log." }, { level: 2, text: "Write console.log(three);" }], xp: 40 }),
  ],
};
