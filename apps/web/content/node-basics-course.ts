...
nodeBasicsCourse.steps.push(...([
  {
    "id": "node-config-school-club-6",
    "index": 266,
    "task": "Add one line at the end of app.js. This line checks if the API_KEY secret is missing. If it is, the program stops and shows an error. This stops the program from running without the secret. The code below does this. Run the checker to see if it works.\n\nIn app.js:\n```\nif (!process.env.API_KEY) { console.error(\"Missing API_KEY\"); process.exit(1); }\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      ...
      {
        "level": 2,
        "text": "Add the line at the very end of app.js, after the other code.\n\nIn app.js:\n```\nif (!process.env.API_KEY) { console.error(\"Missing API_KEY\"); process.exit(1); }\n```"
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "node-config-school-club-7",
    "index": 267,
    "task": "Add two lines at the end of app.js. The first line gets the secret. The second line prints only the first two letters, then hides the rest with stars. This keeps the secret safe. The code below does this. Run the checker to see if it works.\n\nIn app.js:\n```\nconst key = process.env.API_KEY;\nconsole.log(`Key: ${key.slice(0, 2)}***`);\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      ...
      {
        "level": 2,
        "text": "Add these two lines at the end of app.js, after the check for API_KEY.\n\nIn app.js:\n```\nconst key = process.env.API_KEY;\nconsole.log(`Key: ${key.slice(0, 2)}***`);\n```"
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "node-config-school-club-8",
    "index": 268,
    "task": "Add an import at the top of app.js. Then add two lines at the end to read the config file. This reads the currency from config.json. The code below does this. Run the checker to see if it works.\n\nIn app.js:\n```\nimport { readFile } from \"node:fs/promises\";\nconst fileConfig = JSON.parse(await readFile(\"config.json\", \"utf8\"));\nconsole.log(`Currency: ${fileConfig.currency}`);\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use the import to read files. Then read the config file and print its currency."
      },
      {
        "level": 2,
        "text": "Add the import at the top of app.js, then the two lines after the API_KEY check.\n\nIn app.js:\n```\nimport { readFile } from \"node:fs/promises\";\nconst fileConfig = JSON.parse(await readFile(\"config.json\", \"utf8\"));\nconsole.log(`Currency: ${fileConfig.currency}`);\n```"
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "node-config-school-club-9",
    "index": 269,
    "task": "Add two lines at the end of app.js. The first line checks if CURRENCY is set. If yes, use that. If not, use the value from config.json. The code below does this. Run the checker to see if it works.\n\nIn app.js:\n```\nconst currency = process.env.CURRENCY ?? fileConfig.currency;\nconsole.log(`Using ${currency}`);\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "If CURRENCY is set, use it. If not, fall back to config.json."
      },
      {
        "level": 2,
        "text": "Add these two lines at the end of app.js, after reading the config file.\n\nIn app.js:\n```\nconst currency = process.env.CURRENCY ?? fileConfig.currency;\nconsole.log(`Using ${currency}`);\n```"
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "node-config-school-club-10",
    "index": 270,
    "task": "Add two lines at the end of app.js. The first line checks if NODE_ENV is production. If yes, set mode to production. If not, set it to development. The code below does this. Run the checker to see if it works.\n\nIn app.js:\n```\nconst mode = process.env.NODE_ENV === \"production\" ? \"production\" : \"development\";\nconsole.log(`Mode: ${mode}`);\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "Only print production mode if NODE_ENV is set to production."
      },
      {
        "level": 2,
        "text": "Add these two lines at the end of app.js, after the currency check.\n\nIn app.js:\n```\nconst mode = process.env.NODE_ENV === \"production\" ? \"production\" : \"development\";\nconsole.log(`Mode: ${mode}`);\n```"
      }
    ],
    "xp": 10,
    "solution": {
...
nodeBasicsCourse.steps.push(...([
  {
    "id": "node-folders-school-club-6",
    "index": 276,
    "task": "You will add a new line to your code. This line makes a folder called 'archive'. The folder is safe to make even if it already exists. The code below does this. Run the command `node app.js` to test it. After you run it, check the report to see if the folder was made.\n\nIn app.js:\n```\nimport { readdir, mkdir } from \"node:fs/promises\";\nawait mkdir(\"archive\", { recursive: true });\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "Think of 'recursive' like a safety switch, it lets you make folders even if some parts are missing."
      },
      {
        "level": 2,
        "text": "Add the line at the end of the import section, right after 'mkdir'.\n\nIn app.js:\n```\nimport { readdir, mkdir } from \"node:fs/promises\";\nawait mkdir(\"archive\", { recursive: true });\n``` The command is: `node app.js`"
  ...
  {
    "id": "node-folders-school-club-7",
    "index": 277,
    "task": "You will add a new line to copy a file. The file 'records/a.txt' will be copied into the 'archive' folder. The code below does this. Run `node app.js` to test it. After you run it, check the report to see if the file was copied correctly.\n\nIn app.js:\n```\nimport { readdir, mkdir, copyFile } from \"node:fs/promises\";\nawait copyFile(file, path.join(\"archive\", \"a.txt\"));\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "The copy command needs the source file and the new destination path. Think of it like moving a book from one shelf to another."
      },
      {
        "level": 2,
        "text": "Add the line at the end of the import section, right after 'copyFile'.\n\nIn app.js:\n```\nimport { readdir, mkdir, copyFile } from \"node:fs/promises\";\nawait copyFile(file, path.join(\"archive\", \"a.txt\"));\n``` The command is: `node app.js`"
  ...
  {
    "id": "node-folders-school-club-8",
    "index": 278,
    "task": "You will add code to check the file's size. The script will read the file's details and print its size in bytes. The code below does this. After you add it, run the script to see the size printed.\n\nIn app.js:\n```\nimport { readdir, mkdir, copyFile, stat } from \"node:fs/promises\";\nconst info = await stat(file);\nconsole.log(`Size: ${info.size} bytes`);\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "The 'stat' function reads file details. You need to store the result in a variable before you can use it."
      },
      {
        "level": 2,
        "text": "Add the two lines at the end of the import section, right after 'stat'.\n\nIn app.js:\n```\nimport { readdir, mkdir, copyFile, stat } from \"node:fs/promises\";\nconst info = await stat(file);\nconsole.log(`Size: ${info.size} bytes`);\n```"
  ...
  {
    "id": "node-folders-school-club-9",
    "index": 279,
    "task": "You will add a new line to rename the file. The file 'archive/a.txt' will be renamed to 'archive/a-old.txt'. The code below does this. Run `node app.js` to test it. After you run it, check the report to see if the old file is gone and the new one is there.\n\nIn app.js:\n```\nimport { readdir, mkdir, copyFile, stat, rename } from \"node:fs/promises\";\nawait rename(path.join(\"archive\", \"a.txt\"), path.join(\"archive\", \"a-old.txt\"));\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "Rename means changing the name. The old file will disappear, and the new name will appear."
      },
      {
        "level": 2,
        "text": "Add the line at the end of the import section, right after 'rename'.\n\nIn app.js:\n```\nimport { readdir, mkdir, copyFile, stat, rename } from \"node:fs/promises\";\nawait rename(path.join(\"archive\", \"a.txt\"), path.join(\"archive\", \"a-old.txt\"));\n``` The command is: `node app.js`"
  ...
  {
    "id": "node-folders-school-club-10",
    "index": 280,
    "task": "You will add a line to check if the path is absolute. The code uses 'path.resolve' to make the path full and then checks if it is absolute. The code below does this. After you add it, run the script to see if it prints 'Absolute: true'.\n\nIn app.js:\n```\nconsole.log(`Absolute: ${path.isAbsolute(path.resolve(file))}`);\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "An absolute path starts from the root of your computer, like 'C:\\' or '/'."
      },
      {
        "level": 2,
        "text": "Add the line at the end of the script, right after the 'stat' part.\n\nIn app.js:\n```\nconsole.log(`Absolute: ${path.isAbsolute(path.resolve(file))}`);\n```"
      }
    ],
    "xp": 10,
    "solution": {
...
nodeBasicsCourse.steps.push(...([
  {
    "id": "node-files-tricycle-6",
    "index": 306,
    "task": "You will save the item objects to a file called stock.json. This file will hold the data in JSON format. The code below writes the items to that file. Run node app.js to test it. Then check the output to see if stock.json holds Market as JSON.\n\nIn app.js:\n```\nawait writeFile(\"stock.json\", JSON.stringify(items, null, 2));\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "tests": [
      {
        "id": "json",
        "label": "stock.json holds Market as JSON",
        "kind": "local-file-contains",
        "path": "stock.json",
        "value": "\"name\": \"Market\""
      }
    ...
    "hints": [
      {
        "level": 1,
        "text": "The file stock.json will store the data you made earlier."
      },
      {
        "level": 2,
        "text": "Add the code at the end of app.js, right after the items array.\n\nIn app.js:\n```\nawait writeFile(\"stock.json\", JSON.stringify(items, null, 2));\n``` The command is: `node app.js`"
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "node-files-tricycle-7",
    "index": 307,
    "task": "You will read the saved file back into objects and print how many items were saved. The code below reads the file and logs the count. Add these lines at the end of app.js. Run the script to check if it prints Saved: 3 items.\n\nIn app.js:\n```\nconst saved = JSON.parse(await readFile(\"stock.json\", \"utf8\"));\nconsole.log(`Saved: ${saved.length} items`);\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use JSON.parse to turn the text back into objects."
      },
      {
        "level": 2,
        "text": "Add the code at the end of app.js, after the writeFile line.\n\nIn app.js:\n```\nconst saved = JSON.parse(await readFile(\"stock.json\", \"utf8\"));\nconsole.log(`Saved: ${saved.length} items`);\n```"
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "node-files-tricycle-8",
    "index": 308,
    "task": "You will add a line to report.txt without deleting what's already there. The code below uses appendFile to add the text. Add this code to the imports and at the end of app.js. Then run node app.js. Check that report.txt ends with Checked today but still says Items: 3.\n\nIn app.js:\n```\nimport { readFile, writeFile, appendFile } from \"node:fs/promises\";\nawait appendFile(\"report.txt\", \"Checked today\\n\");\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "appendFile adds to the end of a file, not overwriting it."
      },
      {
        "level": 2,
        "text": "Add the code after the import line, and right before the console.log.\n\nIn app.js:\n```\nimport { readFile, writeFile, appendFile } from \"node:fs/promises\";\nawait appendFile(\"report.txt\", \"Checked today\\n\");\n``` The command is: `node app.js`"
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "node-files-tricycle-9",
    "index": 309,
    "task": "You will raise the first saved price by 7 and write the file again. The code below changes the first item's price and writes it back. Add these lines at the end of app.js. Run node app.js. Check that stock.json now has Market at 27.\n\nIn app.js:\n```\nsaved[0].price += 7;\nawait writeFile(\"stock.json\", JSON.stringify(saved, null, 2));\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "tests": [
      {
        "id": "raised",
        "label": "stock.json now has Market at 27",
        "kind": "local-file-contains",
        "path": "stock.json",
        "value": "\"price\": 27"
      }
    ...
    "hints": [
      ...
      {
        "level": 2,
        "text": "Add the code right after the saved variable is read.\n\nIn app.js:\n```\nsaved[0].price += 7;\nawait writeFile(\"stock.json\", JSON.stringify(saved, null, 2));\n``` The command is: `node app.js`"
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "node-files-tricycle-10",
    "index": 310,
    "task": "You will read a file that does not exist and handle the error without crashing. The code below uses try and catch to report the error code. Add this code at the end of app.js. Run the script. Check that it reports Could not read: ENOENT and still finishes normally.\n\nIn app.js:\n```\ntry { await readFile(\"missing.txt\", \"utf8\"); }\ncatch (error) { console.error(`Could not read: ${error.code}`); }\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use try...catch to handle errors safely."
      },
      {
        "level": 2,
        "text": "Add the code at the very end of app.js, after all other code.\n\nIn app.js:\n```\ntry { await readFile(\"missing.txt\", \"utf8\"); }\ncatch (error) { console.error(`Could not read: ${error.code}`); }\n```"
      }
    ],
    "xp": 10,
    "solution": {
...
nodeBasicsCourse.steps.push(...([
  {
    "id": "node-async-tricycle-6",
    "index": 316,
    "task": "You add two lines at the end of app.js. The code below waits for both promises to finish, even if one fails. It then prints their statuses. Run the checker to confirm it works.\n\nIn app.js:\n```\nconst results = await Promise.allSettled([fetchPrice(\"Market\"), failing()]);\nconsole.log(`Settled: ${results.map((result) => result.status).join(\" \")}`);\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "Promise.allSettled waits for all promises to finish, whether they succeed or fail."
      },
      {
        "level": 2,
        "text": "Add the code at the end of app.js, after the existing code.\n\nIn app.js:\n```\nconst results = await Promise.allSettled([fetchPrice(\"Market\"), failing()]);\nconsole.log(`Settled: ${results.map((result) => result.status).join(\" \")}`);\n```"
  ...
  {
    "id": "node-async-tricycle-7",
    "index": 317,
    "task": "You add a for...of loop at the end of app.js. The code below checks two names one after the other. It prints each result. Run the checker to confirm it works.\n\nIn app.js:\n```\nfor (const name of [\"Market\", \"School\"]) {\n  console.log(`Checked ${name}: ${await fetchPrice(name)}`);\n}\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "tests": [
      {
        "id": "loop",
        "label": "The script prints Checked School: 60",
        "kind": "local-node-prints",
        "file": "app.js",
        "value": "Checked School: 60"
      }
    ],
    "hints": [
      {
        "level": 1,
        "text": "The loop runs once for each name in the array. Wait for each fetch to finish before moving to the next."
      },
      {
        "level": 2,
        "text": "Add the code at the end of app.js, after the existing code.\n\nIn app.js:\n```\nfor (const name of [\"Market\", \"School\"]) {\n  console.log(`Checked ${name}: ${await fetchPrice(name)}`);\n}\n```"
  ...
  {
    "id": "node-async-tricycle-8",
    "index": 318,
    "task": "You add one line at the end of app.js. The code below runs the wait function, then always prints a cleanup message, whether it succeeds or fails. Run the checker to confirm it works.\n\nIn app.js:\n```\ntry { await wait(10); } finally { console.log(\"Cleanup done\"); }\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "The finally block runs no matter what happens in the try block."
      },
      {
        "level": 2,
        "text": "Add the code at the end of app.js, after the existing code.\n\nIn app.js:\n```\ntry { await wait(10); } finally { console.log(\"Cleanup done\"); }\n```"
  ...
  {
    "id": "node-async-tricycle-9",
    "index": 319,
    "task": "You add two lines at the end of app.js. The code below starts a timer that runs every 10 milliseconds. It counts ticks and stops after three. Run the checker to confirm it works.\n\nIn app.js:\n```\nlet ticks = 0;\nconst timer = setInterval(() => { ticks += 1; if (ticks === 3) { clearInterval(timer); console.log(\"Ticks: 3\"); } }, 10);\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "setInterval runs a function repeatedly. clearInterval stops it."
      },
      {
        "level": 2,
        "text": "Add the code at the end of app.js, after the existing code.\n\nIn app.js:\n```\nlet ticks = 0;\nconst timer = setInterval(() => { ticks += 1; if (ticks === 3) { clearInterval(timer); console.log(\"Ticks: 3\"); } }, 10);\n```"
  ...
  {
    "id": "node-async-tricycle-10",
    "index": 320,
    "task": "You add two lines at the end of app.js. The code below runs a timer with zero delay, then prints a sync message. The sync message prints first. Run the checker to confirm it works.\n\nIn app.js:\n```\nsetTimeout(() => console.log(\"Timer done\"), 0);\nconsole.log(\"Sync done\");\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "setTimeout with 0 delay runs after the current code finishes, but not instantly."
      },
      {
        "level": 2,
        "text": "Add the code at the end of app.js, after the existing code.\n\nIn app.js:\n```\nsetTimeout(() => console.log(\"Timer done\"), 0);\nconsole.log(\"Sync done\");\n```"
...
nodeBasicsCourse.steps.push(...([
  {
    "id": "node-folders-tricycle-1",
    "index": 341,
    "task": "You will add two lines to the end of app.js. The first line builds a path using path.join. The second line prints that path with forward slashes. This shows how Node.js handles file paths. The code below does that. Run the checker and paste its report.\n\nIn app.js:\n```\nconst file = path.join(\"records\", \"a.txt\");\nconsole.log(file.split(path.sep).join(\"/\"));\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
  ...
  {
    "id": "node-folders-tricycle-2",
    "index": 342,
    "task": "You will add one line to the end of app.js. This line gets the file's extension using path.extname. It prints it with a label. The code below does that. Run the checker and paste its report.\n\nIn app.js:\n```\nconsole.log(`Extension: ${path.extname(file)}`);\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "path.extname gets the part after the last dot, like .txt or .js."
      },
      {
        "level": 2,
        "text": "Add this line after the previous code, at the end of app.js.\n\nIn app.js:\n```\nconsole.log(`Extension: ${path.extname(file)}`);\n```"
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "node-folders-tricycle-3",
    "index": 343,
    "task": "You will add one line to the end of app.js. This line uses path.basename to get the file name without the .txt. It prints that name. The code below does that. Run the checker and paste its report.\n\nIn app.js:\n```\nconsole.log(`Base: ${path.basename(file, \".txt\")}`);\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "path.basename removes the extension if you tell it what to remove."
      },
      {
        "level": 2,
        "text": "Add this line after the previous code, at the end of app.js.\n\nIn app.js:\n```\nconsole.log(`Base: ${path.basename(file, \".txt\")}`);\n```"
  ...
  {
    "id": "node-folders-tricycle-4",
    "index": 344,
    "task": "You will add three lines to app.js. The first line imports readdir from Node.js. The next two lines read the records folder and print how many files it has. The code below does that. Run the checker and paste its report.\n\nIn app.js:\n```\nimport { readdir } from \"node:fs/promises\";\nconst names = await readdir(\"records\");\nconsole.log(`Files: ${names.length}`);\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "readdir reads the contents of a folder and returns an array."
      },
      {
        "level": 2,
        "text": "Add these lines after the import, right after the last line.\n\nIn app.js:\n```\nimport { readdir } from \"node:fs/promises\";\nconst names = await readdir(\"records\");\nconsole.log(`Files: ${names.length}`);\n```"
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "node-folders-tricycle-5",
    "index": 345,
    "task": "You will add two lines to the end of app.js. The first line filters the file names to keep only .txt files. The second line prints how many .txt files there are. The code below does that. Run the checker and paste its report.\n\nIn app.js:\n```\nconst textFiles = names.filter((name) => path.extname(name) === \".txt\");\nconsole.log(`Text files: ${textFiles.length}`);\n```",
    "kind": "local",
    "inputMode": "free",
    "files": {
      "report.txt": ""
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use filter to keep only the files with .txt extension."
      },
      {
        "level": 2,
        "text": "Add these lines after the previous code, at the end of app.js.\n\nIn app.js:\n```\nconst textFiles = names.filter((name) => path.extname(name) === \".txt\");\nconsole.log(`Text files: ${textFiles.length}`);\n```"
      }
    ],
    "xp": 10,
    "solution": {
