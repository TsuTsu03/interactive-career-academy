...
const references = {
  ...
  "rate-2-list-style-type": { estimatedMinutes: 4, solution: solvedRate2(".item-list {\n  list-style-type: none;\n}") },
  "rate-2-padding-left": { estimatedMinutes: 4, solution: solvedRate2(".item-list {\n  list-style-type: none;\n  padding-left: 0px;\n}") },
  "rate-2-background-color": { estimatedMinutes: 4, solution: solvedRate2(".item-list {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n}") },
  "rate-2-border-radius": { estimatedMinutes: 4, solution: solvedRate2(".item-list {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n  border-radius: 8px;\n}") },
  "rate-2-padding-top": { estimatedMinutes: 4, solution: solvedRate2(".item-list {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n  border-radius: 8px;\n  padding-top: 12px;\n}") },
...
export const cssCourse: Course = {
  ...
  steps: [
    ...
    s73({ id: "rate-2-list-style-type", task: "Take the bullets off the list.", inputMode: "guided", files: solvedRate2(".item-list {\n  list-style-type: ;\n}"), activeFile: "styles.css", highlightToken: "list-style-type: ;", tests: [{ id: "rate-2-list-style-type-set", kind: "style", selector: ".item-list", prop: "list-style-type", equals: "none", readable: "no bullets", label: "The list is set to no bullets" }], hints: [{ level: 1, text: "Use the value that means no marker at all." }, { level: 2, text: "Write none after the colon." }], xp: 45 }),
    s73({ id: "rate-2-padding-left", task: "Remove the indent the bullets left behind.", inputMode: "guided", files: solvedRate2(".item-list {\n  list-style-type: none;\n  padding-left: ;\n}"), activeFile: "styles.css", highlightToken: "padding-left: ;", tests: [{ id: "rate-2-padding-left-set", kind: "style", selector: ".item-list", prop: "padding-left", equals: "0px", readable: "no left indent", label: "The list keeps its words clear by no left indent" }], hints: [{ level: 1, text: "Use zero pixels." }, { level: 2, text: "Write 0px after the colon." }], xp: 45 }),
    s73({ id: "rate-2-background-color", task: "Tint the list so it reads as one block.", inputMode: "guided", files: solvedRate2(".item-list {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: ;\n}"), activeFile: "styles.css", highlightToken: "background-color: ;", tests: [{ id: "rate-2-background-color-set", kind: "style", selector: ".item-list", prop: "background-color", equals: "rgb(248, 250, 252)", readable: "pale grey", label: "The list has a background of pale grey" }], hints: [{ level: 1, text: "Use the pale grey code." }, { level: 2, text: "Write #f8fafc after the colon." }], xp: 45 }),
    s73({ id: "rate-2-border-radius", task: "Round the list corners.", inputMode: "guided", files: solvedRate2(".item-list {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n  border-radius: ;\n}"), activeFile: "styles.css", highlightToken: "border-radius: ;", tests: [{ id: "rate-2-border-radius-set", kind: "style", selector: ".item-list", prop: "border-top-left-radius", equals: "8px", readable: "8 pixels", label: "The list has corners curved by 8 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the corner curve." }, { level: 2, text: "Write 8px after the colon." }], xp: 45 }),
    s73({ id: "rate-2-padding-top", task: "Keep the first item clear of the top edge.", inputMode: "guided", files: solvedRate2(".item-list {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n  border-radius: 8px;\n  padding-top: ;\n}"), activeFile: "styles.css", highlightToken: "padding-top: ;", tests: [{ id: "rate-2-padding-top-set", kind: "style", selector: ".item-list", prop: "padding-top", equals: "12px", readable: "12 pixels", label: "The list has room above of 12 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the space above." }, { level: 2, text: "Write 12px after the colon." }], xp: 45 }),
    ...
    s77({ id: "list-3-font-style", task: "Keep the text upright rather than slanted.", inputMode: "guided", files: solvedList3(".info-card {\n  text-transform: uppercase;\n  font-style: ;\n}"), activeFile: "styles.css", highlightToken: "font-style: ;", tests: [{ id: "list-3-font-style-set", kind: "style", selector: ".info-card", prop: "font-style", equals: "normal", readable: "upright", label: "The card text is set to upright" }], hints: [{ level: 1, text: "Use the value that means not italic." }, { level: 2, text: "Write normal after the colon." }], xp: 45 }),
