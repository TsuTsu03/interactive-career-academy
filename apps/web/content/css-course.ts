...
/* css-topic: sizing-limits */
const SLIP_2_HTML = `<article class="info-card">
  <h2>Card Design</h2>
  <p>Size Limits</p>
  <p class="info-detail">Bakery Order</p>
</article>`;
const solvedSlip2 = (styles: string): Record<string, string> => ({ "index.html": SLIP_2_HTML, "styles.css": css(styles) });

/* css-topic: backgrounds */
const STATION_BACKGROUNDS_HTML = `<aside class="notice-banner">
  <h2>Tinted Banner</h2>
  <p>Water Refill Station Notice</p>
</aside>`;
const solvedStationBackgrounds = (styles: string): Record<string, string> => ({ "index.html": STATION_BACKGROUNDS_HTML, "styles.css": css(styles) });

/* css-topic: units */
const UP_UNITS_HTML = `<article class="info-card">
  <h2>Barangay Clean-Up</h2>
  <p>Join Our Drive!</p>
  <p class="info-detail">Clean for Everyone, Save the Planet!</p>
</article>`;
const solvedUpUnits = (styles: string): Record<string, string> => ({ "index.html": UP_UNITS_HTML, "styles.css": css(styles) });

/* css-topic: list-styling */
const RATE_2_HTML = `<section class="item-list">
  <h2>Computer Shop Rate Card</h2>
  <ul>
    <li>Laptop Repair: PHP 85</li>
    <li>Hardware Upgrade: PHP 120</li>
    <li>Software Installation: PHP 75</li>
  </ul>
</section>`;
const solvedRate2 = (styles: string): Record<string, string> => ({ "index.html": RATE_2_HTML, "styles.css": css(styles) });

/* css-topic: hover-state */
const PROGRAMME_2_HTML = `<div class="price-row">
  <span class="price-name">Tickets</span>
  <span class="price-amount">Cost</span>
</div>`;
const solvedProgramme2 = (styles: string): Record<string, string> => ({ "index.html": PROGRAMME_2_HTML, "styles.css": css(styles) });

/* css-topic: grid-repeat */
const PRICE_2_HTML = `<section class="stall-grid">
  <article class="stall-cell">Rice</article>
  <article class="stall-cell">Beans</article>
  <article class="stall-cell">Eggs</article>
  <article class="stall-cell">Oil</article>
</section>`;
const solvedPrice2 = (styles: string): Record<string, string> => ({ "index.html": PRICE_2_HTML, "styles.css": css(styles) });

/* css-topic: opacity-layer */
const RECEIPT_2_HTML = `<aside class="notice-banner">
  <h2>WELCOME TO JADE LAUNDRY</h2>
  <p>Your clothes cleaned, your worries gone.</p>
</aside>`;
const solvedReceipt2 = (styles: string): Record<string, string> => ({ "index.html": RECEIPT_2_HTML, "styles.css": css(styles) });

/* css-topic: text-detail */
const LIST_3_HTML = `<article class="info-card">
  <h2>Medicine List</h2>
  <p>Drug Name - Quantity</p>
  <p class="info-detail">Price per Unit</p>
</article>`;
const solvedList3 = (styles: string): Record<string, string> => ({ "index.html": LIST_3_HTML, "styles.css": css(styles) });

/* css-topic: sizing-limits */
const APPLICATION_2_HTML = `<article class="info-card">
  <h2>Application Notice</h2>
  <p>For Barangay ID Card Issuance</p>
  <p class="info-detail">Please Submit All Required Documents</p>
</article>`;
const solvedApplication2 = (styles: string): Record<string, string> => ({ "index.html": APPLICATION_2_HTML, "styles.css": css(styles) });

/* css-topic: pseudo-elements */
const PSEUDO_ELEMENTS_HTML = `<aside class="notice-banner">
  <h2>Sari-Sari Store</h2>
  <p>Reminder: Credit Due</p>
</aside>`;
const solvedPseudoElements = (styles: string): Record<string, string> => ({ "index.html": PSEUDO_ELEMENTS_HTML, "styles.css": css(styles) });

/* css-topic: flex-wrap */
const FLEX_WRAP_HTML = `<section class="stall-grid">
  <article class="stall-cell">Barangay Notice</article>
  <article class="stall-cell">Curfew Time</article>
  <article class="stall-cell">Items Wrap</article>
  <article class="stall-cell">Nightfall to Dawn</article>
</section>`;
const solvedFlexWrap = (styles: string): Record<string, string> => ({ "index.html": FLEX_WRAP_HTML, "styles.css": css(styles) });

/* css-topic: fluid-sizing */
const FLUID_SIZING_HTML = `<article class="info-card">
  <h2>Welcome</h2>
  <p>Timetable Updates</p>
  <p class="info-detail">Departure: 12:30, Arrival: 4:00</p>
</article>`;
const solvedFluidSizing = (styles: string): Record<string, string> => ({ "index.html": FLUID_SIZING_HTML, "styles.css": css(styles) });

/* css-topic: pseudo-elements */
const STORE_2_HTML = `<aside class="notice-banner">
  <h2>Sari-Sari Store</h2>
  <p>Price List</p>
</aside>`;
const solvedStore2 = (styles: string): Record<string, string> => ({ "index.html": STORE_2_HTML, "styles.css": css(styles) });

/* css-topic: flex-wrap */
const CENTRE_2_HTML = `<section class="stall-grid">
  <article class="stall-cell">Barangay Health Center Notice</article>
  <article class="stall-cell">Items Wrap on Narrow Screen</article>
  <article class="stall-cell">For Barangay Residents Only</article>
  <article class="stall-cell">Contact Us: (912) 123-4567</article>
</section>`;
const solvedCentre2 = (styles: string): Record<string, string> => ({ "index.html": CENTRE_2_HTML, "styles.css": css(styles) });

/* css-topic: fluid-sizing */
const BOARD_2_HTML = `<article class="info-card">
  <h2>Responsive Design</h2>
  <p>Adjusting Sizes</p>
  <p class="info-detail">Like Jeepney Routes</p>
</article>`;
const solvedBoard2 = (styles: string): Record<string, string> => ({ "index.html": BOARD_2_HTML, "styles.css": css(styles) });

/* css-topic: pseudo-elements */
const STALL_3_HTML = `<aside class="notice-banner">
  <h2>Fresh tilapia now</h2>
  <p>PHP 85 per kilo</p>
</aside>`;
const solvedStall3 = (styles: string): Record<string, string> => ({ "index.html": STALL_3_HTML, "styles.css": css(styles) });

/* css-topic: flex-wrap */
const MENU_2_HTML = `<section class="stall-grid">
  <article class="stall-cell">Menu</article>
  <article class="stall-cell">Items</article>
  <article class="stall-cell">Wrap</article>
  <article class="stall-cell">Narrow</article>
</section>`;
const solvedMenu2 = (styles: string): Record<string, string> => ({ "index.html": MENU_2_HTML, "styles.css": css(styles) });

/* css-topic: fluid-sizing */
const LEAGUE_2_HTML = `<article class="info-card">
  <h2>Page Title</h2>
  <p>Schedule Resize</p>
  <p class="info-detail">Responsive Design</p>
</article>`;
const solvedLeague2 = (styles: string): Record<string, string> => ({ "index.html": LEAGUE_2_HTML, "styles.css": css(styles) });
...
const references = {
  ...
  "list-styling-list-style-type": { estimatedMinutes: 4, solution: solvedListStyling(".item-list ul {\n  list-style-type: none;\n}") },
  "list-styling-padding-left": { estimatedMinutes: 4, solution: solvedListStyling(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n}") },
  "list-styling-background-color": { estimatedMinutes: 4, solution: solvedListStyling(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n}") },
  "list-styling-border-radius": { estimatedMinutes: 4, solution: solvedListStyling(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n  border-radius: 8px;\n}") },
  "list-styling-padding-top": { estimatedMinutes: 4, solution: solvedListStyling(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n  border-radius: 8px;\n  padding-top: 12px;\n}") },
  ...
  "stall-2-list-style-type": { estimatedMinutes: 4, solution: solvedStall2(".item-list ul {\n  list-style-type: none;\n}") },
  "stall-2-padding-left": { estimatedMinutes: 4, solution: solvedStall2(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n}") },
  "stall-2-background-color": { estimatedMinutes: 4, solution: solvedStall2(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n}") },
  "stall-2-border-radius": { estimatedMinutes: 4, solution: solvedStall2(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n  border-radius: 8px;\n}") },
  "stall-2-padding-top": { estimatedMinutes: 4, solution: solvedStall2(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n  border-radius: 8px;\n  padding-top: 12px;\n}") },
  ...
  "slip-2-min-width": { estimatedMinutes: 4, solution: solvedSlip2(".info-card {\n  min-width: 240px;\n}") },
  "slip-2-max-width": { estimatedMinutes: 4, solution: solvedSlip2(".info-card {\n  min-width: 240px;\n  max-width: 520px;\n}") },
  "slip-2-min-height": { estimatedMinutes: 4, solution: solvedSlip2(".info-card {\n  min-width: 240px;\n  max-width: 520px;\n  min-height: 120px;\n}") },
  "slip-2-box-sizing": { estimatedMinutes: 4, solution: solvedSlip2(".info-card {\n  min-width: 240px;\n  max-width: 520px;\n  min-height: 120px;\n  box-sizing: border-box;\n}") },
  "slip-2-padding": { estimatedMinutes: 4, solution: solvedSlip2(".info-card {\n  min-width: 240px;\n  max-width: 520px;\n  min-height: 120px;\n  box-sizing: border-box;\n  padding: 20px;\n}") },
  "station-backgrounds-background-color": { estimatedMinutes: 4, solution: solvedStationBackgrounds(".notice-banner {\n  background-color: #ecfdf5;\n}") },
  "station-backgrounds-background-image": { estimatedMinutes: 4, solution: solvedStationBackgrounds(".notice-banner {\n  background-color: #ecfdf5;\n  background-image: linear-gradient(#ecfdf5, #d1fae5);\n}") },
  "station-backgrounds-background-clip": { estimatedMinutes: 4, solution: solvedStationBackgrounds(".notice-banner {\n  background-color: #ecfdf5;\n  background-image: linear-gradient(#ecfdf5, #d1fae5);\n  background-clip: padding-box;\n}") },
  "station-backgrounds-padding": { estimatedMinutes: 4, solution: solvedStationBackgrounds(".notice-banner {\n  background-color: #ecfdf5;\n  background-image: linear-gradient(#ecfdf5, #d1fae5);\n  background-clip: padding-box;\n  padding: 18px;\n}") },
  "station-backgrounds-border-radius": { estimatedMinutes: 4, solution: solvedStationBackgrounds(".notice-banner {\n  background-color: #ecfdf5;\n  background-image: linear-gradient(#ecfdf5, #d1fae5);\n  background-clip: padding-box;\n  padding: 18px;\n  border-radius: 8px;\n}") },
  "up-units-font-size": { estimatedMinutes: 4, solution: solvedUpUnits(".info-card {\n  font-size: 1rem;\n}") },
  "up-units-padding": { estimatedMinutes: 4, solution: solvedUpUnits(".info-card {\n  font-size: 1rem;\n  padding: 1.25rem;\n}") },
  "up-units-max-width": { estimatedMinutes: 4, solution: solvedUpUnits(".info-card {\n  font-size: 1rem;\n  padding: 1.25rem;\n  max-width: 30rem;\n}") },
  "up-units-line-height": { estimatedMinutes: 4, solution: solvedUpUnits(".info-card {\n  font-size: 1rem;\n  padding: 1.25rem;\n  max-width: 30rem;\n  line-height: 1.5;\n}") },
  "up-units-border-radius": { estimatedMinutes: 4, solution: solvedUpUnits(".info-card {\n  font-size: 1rem;\n  padding: 1.25rem;\n  max-width: 30rem;\n  line-height: 1.5;\n  border-radius: 0.5rem;\n}") },
  "rate-2-list-style-type": { estimatedMinutes: 4, solution: solvedRate2(".item-list ul {\n  list-style-type: none;\n}") },
  "rate-2-padding-left": { estimatedMinutes: 4, solution: solvedRate2(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n}") },
  "rate-2-background-color": { estimatedMinutes: 4, solution: solvedRate2(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n}") },
  "rate-2-border-radius": { estimatedMinutes: 4, solution: solvedRate2(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n  border-radius: 8px;\n}") },
  "rate-2-padding-top": { estimatedMinutes: 4, solution: solvedRate2(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n  border-radius: 8px;\n  padding-top: 12px;\n}") },
  "programme-2-padding": { estimatedMinutes: 4, solution: solvedProgramme2(".price-row {\n  padding: 12px;\n}") },
  "programme-2-cursor": { estimatedMinutes: 4, solution: solvedProgramme2(".price-row {\n  padding: 12px;\n  cursor: pointer;\n}") },
  "programme-2-transition-property": { estimatedMinutes: 4, solution: solvedProgramme2(".price-row {\n  padding: 12px;\n  cursor: pointer;\n  transition-property: background-color;\n}") },
  "programme-2-transition-duration": { estimatedMinutes: 4, solution: solvedProgramme2(".price-row {\n  padding: 12px;\n  cursor: pointer;\n  transition-property: background-color;\n  transition-duration: 150ms;\n}") },
  "programme-2-transition-timing-function": { estimatedMinutes: 4, solution: solvedProgramme2(".price-row {\n  padding: 12px;\n  cursor: pointer;\n  transition-property: background-color;\n  transition-duration: 150ms;\n  transition-timing-function: ease-out;\n}") },
  "price-2-display": { estimatedMinutes: 4, solution: solvedPrice2(".stall-grid {\n  display: grid;\n}") },
  "price-2-grid-template-columns": { estimatedMinutes: 4, solution: solvedPrice2(".stall-grid {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n}") },
  "price-2-row-gap": { estimatedMinutes: 4, solution: solvedPrice2(".stall-grid {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  row-gap: 10px;\n}") },
  "price-2-column-gap": { estimatedMinutes: 4, solution: solvedPrice2(".stall-grid {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  row-gap: 10px;\n  column-gap: 16px;\n}") },
  "price-2-align-items": { estimatedMinutes: 4, solution: solvedPrice2(".stall-grid {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  row-gap: 10px;\n  column-gap: 16px;\n  align-items: stretch;\n}") },
  "receipt-2-padding": { estimatedMinutes: 4, solution: solvedReceipt2(".notice-banner {\n  padding: 16px;\n}") },
  "receipt-2-opacity": { estimatedMinutes: 4, solution: solvedReceipt2(".notice-banner {\n  padding: 16px;\n  opacity: 0.95;\n}") },
  "receipt-2-z-index": { estimatedMinutes: 4, solution: solvedReceipt2(".notice-banner {\n  padding: 16px;\n  opacity: 0.95;\n  z-index: 10;\n}") },
  "receipt-2-position": { estimatedMinutes: 4, solution: solvedReceipt2(".notice-banner {\n  padding: 16px;\n  opacity: 0.95;\n  z-index: 10;\n  position: relative;\n}") },
  "receipt-2-background-color": { estimatedMinutes: 4, solution: solvedReceipt2(".notice-banner {\n  padding: 16px;\n  opacity: 0.95;\n  z-index: 10;\n  position: relative;\n  background-color: #fef2f2;\n}") },
  "list-3-text-transform": { estimatedMinutes: 4, solution: solvedList3(".info-card {\n  text-transform: uppercase;\n}") },
  "list-3-font-style": { estimatedMinutes: 4, solution: solvedList3(".info-card {\n  text-transform: uppercase;\n  font-style: normal;\n}") },
  "list-3-text-decoration-line": { estimatedMinutes: 4, solution: solvedList3(".info-card {\n  text-transform: uppercase;\n  font-style: normal;\n  text-decoration-line: underline;\n}") },
  "list-3-text-indent": { estimatedMinutes: 4, solution: solvedList3(".info-card {\n  text-transform: uppercase;\n  font-style: normal;\n  text-decoration-line: underline;\n  text-indent: 8px;\n}") },
  "list-3-word-spacing": { estimatedMinutes: 4, solution: solvedList3(".info-card {\n  text-transform: uppercase;\n  font-style: normal;\n  text-decoration-line: underline;\n  text-indent: 8px;\n  word-spacing: 1px;\n}") },
  "application-2-min-width": { estimatedMinutes: 4, solution: solvedApplication2(".info-card {\n  min-width: 240px;\n}") },
  "application-2-max-width": { estimatedMinutes: 4, solution: solvedApplication2(".info-card {\n  min-width: 240px;\n  max-width: 520px;\n}") },
  "application-2-min-height": { estimatedMinutes: 4, solution: solvedApplication2(".info-card {\n  min-width: 240px;\n  max-width: 520px;\n  min-height: 120px;\n}") },
  "application-2-box-sizing": { estimatedMinutes: 4, solution: solvedApplication2(".info-card {\n  min-width: 240px;\n  max-width: 520px;\n  min-height: 120px;\n  box-sizing: border-box;\n}") },
  "application-2-padding": { estimatedMinutes: 4, solution: solvedApplication2(".info-card {\n  min-width: 240px;\n  max-width: 520px;\n  min-height: 120px;\n  box-sizing: border-box;\n  padding: 20px;\n}") },
  "pseudo-elements-position": { estimatedMinutes: 4, solution: solvedPseudoElements(".notice-banner {\n  position: relative;\n}") },
  "pseudo-elements-padding-top": { estimatedMinutes: 4, solution: solvedPseudoElements(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n}") },
  "pseudo-elements-content-before": { estimatedMinutes: 4, solution: solvedPseudoElements(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n}\n\n.notice-banner::before {\n  content: 'Notice';\n}") },
  "pseudo-elements-color-before": { estimatedMinutes: 4, solution: solvedPseudoElements(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n}\n\n.notice-banner::before {\n  content: 'Notice';\n  color: #b45309;\n}") },
  "pseudo-elements-background-color": { estimatedMinutes: 4, solution: solvedPseudoElements(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n  background-color: #fffbeb;\n}\n\n.notice-banner::before {\n  content: 'Notice';\n  color: #b45309;\n}") },
  "flex-wrap-display": { estimatedMinutes: 4, solution: solvedFlexWrap(".stall-grid {\n  display: flex;\n}") },
  "flex-wrap-flex-wrap": { estimatedMinutes: 4, solution: solvedFlexWrap(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n}") },
  "flex-wrap-gap": { estimatedMinutes: 4, solution: solvedFlexWrap(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 12px;\n}") },
  "flex-wrap-justify-content": { estimatedMinutes: 4, solution: solvedFlexWrap(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 12px;\n  justify-content: flex-start;\n}") },
  "flex-wrap-align-content": { estimatedMinutes: 4, solution: solvedFlexWrap(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 12px;\n  justify-content: flex-start;\n  align-content: flex-start;\n}") },
  "fluid-sizing-width": { estimatedMinutes: 4, solution: solvedFluidSizing(".info-card {\n  width: min(100%, 480px);\n}") },
  "fluid-sizing-font-size": { estimatedMinutes: 4, solution: solvedFluidSizing(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n}") },
  "fluid-sizing-aspect-ratio": { estimatedMinutes: 4, solution: solvedFluidSizing(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: 3 / 2;\n}") },
  "fluid-sizing-padding": { estimatedMinutes: 4, solution: solvedFluidSizing(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: 3 / 2;\n  padding: 16px;\n}") },
  "fluid-sizing-box-sizing": { estimatedMinutes: 4, solution: solvedFluidSizing(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: 3 / 2;\n  padding: 16px;\n  box-sizing: border-box;\n}") },
  "store-2-position": { estimatedMinutes: 4, solution: solvedStore2(".notice-banner {\n  position: relative;\n}") },
  "store-2-padding-top": { estimatedMinutes: 4, solution: solvedStore2(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n}") },
  "store-2-content-before": { estimatedMinutes: 4, solution: solvedStore2(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n}\n\n.notice-banner::before {\n  content: 'Notice';\n}") },
  "store-2-color-before": { estimatedMinutes: 4, solution: solvedStore2(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n}\n\n.notice-banner::before {\n  content: 'Notice';\n  color: #b45309;\n}") },
  "store-2-background-color": { estimatedMinutes: 4, solution: solvedStore2(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n  background-color: #fffbeb;\n}\n\n.notice-banner::before {\n  content: 'Notice';\n  color: #b45309;\n}") },
  "centre-2-display": { estimatedMinutes: 4, solution: solvedCentre2(".stall-grid {\n  display: flex;\n}") },
  "centre-2-flex-wrap": { estimatedMinutes: 4, solution: solvedCentre2(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n}") },
  "centre-2-gap": { estimatedMinutes: 4, solution: solvedCentre2(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 12px;\n}") },
  "centre-2-justify-content": { estimatedMinutes: 4, solution: solvedCentre2(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 12px;\n  justify-content: flex-start;\n}") },
  "centre-2-align-content": { estimatedMinutes: 4, solution: solvedCentre2(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 12px;\n  justify-content: flex-start;\n  align-content: flex-start;\n}") },
  "board-2-width": { estimatedMinutes: 4, solution: solvedBoard2(".info-card {\n  width: min(100%, 480px);\n}") },
  "board-2-font-size": { estimatedMinutes: 4, solution: solvedBoard2(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n}") },
  "board-2-aspect-ratio": { estimatedMinutes: 4, solution: solvedBoard2(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: 3 / 2;\n}") },
  "board-2-padding": { estimatedMinutes: 4, solution: solvedBoard2(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: 3 / 2;\n  padding: 16px;\n}") },
  "board-2-box-sizing": { estimatedMinutes: 4, solution: solvedBoard2(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: 3 / 2;\n  padding: 16px;\n  box-sizing: border-box;\n}") },
  "stall-3-position": { estimatedMinutes: 4, solution: solvedStall3(".notice-banner {\n  position: relative;\n}") },
  "stall-3-padding-top": { estimatedMinutes: 4, solution: solvedStall3(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n}") },
  "stall-3-content-before": { estimatedMinutes: 4, solution: solvedStall3(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n}\n\n.notice-banner::before {\n  content: 'Notice';\n}") },
  "stall-3-color-before": { estimatedMinutes: 4, solution: solvedStall3(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n}\n\n.notice-banner::before {\n  content: 'Notice';\n  color: #b45309;\n}") },
  "stall-3-background-color": { estimatedMinutes: 4, solution: solvedStall3(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n  background-color: #fffbeb;\n}\n\n.notice-banner::before {\n  content: 'Notice';\n  color: #b45309;\n}") },
  "menu-2-display": { estimatedMinutes: 4, solution: solvedMenu2(".stall-grid {\n  display: flex;\n}") },
  "menu-2-flex-wrap": { estimatedMinutes: 4, solution: solvedMenu2(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n}") },
  "menu-2-gap": { estimatedMinutes: 4, solution: solvedMenu2(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 12px;\n}") },
  "menu-2-justify-content": { estimatedMinutes: 4, solution: solvedMenu2(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 12px;\n  justify-content: flex-start;\n}") },
  "menu-2-align-content": { estimatedMinutes: 4, solution: solvedMenu2(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 12px;\n  justify-content: flex-start;\n  align-content: flex-start;\n}") },
  "league-2-width": { estimatedMinutes: 4, solution: solvedLeague2(".info-card {\n  width: min(100%, 480px);\n}") },
  "league-2-font-size": { estimatedMinutes: 4, solution: solvedLeague2(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n}") },
  "league-2-aspect-ratio": { estimatedMinutes: 4, solution: solvedLeague2(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: 3 / 2;\n}") },
  "league-2-padding": { estimatedMinutes: 4, solution: solvedLeague2(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: 3 / 2;\n  padding: 16px;\n}") },
  "league-2-box-sizing": { estimatedMinutes: 4, solution: solvedLeague2(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: 3 / 2;\n  padding: 16px;\n  box-sizing: border-box;\n}") },
...
const PROJECT_70_ID = "bakery-order-slip-2";
const PROJECT_71_ID = "water-refill-station-backgrounds";
const PROJECT_72_ID = "barangay-clean-up-units";
const PROJECT_73_ID = "computer-shop-rate-2";
const PROJECT_74_ID = "fiesta-programme-2";
const PROJECT_75_ID = "rice-retailer-price-2";
const PROJECT_76_ID = "laundry-shop-receipt-2";
const PROJECT_77_ID = "pharmacy-stock-list-3";
const PROJECT_78_ID = "barangay-id-application-2";
const PROJECT_79_ID = "sari-sari-store-pseudo-elements";
const PROJECT_80_ID = "barangay-curfew-notice-flex-wrap";
const PROJECT_81_ID = "jeepney-terminal-timetable-fluid-sizing";
const PROJECT_82_ID = "sari-sari-store-2";
const PROJECT_83_ID = "barangay-health-centre-2";
const PROJECT_84_ID = "jeepney-route-board-2";
const PROJECT_85_ID = "palengke-fish-stall-3";
const PROJECT_86_ID = "turo-turo-menu-2";
const PROJECT_87_ID = "barangay-basketball-league-2";
...
const s70 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_70_ID }; };

const s71 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_71_ID }; };

const s72 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_72_ID }; };

const s73 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_73_ID }; };

const s74 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_74_ID }; };

const s75 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_75_ID }; };

const s76 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_76_ID }; };

const s77 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_77_ID }; };

const s78 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_78_ID }; };

const s79 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_79_ID }; };

const s80 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_80_ID }; };

const s81 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_81_ID }; };

const s82 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_82_ID }; };

const s83 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_83_ID }; };

const s84 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_84_ID }; };

const s85 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_85_ID }; };

const s86 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_86_ID }; };

const s87 = (step: Omit<Step, "index" | "kind" | "projectId">): Step => { const reference = references[step.id as keyof typeof references]; if (!reference) throw new Error(`Missing reference data for CSS step: ${step.id}`); return { ...step, ...reference, index: ++n, kind: "web", projectId: PROJECT_87_ID }; };
...
export const cssCourse: Course = {
  ...
  steps: [
    ...
    s20({ id: "curfew-notice-border-left-width", task: "Give the notice a thick stripe down its left side.", inputMode: "guided", files: solvedCurfewNotice(".notice-banner {\n  border-left-width: ;\n}"), activeFile: "styles.css", highlightToken: "border-left-width: ;", tests: [{ id: "curfew-notice-border-left-width-set", kind: "source-matches", file: "styles.css", pattern: "border-left-width\\s*:\\s*4px", flags: "i", because: "Write the four-pixel stripe width.", label: "The declaration is written" }], hints: [{ level: 1, text: "Use a pixel value for the stripe width." }, { level: 2, text: "Write 4px after the colon." }], xp: 55 }),
    ...
    s25({ id: "fish-stall-font-size", task: "Set a comfortable reading size.", inputMode: "guided", files: solvedFishStall(".info-card {\n  max-width: 480px;\n  width: 100%;\n  padding: 16px;\n  font-size: ;\n}"), activeFile: "styles.css", highlightToken: "font-size: ;", tests: [{ id: "fish-stall-font-size-set", kind: "source-matches", file: "styles.css", pattern: "font-size\\s*:\\s*16px", flags: "i", because: "Write the reading size explicitly.", label: "The declaration is written" }], hints: [{ level: 1, text: "Use a pixel value for the text size." }, { level: 2, text: "Write 16px after the colon." }], xp: 55 }),
    ...
    s26({ id: "turo-menu-border", task: "Add a faint edge so the card reads on a white page.", inputMode: "guided", files: solvedTuroMenu(".info-card {\n  background-color: #ffffff;\n  border-radius: 10px;\n  box-shadow: 0 1px 3px rgba(15, 23, 42, 0.2);\n  padding: 20px;\n  border: ;\n}"), activeFile: "styles.css", highlightToken: "border: ;", tests: [{ id: "turo-menu-border-set", kind: "source-matches", file: "styles.css", pattern: "border\\s*:\\s*1px\\s+solid\\s+#e2e8f0", flags: "i", because: "A border needs a width, a line style, and a colour, in that order.", label: "The card has an edge of a thin grey edge" }], hints: [{ level: 1, text: "A border needs a width, a style, and a colour." }, { level: 2, text: "Write 1px solid #e2e8f0 after the colon." }], xp: 45 }),
    ...
    s32({ id: "clean-up-font-size", task: "Set a comfortable reading size.", inputMode: "guided", files: solvedCleanUp(".info-card {\n  max-width: 480px;\n  width: 100%;\n  padding: 16px;\n  font-size: ;\n}"), activeFile: "styles.css", highlightToken: "font-size: ;", tests: [{ id: "clean-up-font-size-set", kind: "source-matches", file: "styles.css", pattern: "font-size\\s*:\\s*16px", flags: "i", because: "Write the reading size explicitly.", label: "The declaration is written" }], hints: [{ level: 1, text: "Use a pixel value for the text size." }, { level: 2, text: "Write 16px after the colon." }], xp: 55 }),
    ...
    s33({ id: "shop-rate-border", task: "Add a faint edge so the card reads on a white page.", inputMode: "guided", files: solvedShopRate(".info-card {\n  background-color: #ffffff;\n  border-radius: 10px;\n  box-shadow: 0 1px 3px rgba(15, 23, 42, 0.2);\n  padding: 20px;\n  border: ;\n}"), activeFile: "styles.css", highlightToken: "border: ;", tests: [{ id: "shop-rate-border-set", kind: "source-matches", file: "styles.css", pattern: "border\\s*:\\s*1px\\s+solid\\s+#e2e8f0", flags: "i", because: "A border needs a width, a line style, and a colour, in that order.", label: "The card has an edge of a thin grey edge" }], hints: [{ level: 1, text: "A border needs a width, a style, and a colour." }, { level: 2, text: "Write 1px solid #e2e8f0 after the colon." }], xp: 45 }),
    ...
    s39({ id: "store-credit-border-left-width", task: "Give the notice a thick stripe down its left side.", inputMode: "guided", files: solvedStoreCredit(".notice-banner {\n  border-left-width: ;\n}"), activeFile: "styles.css", highlightToken: "border-left-width: ;", tests: [{ id: "store-credit-border-left-width-set", kind: "source-matches", file: "styles.css", pattern: "border-left-width\\s*:\\s*4px", flags: "i", because: "Write the four-pixel stripe width.", label: "The declaration is written" }], hints: [{ level: 1, text: "Use a pixel value for the stripe width." }, { level: 2, text: "Write 4px after the colon." }], xp: 55 }),
    ...
    s44({ id: "board-responsive-font-size", task: "Set a comfortable reading size.", inputMode: "guided", files: solvedBoardResponsive(".info-card {\n  max-width: 480px;\n  width: 100%;\n  padding: 16px;\n  font-size: ;\n}"), activeFile: "styles.css", highlightToken: "font-size: ;", tests: [{ id: "board-responsive-font-size-set", kind: "source-matches", file: "styles.css", pattern: "font-size\\s*:\\s*16px", flags: "i", because: "Write the reading size explicitly.", label: "The declaration is written" }], hints: [{ level: 1, text: "Use a pixel value for the text size." }, { level: 2, text: "Write 16px after the colon." }], xp: 55 }),
    ...
    s45({ id: "stall-sign-border", task: "Add a faint edge so the card reads on a white page.", inputMode: "guided", files: solvedStallSign(".info-card {\n  background-color: #ffffff;\n  border-radius: 10px;\n  box-shadow: 0 1px 3px rgba(15, 23, 42, 0.2);\n  padding: 20px;\n  border: ;\n}"), activeFile: "styles.css", highlightToken: "border: ;", tests: [{ id: "stall-sign-border-set", kind: "source-matches", file: "styles.css", pattern: "border\\s*:\\s*1px\\s+solid\\s+#e2e8f0", flags: "i", because: "A border needs a width, a line style, and a colour, in that order.", label: "The card has an edge of a thin grey edge" }], hints: [{ level: 1, text: "A border needs a width, a style, and a colour." }, { level: 2, text: "Write 1px solid #e2e8f0 after the colon." }], xp: 45 }),
    ...
    s51({ id: "station-notice-border-left-width", task: "Give the notice a thick stripe down its left side.", inputMode: "guided", files: solvedStationNotice(".notice-banner {\n  border-left-width: ;\n}"), activeFile: "styles.css", highlightToken: "border-left-width: ;", tests: [{ id: "station-notice-border-left-width-set", kind: "source-matches", file: "styles.css", pattern: "border-left-width\\s*:\\s*4px", flags: "i", because: "Write the four-pixel stripe width.", label: "The declaration is written" }], hints: [{ level: 1, text: "Use a pixel value for the stripe width." }, { level: 2, text: "Write 4px after the colon." }], xp: 55 }),
    ...
    s56({ id: "receipt-units-font-size", task: "Size the card text from the page setting instead of a fixed number.", inputMode: "guided", files: solvedReceiptUnits(".info-card {\n  font-size: ;\n}"), activeFile: "styles.css", highlightToken: "font-size: ;", tests: [{ id: "receipt-units-font-size-set", kind: "source-matches", file: "styles.css", pattern: "font-size\\s*:\\s*1rem", flags: "i", because: "Use the root-relative unit named in the lesson.", label: "The declaration is written" }], hints: [{ level: 1, text: "Use the unit that means one root font size." }, { level: 2, text: "Write 1rem after the colon." }], xp: 55 }),
    ...
    s57({ id: "list-styling-list-style-type", task: "Take the bullets off the list.", inputMode: "guided", files: solvedListStyling(".item-list ul {\n  list-style-type: ;\n}"), activeFile: "styles.css", highlightToken: "list-style-type: ;", tests: [{ id: "list-styling-list-style-type-set", kind: "style", selector: ".item-list ul", prop: "list-style-type", equals: "none", readable: "no bullets", label: "The list is set to no bullets" }], hints: [{ level: 1, text: "Use the value that means no marker at all." }, { level: 2, text: "Write none after the colon." }], xp: 45 }),
    s57({ id: "list-styling-padding-left", task: "Remove the indent the bullets left behind.", inputMode: "guided", files: solvedListStyling(".item-list ul {\n  list-style-type: none;\n  padding-left: ;\n}"), activeFile: "styles.css", highlightToken: "padding-left: ;", tests: [{ id: "list-styling-padding-left-set", kind: "style", selector: ".item-list ul", prop: "padding-left", equals: "0px", readable: "no left indent", label: "The list keeps its words clear by no left indent" }], hints: [{ level: 1, text: "Use zero pixels." }, { level: 2, text: "Write 0px after the colon." }], xp: 45 }),
    s57({ id: "list-styling-background-color", task: "Tint the list so it reads as one block.", inputMode: "guided", files: solvedListStyling(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: ;\n}"), activeFile: "styles.css", highlightToken: "background-color: ;", tests: [{ id: "list-styling-background-color-set", kind: "style", selector: ".item-list ul", prop: "background-color", equals: "rgb(248, 250, 252)", readable: "pale grey", label: "The list has a background of pale grey" }], hints: [{ level: 1, text: "Use the pale grey code." }, { level: 2, text: "Write #f8fafc after the colon." }], xp: 45 }),
    s57({ id: "list-styling-border-radius", task: "Round the list corners.", inputMode: "guided", files: solvedListStyling(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n  border-radius: ;\n}"), activeFile: "styles.css", highlightToken: "border-radius: ;", tests: [{ id: "list-styling-border-radius-set", kind: "style", selector: ".item-list ul", prop: "border-top-left-radius", equals: "8px", readable: "8 pixels", label: "The list has corners curved by 8 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the corner curve." }, { level: 2, text: "Write 8px after the colon." }], xp: 45 }),
    s57({ id: "list-styling-padding-top", task: "Keep the first item clear of the top edge.", inputMode: "guided", files: solvedListStyling(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n  border-radius: 8px;\n  padding-top: ;\n}"), activeFile: "styles.css", highlightToken: "padding-top: ;", tests: [{ id: "list-styling-padding-top-set", kind: "style", selector: ".item-list ul", prop: "padding-top", equals: "12px", readable: "12 pixels", label: "The list has room above of 12 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the space above." }, { level: 2, text: "Write 12px after the colon." }], xp: 45 }),
    ...
    s61({ id: "text-detail-font-style", task: "Keep the text upright rather than slanted.", inputMode: "guided", files: solvedTextDetail(".info-card {\n  text-transform: uppercase;\n  font-style: ;\n}"), activeFile: "styles.css", highlightToken: "font-style: ;", tests: [{ id: "text-detail-font-style-set", kind: "source-matches", file: "styles.css", pattern: "font-style\\s*:\\s*normal", flags: "i", because: "Write the upright font style explicitly.", label: "The declaration is written" }], hints: [{ level: 1, text: "Use the value that means not italic." }, { level: 2, text: "Write normal after the colon." }], xp: 55 }),
    ...
    s64({ id: "board-units-font-size", task: "Size the card text from the page setting instead of a fixed number.", inputMode: "guided", files: solvedBoardUnits(".info-card {\n  font-size: ;\n}"), activeFile: "styles.css", highlightToken: "font-size: ;", tests: [{ id: "board-units-font-size-set", kind: "source-matches", file: "styles.css", pattern: "font-size\\s*:\\s*1rem", flags: "i", because: "Use the root-relative unit named in the lesson.", label: "The declaration is written" }], hints: [{ level: 1, text: "Use the unit that means one root font size." }, { level: 2, text: "Write 1rem after the colon." }], xp: 55 }),
    ...
    s65({ id: "stall-2-list-style-type", task: "Take the bullets off the list.", inputMode: "guided", files: solvedStall2(".item-list ul {\n  list-style-type: ;\n}"), activeFile: "styles.css", highlightToken: "list-style-type: ;", tests: [{ id: "stall-2-list-style-type-set", kind: "style", selector: ".item-list ul", prop: "list-style-type", equals: "none", readable: "no bullets", label: "The list is set to no bullets" }], hints: [{ level: 1, text: "Use the value that means no marker at all." }, { level: 2, text: "Write none after the colon." }], xp: 45 }),
    s65({ id: "stall-2-padding-left", task: "Remove the indent the bullets left behind.", inputMode: "guided", files: solvedStall2(".item-list ul {\n  list-style-type: none;\n  padding-left: ;\n}"), activeFile: "styles.css", highlightToken: "padding-left: ;", tests: [{ id: "stall-2-padding-left-set", kind: "style", selector: ".item-list ul", prop: "padding-left", equals: "0px", readable: "no left indent", label: "The list keeps its words clear by no left indent" }], hints: [{ level: 1, text: "Use zero pixels." }, { level: 2, text: "Write 0px after the colon." }], xp: 45 }),
    s65({ id: "stall-2-background-color", task: "Tint the list so it reads as one block.", inputMode: "guided", files: solvedStall2(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: ;\n}"), activeFile: "styles.css", highlightToken: "background-color: ;", tests: [{ id: "stall-2-background-color-set", kind: "style", selector: ".item-list ul", prop: "background-color", equals: "rgb(248, 250, 252)", readable: "pale grey", label: "The list has a background of pale grey" }], hints: [{ level: 1, text: "Use the pale grey code." }, { level: 2, text: "Write #f8fafc after the colon." }], xp: 45 }),
    s65({ id: "stall-2-border-radius", task: "Round the list corners.", inputMode: "guided", files: solvedStall2(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n  border-radius: ;\n}"), activeFile: "styles.css", highlightToken: "border-radius: ;", tests: [{ id: "stall-2-border-radius-set", kind: "style", selector: ".item-list ul", prop: "border-top-left-radius", equals: "8px", readable: "8 pixels", label: "The list has corners curved by 8 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the corner curve." }, { level: 2, text: "Write 8px after the colon." }], xp: 45 }),
    s65({ id: "stall-2-padding-top", task: "Keep the first item clear of the top edge.", inputMode: "guided", files: solvedStall2(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n  border-radius: 8px;\n  padding-top: ;\n}"), activeFile: "styles.css", highlightToken: "padding-top: ;", tests: [{ id: "stall-2-padding-top-set", kind: "style", selector: ".item-list ul", prop: "padding-top", equals: "12px", readable: "12 pixels", label: "The list has room above of 12 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the space above." }, { level: 2, text: "Write 12px after the colon." }], xp: 45 }),
    ...
    s69({ id: "table-2-font-style", task: "Keep the text upright rather than slanted.", inputMode: "guided", files: solvedTable2(".info-card {\n  text-transform: uppercase;\n  font-style: ;\n}"), activeFile: "styles.css", highlightToken: "font-style: ;", tests: [{ id: "table-2-font-style-set", kind: "source-matches", file: "styles.css", pattern: "font-style\\s*:\\s*normal", flags: "i", because: "Write the upright font style explicitly.", label: "The declaration is written" }], hints: [{ level: 1, text: "Use the value that means not italic." }, { level: 2, text: "Write normal after the colon." }], xp: 55 }),
    ...
    s70({ id: "slip-2-min-width", task: "Stop the card shrinking below a readable width.", inputMode: "guided", files: solvedSlip2(".info-card {\n  min-width: ;\n}"), activeFile: "styles.css", highlightToken: "min-width: ;", tests: [{ id: "slip-2-min-width-set", kind: "style", selector: ".info-card", prop: "min-width", equals: "240px", readable: "240 pixels", label: "The card is set to 240 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the narrowest it may get." }, { level: 2, text: "Write 240px after the colon." }], xp: 45 }),
    s70({ id: "slip-2-max-width", task: "Stop the card growing past a comfortable line length.", inputMode: "guided", files: solvedSlip2(".info-card {\n  min-width: 240px;\n  max-width: ;\n}"), activeFile: "styles.css", highlightToken: "max-width: ;", tests: [{ id: "slip-2-max-width-set", kind: "style", selector: ".info-card", prop: "max-width", equals: "520px", readable: "520 pixels", label: "The card stops growing past 520 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the widest it may get." }, { level: 2, text: "Write 520px after the colon." }], xp: 45 }),
    s70({ id: "slip-2-min-height", task: "Keep the card from collapsing when it holds little text.", inputMode: "guided", files: solvedSlip2(".info-card {\n  min-width: 240px;\n  max-width: 520px;\n  min-height: ;\n}"), activeFile: "styles.css", highlightToken: "min-height: ;", tests: [{ id: "slip-2-min-height-set", kind: "style", selector: ".info-card", prop: "min-height", equals: "120px", readable: "120 pixels", label: "The card stays at least 120 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the shortest it may be." }, { level: 2, text: "Write 120px after the colon." }], xp: 45 }),
    s70({ id: "slip-2-box-sizing", task: "Count the padding inside those limits rather than on top of them.", inputMode: "guided", files: solvedSlip2(".info-card {\n  min-width: 240px;\n  max-width: 520px;\n  min-height: 120px;\n  box-sizing: ;\n}"), activeFile: "styles.css", highlightToken: "box-sizing: ;", tests: [{ id: "slip-2-box-sizing-set", kind: "style", selector: ".info-card", prop: "box-sizing", equals: "border-box", readable: "border box", label: "The card measures itself as border box" }], hints: [{ level: 1, text: "Use the sizing value that includes padding and border." }, { level: 2, text: "Write border-box after the colon." }], xp: 45 }),
    s70({ id: "slip-2-padding", task: "Give the card room inside its limits.", inputMode: "guided", files: solvedSlip2(".info-card {\n  min-width: 240px;\n  max-width: 520px;\n  min-height: 120px;\n  box-sizing: border-box;\n  padding: ;\n}"), activeFile: "styles.css", highlightToken: "padding: ;", tests: [{ id: "slip-2-padding-set", kind: "style", selector: ".info-card", prop: "padding-top", equals: "20px", readable: "20 pixels", label: "The card has room inside of 20 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the inside room." }, { level: 2, text: "Write 20px after the colon." }], xp: 45 }),
    s71({ id: "station-backgrounds-background-color", task: "Tint the banner pale green.", inputMode: "guided", files: solvedStationBackgrounds(".notice-banner {\n  background-color: ;\n}"), activeFile: "styles.css", highlightToken: "background-color: ;", tests: [{ id: "station-backgrounds-background-color-set", kind: "style", selector: ".notice-banner", prop: "background-color", equals: "rgb(236, 253, 245)", readable: "pale green", label: "The banner has a background of pale green" }], hints: [{ level: 1, text: "Use the pale green code named in the task." }, { level: 2, text: "Write #ecfdf5 after the colon." }], xp: 45 }),
    s71({ id: "station-backgrounds-background-image", task: "Fade the banner from its top colour into a deeper one.", inputMode: "guided", files: solvedStationBackgrounds(".notice-banner {\n  background-color: #ecfdf5;\n  background-image: ;\n}"), activeFile: "styles.css", highlightToken: "background-image: ;", tests: [{ id: "station-backgrounds-background-image-set", kind: "source-matches", file: "styles.css", pattern: "background-image\\s*:\\s*linear-gradient", flags: "i", because: "A gradient names the colours it fades between.", label: "The banner is set to a colour that fades down" }], hints: [{ level: 1, text: "Name the two colours the fade runs between." }, { level: 2, text: "Write linear-gradient(#ecfdf5, #d1fae5) after the colon." }], xp: 55 }),
    s71({ id: "station-backgrounds-background-clip", task: "Stop the background running under the border.", inputMode: "guided", files: solvedStationBackgrounds(".notice-banner {\n  background-color: #ecfdf5;\n  background-image: linear-gradient(#ecfdf5, #d1fae5);\n  background-clip: ;\n}"), activeFile: "styles.css", highlightToken: "background-clip: ;", tests: [{ id: "station-backgrounds-background-clip-set", kind: "style", selector: ".notice-banner", prop: "background-clip", equals: "padding-box", readable: "kept inside the padding", label: "The banner is set to kept inside the padding" }], hints: [{ level: 1, text: "Name the box the background should stop at." }, { level: 2, text: "Write padding-box after the colon." }], xp: 45 }),
    s71({ id: "station-backgrounds-padding", task: "Give the banner room inside.", inputMode: "guided", files: solvedStationBackgrounds(".notice-banner {\n  background-color: #ecfdf5;\n  background-image: linear-gradient(#ecfdf5, #d1fae5);\n  background-clip: padding-box;\n  padding: ;\n}"), activeFile: "styles.css", highlightToken: "padding: ;", tests: [{ id: "station-backgrounds-padding-set", kind: "style", selector: ".notice-banner", prop: "padding-top", equals: "18px", readable: "18 pixels", label: "The banner has room inside of 18 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the inside room." }, { level: 2, text: "Write 18px after the colon." }], xp: 45 }),
    s71({ id: "station-backgrounds-border-radius", task: "Round the banner corners.", inputMode: "guided", files: solvedStationBackgrounds(".notice-banner {\n  background-color: #ecfdf5;\n  background-image: linear-gradient(#ecfdf5, #d1fae5);\n  background-clip: padding-box;\n  padding: 18px;\n  border-radius: ;\n}"), activeFile: "styles.css", highlightToken: "border-radius: ;", tests: [{ id: "station-backgrounds-border-radius-set", kind: "style", selector: ".notice-banner", prop: "border-top-left-radius", equals: "8px", readable: "8 pixels", label: "The banner has corners curved by 8 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the corner curve." }, { level: 2, text: "Write 8px after the colon." }], xp: 45 }),
    s72({ id: "up-units-font-size", task: "Size the card text from the page setting instead of a fixed number.", inputMode: "guided", files: solvedUpUnits(".info-card {\n  font-size: ;\n}"), activeFile: "styles.css", highlightToken: "font-size: ;", tests: [{ id: "up-units-font-size-set", kind: "source-matches", file: "styles.css", pattern: "font-size\\s*:\\s*1rem", flags: "i", because: "Use the root-relative unit named in the lesson.", label: "The declaration is written" }], hints: [{ level: 1, text: "Use the unit that means one root font size." }, { level: 2, text: "Write 1rem after the colon." }], xp: 55 }),
    s72({ id: "up-units-padding", task: "Set the inside room in the same scaling unit.", inputMode: "guided", files: solvedUpUnits(".info-card {\n  font-size: 1rem;\n  padding: ;\n}"), activeFile: "styles.css", highlightToken: "padding: ;", tests: [{ id: "up-units-padding-set", kind: "style", selector: ".info-card", prop: "padding-top", equals: "20px", readable: "1.25 root sizes", label: "The card has room inside of 1.25 root sizes" }], hints: [{ level: 1, text: "Use a rem value a little over one." }, { level: 2, text: "Write 1.25rem after the colon." }], xp: 45 }),
    s72({ id: "up-units-max-width", task: "Cap the card width in the same unit.", inputMode: "guided", files: solvedUpUnits(".info-card {\n  font-size: 1rem;\n  padding: 1.25rem;\n  max-width: ;\n}"), activeFile: "styles.css", highlightToken: "max-width: ;", tests: [{ id: "up-units-max-width-set", kind: "style", selector: ".info-card", prop: "max-width", equals: "480px", readable: "30 root sizes", label: "The card stops growing past 30 root sizes" }], hints: [{ level: 1, text: "Use a rem value for the widest it may get." }, { level: 2, text: "Write 30rem after the colon." }], xp: 45 }),
    s72({ id: "up-units-line-height", task: "Space the lines relative to the text size.", inputMode: "guided", files: solvedUpUnits(".info-card {\n  font-size: 1rem;\n  padding: 1.25rem;\n  max-width: 30rem;\n  line-height: ;\n}"), activeFile: "styles.css", highlightToken: "line-height: ;", tests: [{ id: "up-units-line-height-set", kind: "style", selector: ".info-card", prop: "line-height", equals: "24px", readable: "1.5 times the text size", label: "The card spaces its lines by 1.5 times the text size" }], hints: [{ level: 1, text: "Use a number with no unit." }, { level: 2, text: "Write 1.5 after the colon." }], xp: 45 }),
    s72({ id: "up-units-border-radius", task: "Round the corners in the same scaling unit.", inputMode: "guided", files: solvedUpUnits(".info-card {\n  font-size: 1rem;\n  padding: 1.25rem;\n  max-width: 30rem;\n  line-height: 1.5;\n  border-radius: ;\n}"), activeFile: "styles.css", highlightToken: "border-radius: ;", tests: [{ id: "up-units-border-radius-set", kind: "style", selector: ".info-card", prop: "border-top-left-radius", equals: "8px", readable: "half a root size", label: "The card has corners curved by half a root size" }], hints: [{ level: 1, text: "Use a rem value below one." }, { level: 2, text: "Write 0.5rem after the colon." }], xp: 45 }),
    s73({ id: "rate-2-list-style-type", task: "Take the bullets off the list.", inputMode: "guided", files: solvedRate2(".item-list ul {\n  list-style-type: ;\n}"), activeFile: "styles.css", highlightToken: "list-style-type: ;", tests: [{ id: "rate-2-list-style-type-set", kind: "style", selector: ".item-list ul", prop: "list-style-type", equals: "none", readable: "no bullets", label: "The list is set to no bullets" }], hints: [{ level: 1, text: "Use the value that means no marker at all." }, { level: 2, text: "Write none after the colon." }], xp: 45 }),
    s73({ id: "rate-2-padding-left", task: "Remove the indent the bullets left behind.", inputMode: "guided", files: solvedRate2(".item-list ul {\n  list-style-type: none;\n  padding-left: ;\n}"), activeFile: "styles.css", highlightToken: "padding-left: ;", tests: [{ id: "rate-2-padding-left-set", kind: "style", selector: ".item-list ul", prop: "padding-left", equals: "0px", readable: "no left indent", label: "The list keeps its words clear by no left indent" }], hints: [{ level: 1, text: "Use zero pixels." }, { level: 2, text: "Write 0px after the colon." }], xp: 45 }),
    s73({ id: "rate-2-background-color", task: "Tint the list so it reads as one block.", inputMode: "guided", files: solvedRate2(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: ;\n}"), activeFile: "styles.css", highlightToken: "background-color: ;", tests: [{ id: "rate-2-background-color-set", kind: "style", selector: ".item-list ul", prop: "background-color", equals: "rgb(248, 250, 252)", readable: "pale grey", label: "The list has a background of pale grey" }], hints: [{ level: 1, text: "Use the pale grey code." }, { level: 2, text: "Write #f8fafc after the colon." }], xp: 45 }),
    s73({ id: "rate-2-border-radius", task: "Round the list corners.", inputMode: "guided", files: solvedRate2(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n  border-radius: ;\n}"), activeFile: "styles.css", highlightToken: "border-radius: ;", tests: [{ id: "rate-2-border-radius-set", kind: "style", selector: ".item-list ul", prop: "border-top-left-radius", equals: "8px", readable: "8 pixels", label: "The list has corners curved by 8 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the corner curve." }, { level: 2, text: "Write 8px after the colon." }], xp: 45 }),
    s73({ id: "rate-2-padding-top", task: "Keep the first item clear of the top edge.", inputMode: "guided", files: solvedRate2(".item-list ul {\n  list-style-type: none;\n  padding-left: 0px;\n  background-color: #f8fafc;\n  border-radius: 8px;\n  padding-top: ;\n}"), activeFile: "styles.css", highlightToken: "padding-top: ;", tests: [{ id: "rate-2-padding-top-set", kind: "style", selector: ".item-list ul", prop: "padding-top", equals: "12px", readable: "12 pixels", label: "The list has room above of 12 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the space above." }, { level: 2, text: "Write 12px after the colon." }], xp: 45 }),
    s74({ id: "programme-2-padding", task: "Give the row room inside.", inputMode: "guided", files: solvedProgramme2(".price-row {\n  padding: ;\n}"), activeFile: "styles.css", highlightToken: "padding: ;", tests: [{ id: "programme-2-padding-set", kind: "style", selector: ".price-row", prop: "padding-top", equals: "12px", readable: "12 pixels", label: "The row has room inside of 12 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the inside room." }, { level: 2, text: "Write 12px after the colon." }], xp: 45 }),
    s74({ id: "programme-2-cursor", task: "Show that the row can be clicked.", inputMode: "guided", files: solvedProgramme2(".price-row {\n  padding: 12px;\n  cursor: ;\n}"), activeFile: "styles.css", highlightToken: "cursor: ;", tests: [{ id: "programme-2-cursor-set", kind: "style", selector: ".price-row", prop: "cursor", equals: "pointer", readable: "a pointing hand", label: "The row is set to a pointing hand" }], hints: [{ level: 1, text: "Use the cursor value that shows a pointing hand." }, { level: 2, text: "Write pointer after the colon." }], xp: 45 }),
    s74({ id: "programme-2-transition-property", task: "Name what should change smoothly rather than snapping.", inputMode: "guided", files: solvedProgramme2(".price-row {\n  padding: 12px;\n  cursor: pointer;\n  transition-property: ;\n}"), activeFile: "styles.css", highlightToken: "transition-property: ;", tests: [{ id: "programme-2-transition-property-set", kind: "style", selector: ".price-row", prop: "transition-property", equals: "background-color", readable: "a smooth colour change", label: "The row is set to a smooth colour change" }], hints: [{ level: 1, text: "Name the property that will change." }, { level: 2, text: "Write background-color after the colon." }], xp: 45 }),
    s74({ id: "programme-2-transition-duration", task: "Set how long that change takes.", inputMode: "guided", files: solvedProgramme2(".price-row {\n  padding: 12px;\n  cursor: pointer;\n  transition-property: background-color;\n  transition-duration: ;\n}"), activeFile: "styles.css", highlightToken: "transition-duration: ;", tests: [{ id: "programme-2-transition-duration-set", kind: "style", selector: ".price-row", prop: "transition-duration", equals: "0.15s", readable: "150 milliseconds", label: "The row is set to 150 milliseconds" }], hints: [{ level: 1, text: "Use a value in milliseconds." }, { level: 2, text: "Write 150ms after the colon." }], xp: 45 }),
    s74({ id: "programme-2-transition-timing-function", task: "Make the change start quickly and settle gently.", inputMode: "guided", files: solvedProgramme2(".price-row {\n  padding: 12px;\n  cursor: pointer;\n  transition-property: background-color;\n  transition-duration: 150ms;\n  transition-timing-function: ;\n}"), activeFile: "styles.css", highlightToken: "transition-timing-function: ;", tests: [{ id: "programme-2-transition-timing-function-set", kind: "style", selector: ".price-row", prop: "transition-timing-function", equals: "ease-out", readable: "quick then gentle", label: "The row is set to quick then gentle" }], hints: [{ level: 1, text: "Use the timing value that eases at the end." }, { level: 2, text: "Write ease-out after the colon." }], xp: 45 }),
    s75({ id: "price-2-display", task: "Lay the cells out as a grid.", inputMode: "guided", files: solvedPrice2(".stall-grid {\n  display: ;\n}"), activeFile: "styles.css", highlightToken: "display: ;", tests: [{ id: "price-2-display-set", kind: "style", selector: ".stall-grid", prop: "display", equals: "grid", readable: "a grid", label: "The grid is laid out as a grid" }], hints: [{ level: 1, text: "Use the display value made for rows and columns together." }, { level: 2, text: "Write grid after the colon." }], xp: 45 }),
    s75({ id: "price-2-grid-template-columns", task: "Ask for two equal columns without writing the track twice.", inputMode: "guided", files: solvedPrice2(".stall-grid {\n  display: grid;\n  grid-template-columns: ;\n}"), activeFile: "styles.css", highlightToken: "grid-template-columns: ;", tests: [{ id: "price-2-grid-template-columns-set", kind: "source-matches", file: "styles.css", pattern: "grid-template-columns\\s*:\\s*repeat\\(2,\\s*1fr\\)", flags: "i", because: "Repeat asks for the same track twice without writing it twice.", label: "The grid is divided into two repeated columns" }], hints: [{ level: 1, text: "Use the function that repeats a track a number of times." }, { level: 2, text: "Write repeat(2, 1fr) after the colon." }], xp: 55 }),
    s75({ id: "price-2-row-gap", task: "Space the rows apart.", inputMode: "guided", files: solvedPrice2(".stall-grid {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  row-gap: ;\n}"), activeFile: "styles.css", highlightToken: "row-gap: ;", tests: [{ id: "price-2-row-gap-set", kind: "style", selector: ".stall-grid", prop: "row-gap", equals: "10px", readable: "10 pixels between rows", label: "The grid is set to 10 pixels between rows" }], hints: [{ level: 1, text: "Use a pixel value for the gap between rows." }, { level: 2, text: "Write 10px after the colon." }], xp: 45 }),
    s75({ id: "price-2-column-gap", task: "Use a wider gap between the columns.", inputMode: "guided", files: solvedPrice2(".stall-grid {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  row-gap: 10px;\n  column-gap: ;\n}"), activeFile: "styles.css", highlightToken: "column-gap: ;", tests: [{ id: "price-2-column-gap-set", kind: "style", selector: ".stall-grid", prop: "column-gap", equals: "16px", readable: "16 pixels between columns", label: "The grid is set to 16 pixels between columns" }], hints: [{ level: 1, text: "Use a pixel value for the gap between columns." }, { level: 2, text: "Write 16px after the colon." }], xp: 45 }),
    s75({ id: "price-2-align-items", task: "Make every cell in a row the same height.", inputMode: "guided", files: solvedPrice2(".stall-grid {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  row-gap: 10px;\n  column-gap: 16px;\n  align-items: ;\n}"), activeFile: "styles.css", highlightToken: "align-items: ;", tests: [{ id: "price-2-align-items-set", kind: "style", selector: ".stall-grid", prop: "align-items", equals: "stretch", readable: "cells of equal height", label: "The grid lines its children up cells of equal height" }], hints: [{ level: 1, text: "Use the value that stretches children to fill the row." }, { level: 2, text: "Write stretch after the colon." }], xp: 45 }),
    s76({ id: "receipt-2-padding", task: "Give the notice room inside.", inputMode: "guided", files: solvedReceipt2(".notice-banner {\n  padding: ;\n}"), activeFile: "styles.css", highlightToken: "padding: ;", tests: [{ id: "receipt-2-padding-set", kind: "style", selector: ".notice-banner", prop: "padding-top", equals: "16px", readable: "16 pixels", label: "The notice has room inside of 16 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the inside room." }, { level: 2, text: "Write 16px after the colon." }], xp: 45 }),
    s76({ id: "receipt-2-opacity", task: "Soften the notice very slightly.", inputMode: "guided", files: solvedReceipt2(".notice-banner {\n  padding: 16px;\n  opacity: ;\n}"), activeFile: "styles.css", highlightToken: "opacity: ;", tests: [{ id: "receipt-2-opacity-set", kind: "style", selector: ".notice-banner", prop: "opacity", equals: "0.95", readable: "very slightly see-through", label: "The notice is set to very slightly see-through" }], hints: [{ level: 1, text: "Use a number just below one." }, { level: 2, text: "Write 0.95 after the colon." }], xp: 45 }),
    s76({ id: "receipt-2-z-index", task: "Keep the notice above anything it overlaps.", inputMode: "guided", files: solvedReceipt2(".notice-banner {\n  padding: 16px;\n  opacity: 0.95;\n  z-index: ;\n}"), activeFile: "styles.css", highlightToken: "z-index: ;", tests: [{ id: "receipt-2-z-index-set", kind: "style", selector: ".notice-banner", prop: "z-index", equals: "10", readable: "stacked above", label: "The notice is set to stacked above" }], hints: [{ level: 1, text: "Use a whole number; higher sits on top." }, { level: 2, text: "Write 10 after the colon." }], xp: 45 }),
    s76({ id: "receipt-2-position", task: "Give the stacking order something to apply to.", inputMode: "guided", files: solvedReceipt2(".notice-banner {\n  padding: 16px;\n  opacity: 0.95;\n  z-index: 10;\n  position: ;\n}"), activeFile: "styles.css", highlightToken: "position: ;", tests: [{ id: "receipt-2-position-set", kind: "style", selector: ".notice-banner", prop: "position", equals: "relative", readable: "positioned", label: "The notice is positioned" }], hints: [{ level: 1, text: "Stacking only applies to a positioned element." }, { level: 2, text: "Write relative after the colon." }], xp: 45 }),
    s76({ id: "receipt-2-background-color", task: "Tint the notice so it reads as urgent.", inputMode: "guided", files: solvedReceipt2(".notice-banner {\n  padding: 16px;\n  opacity: 0.95;\n  z-index: 10;\n  position: relative;\n  background-color: ;\n}"), activeFile: "styles.css", highlightToken: "background-color: ;", tests: [{ id: "receipt-2-background-color-set", kind: "style", selector: ".notice-banner", prop: "background-color", equals: "rgb(254, 242, 242)", readable: "pale red", label: "The notice has a background of pale red" }], hints: [{ level: 1, text: "Use the pale red code." }, { level: 2, text: "Write #fef2f2 after the colon." }], xp: 45 }),
    s77({ id: "list-3-text-transform", task: "Put the card text in capitals.", inputMode: "guided", files: solvedList3(".info-card {\n  text-transform: ;\n}"), activeFile: "styles.css", highlightToken: "text-transform: ;", tests: [{ id: "list-3-text-transform-set", kind: "style", selector: ".info-card", prop: "text-transform", equals: "uppercase", readable: "capital letters", label: "The card text is set to capital letters" }], hints: [{ level: 1, text: "Use the value that makes every letter a capital." }, { level: 2, text: "Write uppercase after the colon." }], xp: 45 }),
    s77({ id: "list-3-font-style", task: "Keep the text upright rather than slanted.", inputMode: "guided", files: solvedList3(".info-card {\n  text-transform: uppercase;\n  font-style: ;\n}"), activeFile: "styles.css", highlightToken: "font-style: ;", tests: [{ id: "list-3-font-style-set", kind: "source-matches", file: "styles.css", pattern: "font-style\\s*:\\s*normal", flags: "i", because: "Write the upright font style explicitly.", label: "The declaration is written" }], hints: [{ level: 1, text: "Use the value that means not italic." }, { level: 2, text: "Write normal after the colon." }], xp: 55 }),
    s77({ id: "list-3-text-decoration-line", task: "Underline the card text.", inputMode: "guided", files: solvedList3(".info-card {\n  text-transform: uppercase;\n  font-style: normal;\n  text-decoration-line: ;\n}"), activeFile: "styles.css", highlightToken: "text-decoration-line: ;", tests: [{ id: "list-3-text-decoration-line-set", kind: "style", selector: ".info-card", prop: "text-decoration-line", equals: "underline", readable: "underlined", label: "The card text is set to underlined" }], hints: [{ level: 1, text: "Use the value that draws a line under the words." }, { level: 2, text: "Write underline after the colon." }], xp: 45 }),
    s77({ id: "list-3-text-indent", task: "Indent the first line.", inputMode: "guided", files: solvedList3(".info-card {\n  text-transform: uppercase;\n  font-style: normal;\n  text-decoration-line: underline;\n  text-indent: ;\n}"), activeFile: "styles.css", highlightToken: "text-indent: ;", tests: [{ id: "list-3-text-indent-set", kind: "style", selector: ".info-card", prop: "text-indent", equals: "8px", readable: "8 pixels of indent", label: "The card text is set to 8 pixels of indent" }], hints: [{ level: 1, text: "Use a pixel value for the first-line indent." }, { level: 2, text: "Write 8px after the colon." }], xp: 45 }),
    s77({ id: "list-3-word-spacing", task: "Loosen the gaps between words slightly.", inputMode: "guided", files: solvedList3(".info-card {\n  text-transform: uppercase;\n  font-style: normal;\n  text-decoration-line: underline;\n  text-indent: 8px;\n  word-spacing: ;\n}"), activeFile: "styles.css", highlightToken: "word-spacing: ;", tests: [{ id: "list-3-word-spacing-set", kind: "style", selector: ".info-card", prop: "word-spacing", equals: "1px", readable: "1 pixel between words", label: "The card text is set to 1 pixel between words" }], hints: [{ level: 1, text: "Use a small pixel value." }, { level: 2, text: "Write 1px after the colon." }], xp: 45 }),
    s78({ id: "application-2-min-width", task: "Stop the card shrinking below a readable width.", inputMode: "guided", files: solvedApplication2(".info-card {\n  min-width: ;\n}"), activeFile: "styles.css", highlightToken: "min-width: ;", tests: [{ id: "application-2-min-width-set", kind: "style", selector: ".info-card", prop: "min-width", equals: "240px", readable: "240 pixels", label: "The card is set to 240 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the narrowest it may get." }, { level: 2, text: "Write 240px after the colon." }], xp: 45 }),
    s78({ id: "application-2-max-width", task: "Stop the card growing past a comfortable line length.", inputMode: "guided", files: solvedApplication2(".info-card {\n  min-width: 240px;\n  max-width: ;\n}"), activeFile: "styles.css", highlightToken: "max-width: ;", tests: [{ id: "application-2-max-width-set", kind: "style", selector: ".info-card", prop: "max-width", equals: "520px", readable: "520 pixels", label: "The card stops growing past 520 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the widest it may get." }, { level: 2, text: "Write 520px after the colon." }], xp: 45 }),
    s78({ id: "application-2-min-height", task: "Keep the card from collapsing when it holds little text.", inputMode: "guided", files: solvedApplication2(".info-card {\n  min-width: 240px;\n  max-width: 520px;\n  min-height: ;\n}"), activeFile: "styles.css", highlightToken: "min-height: ;", tests: [{ id: "application-2-min-height-set", kind: "style", selector: ".info-card", prop: "min-height", equals: "120px", readable: "120 pixels", label: "The card stays at least 120 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the shortest it may be." }, { level: 2, text: "Write 120px after the colon." }], xp: 45 }),
    s78({ id: "application-2-box-sizing", task: "Count the padding inside those limits rather than on top of them.", inputMode: "guided", files: solvedApplication2(".info-card {\n  min-width: 240px;\n  max-width: 520px;\n  min-height: 120px;\n  box-sizing: ;\n}"), activeFile: "styles.css", highlightToken: "box-sizing: ;", tests: [{ id: "application-2-box-sizing-set", kind: "style", selector: ".info-card", prop: "box-sizing", equals: "border-box", readable: "border box", label: "The card measures itself as border box" }], hints: [{ level: 1, text: "Use the sizing value that includes padding and border." }, { level: 2, text: "Write border-box after the colon." }], xp: 45 }),
    s78({ id: "application-2-padding", task: "Give the card room inside its limits.", inputMode: "guided", files: solvedApplication2(".info-card {\n  min-width: 240px;\n  max-width: 520px;\n  min-height: 120px;\n  box-sizing: border-box;\n  padding: ;\n}"), activeFile: "styles.css", highlightToken: "padding: ;", tests: [{ id: "application-2-padding-set", kind: "style", selector: ".info-card", prop: "padding-top", equals: "20px", readable: "20 pixels", label: "The card has room inside of 20 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the inside room." }, { level: 2, text: "Write 20px after the colon." }], xp: 45 }),
    s79({ id: "pseudo-elements-position", task: "Make the notice the anchor for a label added by CSS.", inputMode: "guided", files: solvedPseudoElements(".notice-banner {\n  position: ;\n}"), activeFile: "styles.css", highlightToken: "position: ;", tests: [{ id: "pseudo-elements-position-set", kind: "style", selector: ".notice-banner", prop: "position", equals: "relative", readable: "positioned", label: "The notice is positioned" }], hints: [{ level: 1, text: "An added label is placed against a positioned element." }, { level: 2, text: "Write relative after the colon." }], xp: 45 }),
    s79({ id: "pseudo-elements-padding-top", task: "Leave room at the top for a label that is not in the HTML.", inputMode: "guided", files: solvedPseudoElements(".notice-banner {\n  position: relative;\n  padding-top: ;\n}"), activeFile: "styles.css", highlightToken: "padding-top: ;", tests: [{ id: "pseudo-elements-padding-top-set", kind: "style", selector: ".notice-banner", prop: "padding-top", equals: "32px", readable: "32 pixels", label: "The notice has room above of 32 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the space above." }, { level: 2, text: "Write 32px after the colon." }], xp: 45 }),
    s79({ id: "pseudo-elements-content-before", task: "Add the word Notice above the heading without touching the HTML.", inputMode: "guided", files: solvedPseudoElements(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n}\n\n.notice-banner::before {\n  content: ;\n}"), activeFile: "styles.css", highlightToken: "content: ;", tests: [{ id: "pseudo-elements-content-before-set", kind: "source-matches", file: "styles.css", pattern: "::before\\s*\\{[^}]*content\\s*:\\s*'Notice'", flags: "i", because: "An added element needs content before the browser will draw it.", label: "The notice is set to a label added by CSS" }], hints: [{ level: 1, text: "The added-element rule is open; give it something to say." }, { level: 2, text: "Write 'Notice' after the colon, quotes included." }], xp: 55 }),
    s79({ id: "pseudo-elements-color-before", task: "Colour the added label amber.", inputMode: "guided", files: solvedPseudoElements(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n}\n\n.notice-banner::before {\n  content: 'Notice';\n  color: ;\n}"), activeFile: "styles.css", highlightToken: "color: ;", tests: [{ id: "pseudo-elements-color-before-set", kind: "source-matches", file: "styles.css", pattern: "::before\\s*\\{[^}]*color\\s*:\\s*#b45309", flags: "i", because: "The added label takes a colour of its own.", label: "The notice shows its words in an amber label" }], hints: [{ level: 1, text: "Set the colour inside the added-element rule." }, { level: 2, text: "Write #b45309 after the colon." }], xp: 55 }),
    s79({ id: "pseudo-elements-background-color", task: "Tint the notice to match its label.", inputMode: "guided", files: solvedPseudoElements(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n  background-color: ;\n}\n\n.notice-banner::before {\n  content: 'Notice';\n  color: #b45309;\n}"), activeFile: "styles.css", highlightToken: "background-color: ;", tests: [{ id: "pseudo-elements-background-color-set", kind: "style", selector: ".notice-banner", prop: "background-color", equals: "rgb(255, 251, 235)", readable: "pale amber", label: "The notice has a background of pale amber" }], hints: [{ level: 1, text: "Use the pale amber code." }, { level: 2, text: "Write #fffbeb after the colon." }], xp: 45 }),
    s80({ id: "flex-wrap-display", task: "Lay the stalls out in a flexible row.", inputMode: "guided", files: solvedFlexWrap(".stall-grid {\n  display: ;\n}"), activeFile: "styles.css", highlightToken: "display: ;", tests: [{ id: "flex-wrap-display-set", kind: "style", selector: ".stall-grid", prop: "display", equals: "flex", readable: "a flex box", label: "The grid is laid out as a flex box" }], hints: [{ level: 1, text: "Use the display value that lays children out in a row." }, { level: 2, text: "Write flex after the colon." }], xp: 45 }),
    s80({ id: "flex-wrap-flex-wrap", task: "Let the stalls drop to the next line instead of squeezing.", inputMode: "guided", files: solvedFlexWrap(".stall-grid {\n  display: flex;\n  flex-wrap: ;\n}"), activeFile: "styles.css", highlightToken: "flex-wrap: ;", tests: [{ id: "flex-wrap-flex-wrap-set", kind: "style", selector: ".stall-grid", prop: "flex-wrap", equals: "wrap", readable: "wrapping onto new lines", label: "The grid is set to wrapping onto new lines" }], hints: [{ level: 1, text: "Use the value that allows a new line." }, { level: 2, text: "Write wrap after the colon." }], xp: 45 }),
    s80({ id: "flex-wrap-gap", task: "Space the stalls apart in both directions.", inputMode: "guided", files: solvedFlexWrap(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: ;\n}"), activeFile: "styles.css", highlightToken: "gap: ;", tests: [{ id: "flex-wrap-gap-set", kind: "style", selector: ".stall-grid", prop: "row-gap", equals: "12px", readable: "12 pixels", label: "The grid keeps a gap of 12 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the gap." }, { level: 2, text: "Write 12px after the colon." }], xp: 45 }),
    s80({ id: "flex-wrap-justify-content", task: "Keep the stalls packed to the left of each line.", inputMode: "guided", files: solvedFlexWrap(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 12px;\n  justify-content: ;\n}"), activeFile: "styles.css", highlightToken: "justify-content: ;", tests: [{ id: "flex-wrap-justify-content-set", kind: "style", selector: ".stall-grid", prop: "justify-content", equals: "flex-start", readable: "packed to the start", label: "The grid spaces its children packed to the start" }], hints: [{ level: 1, text: "Use the value that packs children at the start." }, { level: 2, text: "Write flex-start after the colon." }], xp: 45 }),
    s80({ id: "flex-wrap-align-content", task: "Keep the wrapped lines packed to the top.", inputMode: "guided", files: solvedFlexWrap(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 12px;\n  justify-content: flex-start;\n  align-content: ;\n}"), activeFile: "styles.css", highlightToken: "align-content: ;", tests: [{ id: "flex-wrap-align-content-set", kind: "style", selector: ".stall-grid", prop: "align-content", equals: "flex-start", readable: "lines packed to the top", label: "The grid is set to lines packed to the top" }], hints: [{ level: 1, text: "Use the value that packs the lines at the start." }, { level: 2, text: "Write flex-start after the colon." }], xp: 45 }),
    s81({ id: "fluid-sizing-width", task: "Let the card fill a narrow screen but stop at 480 pixels on a wide one.", inputMode: "guided", files: solvedFluidSizing(".info-card {\n  width: ;\n}"), activeFile: "styles.css", highlightToken: "width: ;", tests: [{ id: "fluid-sizing-width-set", kind: "source-matches", file: "styles.css", pattern: "width\\s*:\\s*min\\(\\s*100%\\s*,\\s*480px\\s*\\)", flags: "i", because: "min takes whichever of the two is smaller, so the card fits a phone and stops at 480px on a laptop.", label: "The card takes up whichever is smaller" }], hints: [{ level: 1, text: "Use the function that takes whichever value is smaller." }, { level: 2, text: "Write min(100%, 480px) after the colon." }], xp: 55 }),
    s81({ id: "fluid-sizing-font-size", task: "Let the text grow with the screen but never below 14 or above 18 pixels.", inputMode: "guided", files: solvedFluidSizing(".info-card {\n  width: min(100%, 480px);\n  font-size: ;\n}"), activeFile: "styles.css", highlightToken: "font-size: ;", tests: [{ id: "fluid-sizing-font-size-set", kind: "source-matches", file: "styles.css", pattern: "font-size\\s*:\\s*clamp\\(\\s*14px\\s*,\\s*4vw\\s*,\\s*18px\\s*\\)", flags: "i", because: "clamp names a smallest size, a size that follows the screen, and a largest.", label: "The card sets its text at text between 14 and 18 pixels" }], hints: [{ level: 1, text: "Name the smallest size, the one that follows the screen, and the largest." }, { level: 2, text: "Write clamp(14px, 4vw, 18px) after the colon." }], xp: 55 }),
    s81({ id: "fluid-sizing-aspect-ratio", task: "Keep the card the same shape whatever width it takes.", inputMode: "guided", files: solvedFluidSizing(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: ;\n}"), activeFile: "styles.css", highlightToken: "aspect-ratio: ;", tests: [{ id: "fluid-sizing-aspect-ratio-set", kind: "source-matches", file: "styles.css", pattern: "aspect-ratio\\s*:\\s*3\\s*/\\s*2", flags: "i", because: "A ratio keeps the card's shape as its width changes.", label: "The card is set to a fixed shape" }], hints: [{ level: 1, text: "Write the width and height as a ratio with a slash." }, { level: 2, text: "Write 3 / 2 after the colon." }], xp: 55 }),
    s81({ id: "fluid-sizing-padding", task: "Give the card room inside.", inputMode: "guided", files: solvedFluidSizing(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: 3 / 2;\n  padding: ;\n}"), activeFile: "styles.css", highlightToken: "padding: ;", tests: [{ id: "fluid-sizing-padding-set", kind: "style", selector: ".info-card", prop: "padding-top", equals: "16px", readable: "16 pixels", label: "The card has room inside of 16 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the inside room." }, { level: 2, text: "Write 16px after the colon." }], xp: 45 }),
    s81({ id: "fluid-sizing-box-sizing", task: "Count the padding inside the width rather than on top of it.", inputMode: "guided", files: solvedFluidSizing(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: 3 / 2;\n  padding: 16px;\n  box-sizing: ;\n}"), activeFile: "styles.css", highlightToken: "box-sizing: ;", tests: [{ id: "fluid-sizing-box-sizing-set", kind: "style", selector: ".info-card", prop: "box-sizing", equals: "border-box", readable: "border box", label: "The card measures itself as border box" }], hints: [{ level: 1, text: "Use the sizing value that includes padding and border." }, { level: 2, text: "Write border-box after the colon." }], xp: 45 }),
    s82({ id: "store-2-position", task: "Make the notice the anchor for a label added by CSS.", inputMode: "guided", files: solvedStore2(".notice-banner {\n  position: ;\n}"), activeFile: "styles.css", highlightToken: "position: ;", tests: [{ id: "store-2-position-set", kind: "style", selector: ".notice-banner", prop: "position", equals: "relative", readable: "positioned", label: "The notice is positioned" }], hints: [{ level: 1, text: "An added label is placed against a positioned element." }, { level: 2, text: "Write relative after the colon." }], xp: 45 }),
    s82({ id: "store-2-padding-top", task: "Leave room at the top for a label that is not in the HTML.", inputMode: "guided", files: solvedStore2(".notice-banner {\n  position: relative;\n  padding-top: ;\n}"), activeFile: "styles.css", highlightToken: "padding-top: ;", tests: [{ id: "store-2-padding-top-set", kind: "style", selector: ".notice-banner", prop: "padding-top", equals: "32px", readable: "32 pixels", label: "The notice has room above of 32 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the space above." }, { level: 2, text: "Write 32px after the colon." }], xp: 45 }),
    s82({ id: "store-2-content-before", task: "Add the word Notice above the heading without touching the HTML.", inputMode: "guided", files: solvedStore2(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n}\n\n.notice-banner::before {\n  content: ;\n}"), activeFile: "styles.css", highlightToken: "content: ;", tests: [{ id: "store-2-content-before-set", kind: "source-matches", file: "styles.css", pattern: "::before\\s*\\{[^}]*content\\s*:\\s*'Notice'", flags: "i", because: "An added element needs content before the browser will draw it.", label: "The notice is set to a label added by CSS" }], hints: [{ level: 1, text: "The added-element rule is open; give it something to say." }, { level: 2, text: "Write 'Notice' after the colon, quotes included." }], xp: 55 }),
    s82({ id: "store-2-color-before", task: "Colour the added label amber.", inputMode: "guided", files: solvedStore2(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n}\n\n.notice-banner::before {\n  content: 'Notice';\n  color: ;\n}"), activeFile: "styles.css", highlightToken: "color: ;", tests: [{ id: "store-2-color-before-set", kind: "source-matches", file: "styles.css", pattern: "::before\\s*\\{[^}]*color\\s*:\\s*#b45309", flags: "i", because: "The added label takes a colour of its own.", label: "The notice shows its words in an amber label" }], hints: [{ level: 1, text: "Set the colour inside the added-element rule." }, { level: 2, text: "Write #b45309 after the colon." }], xp: 55 }),
    s82({ id: "store-2-background-color", task: "Tint the notice to match its label.", inputMode: "guided", files: solvedStore2(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n  background-color: ;\n}\n\n.notice-banner::before {\n  content: 'Notice';\n  color: #b45309;\n}"), activeFile: "styles.css", highlightToken: "background-color: ;", tests: [{ id: "store-2-background-color-set", kind: "style", selector: ".notice-banner", prop: "background-color", equals: "rgb(255, 251, 235)", readable: "pale amber", label: "The notice has a background of pale amber" }], hints: [{ level: 1, text: "Use the pale amber code." }, { level: 2, text: "Write #fffbeb after the colon." }], xp: 45 }),
    s83({ id: "centre-2-display", task: "Lay the stalls out in a flexible row.", inputMode: "guided", files: solvedCentre2(".stall-grid {\n  display: ;\n}"), activeFile: "styles.css", highlightToken: "display: ;", tests: [{ id: "centre-2-display-set", kind: "style", selector: ".stall-grid", prop: "display", equals: "flex", readable: "a flex box", label: "The grid is laid out as a flex box" }], hints: [{ level: 1, text: "Use the display value that lays children out in a row." }, { level: 2, text: "Write flex after the colon." }], xp: 45 }),
    s83({ id: "centre-2-flex-wrap", task: "Let the stalls drop to the next line instead of squeezing.", inputMode: "guided", files: solvedCentre2(".stall-grid {\n  display: flex;\n  flex-wrap: ;\n}"), activeFile: "styles.css", highlightToken: "flex-wrap: ;", tests: [{ id: "centre-2-flex-wrap-set", kind: "style", selector: ".stall-grid", prop: "flex-wrap", equals: "wrap", readable: "wrapping onto new lines", label: "The grid is set to wrapping onto new lines" }], hints: [{ level: 1, text: "Use the value that allows a new line." }, { level: 2, text: "Write wrap after the colon." }], xp: 45 }),
    s83({ id: "centre-2-gap", task: "Space the stalls apart in both directions.", inputMode: "guided", files: solvedCentre2(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: ;\n}"), activeFile: "styles.css", highlightToken: "gap: ;", tests: [{ id: "centre-2-gap-set", kind: "style", selector: ".stall-grid", prop: "row-gap", equals: "12px", readable: "12 pixels", label: "The grid keeps a gap of 12 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the gap." }, { level: 2, text: "Write 12px after the colon." }], xp: 45 }),
    s83({ id: "centre-2-justify-content", task: "Keep the stalls packed to the left of each line.", inputMode: "guided", files: solvedCentre2(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 12px;\n  justify-content: ;\n}"), activeFile: "styles.css", highlightToken: "justify-content: ;", tests: [{ id: "centre-2-justify-content-set", kind: "style", selector: ".stall-grid", prop: "justify-content", equals: "flex-start", readable: "packed to the start", label: "The grid spaces its children packed to the start" }], hints: [{ level: 1, text: "Use the value that packs children at the start." }, { level: 2, text: "Write flex-start after the colon." }], xp: 45 }),
    s83({ id: "centre-2-align-content", task: "Keep the wrapped lines packed to the top.", inputMode: "guided", files: solvedCentre2(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 12px;\n  justify-content: flex-start;\n  align-content: ;\n}"), activeFile: "styles.css", highlightToken: "align-content: ;", tests: [{ id: "centre-2-align-content-set", kind: "style", selector: ".stall-grid", prop: "align-content", equals: "flex-start", readable: "lines packed to the top", label: "The grid is set to lines packed to the top" }], hints: [{ level: 1, text: "Use the value that packs the lines at the start." }, { level: 2, text: "Write flex-start after the colon." }], xp: 45 }),
    s84({ id: "board-2-width", task: "Let the card fill a narrow screen but stop at 480 pixels on a wide one.", inputMode: "guided", files: solvedBoard2(".info-card {\n  width: ;\n}"), activeFile: "styles.css", highlightToken: "width: ;", tests: [{ id: "board-2-width-set", kind: "source-matches", file: "styles.css", pattern: "width\\s*:\\s*min\\(\\s*100%\\s*,\\s*480px\\s*\\)", flags: "i", because: "min takes whichever of the two is smaller, so the card fits a phone and stops at 480px on a laptop.", label: "The card takes up whichever is smaller" }], hints: [{ level: 1, text: "Use the function that takes whichever value is smaller." }, { level: 2, text: "Write min(100%, 480px) after the colon." }], xp: 55 }),
    s84({ id: "board-2-font-size", task: "Let the text grow with the screen but never below 14 or above 18 pixels.", inputMode: "guided", files: solvedBoard2(".info-card {\n  width: min(100%, 480px);\n  font-size: ;\n}"), activeFile: "styles.css", highlightToken: "font-size: ;", tests: [{ id: "board-2-font-size-set", kind: "source-matches", file: "styles.css", pattern: "font-size\\s*:\\s*clamp\\(\\s*14px\\s*,\\s*4vw\\s*,\\s*18px\\s*\\)", flags: "i", because: "clamp names a smallest size, a size that follows the screen, and a largest.", label: "The card sets its text at text between 14 and 18 pixels" }], hints: [{ level: 1, text: "Name the smallest size, the one that follows the screen, and the largest." }, { level: 2, text: "Write clamp(14px, 4vw, 18px) after the colon." }], xp: 55 }),
    s84({ id: "board-2-aspect-ratio", task: "Keep the card the same shape whatever width it takes.", inputMode: "guided", files: solvedBoard2(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: ;\n}"), activeFile: "styles.css", highlightToken: "aspect-ratio: ;", tests: [{ id: "board-2-aspect-ratio-set", kind: "source-matches", file: "styles.css", pattern: "aspect-ratio\\s*:\\s*3\\s*/\\s*2", flags: "i", because: "A ratio keeps the card's shape as its width changes.", label: "The card is set to a fixed shape" }], hints: [{ level: 1, text: "Write the width and height as a ratio with a slash." }, { level: 2, text: "Write 3 / 2 after the colon." }], xp: 55 }),
    s84({ id: "board-2-padding", task: "Give the card room inside.", inputMode: "guided", files: solvedBoard2(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: 3 / 2;\n  padding: ;\n}"), activeFile: "styles.css", highlightToken: "padding: ;", tests: [{ id: "board-2-padding-set", kind: "style", selector: ".info-card", prop: "padding-top", equals: "16px", readable: "16 pixels", label: "The card has room inside of 16 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the inside room." }, { level: 2, text: "Write 16px after the colon." }], xp: 45 }),
    s84({ id: "board-2-box-sizing", task: "Count the padding inside the width rather than on top of it.", inputMode: "guided", files: solvedBoard2(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: 3 / 2;\n  padding: 16px;\n  box-sizing: ;\n}"), activeFile: "styles.css", highlightToken: "box-sizing: ;", tests: [{ id: "board-2-box-sizing-set", kind: "style", selector: ".info-card", prop: "box-sizing", equals: "border-box", readable: "border box", label: "The card measures itself as border box" }], hints: [{ level: 1, text: "Use the sizing value that includes padding and border." }, { level: 2, text: "Write border-box after the colon." }], xp: 45 }),
    s85({ id: "stall-3-position", task: "Make the notice the anchor for a label added by CSS.", inputMode: "guided", files: solvedStall3(".notice-banner {\n  position: ;\n}"), activeFile: "styles.css", highlightToken: "position: ;", tests: [{ id: "stall-3-position-set", kind: "style", selector: ".notice-banner", prop: "position", equals: "relative", readable: "positioned", label: "The notice is positioned" }], hints: [{ level: 1, text: "An added label is placed against a positioned element." }, { level: 2, text: "Write relative after the colon." }], xp: 45 }),
    s85({ id: "stall-3-padding-top", task: "Leave room at the top for a label that is not in the HTML.", inputMode: "guided", files: solvedStall3(".notice-banner {\n  position: relative;\n  padding-top: ;\n}"), activeFile: "styles.css", highlightToken: "padding-top: ;", tests: [{ id: "stall-3-padding-top-set", kind: "style", selector: ".notice-banner", prop: "padding-top", equals: "32px", readable: "32 pixels", label: "The notice has room above of 32 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the space above." }, { level: 2, text: "Write 32px after the colon." }], xp: 45 }),
    s85({ id: "stall-3-content-before", task: "Add the word Notice above the heading without touching the HTML.", inputMode: "guided", files: solvedStall3(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n}\n\n.notice-banner::before {\n  content: ;\n}"), activeFile: "styles.css", highlightToken: "content: ;", tests: [{ id: "stall-3-content-before-set", kind: "source-matches", file: "styles.css", pattern: "::before\\s*\\{[^}]*content\\s*:\\s*'Notice'", flags: "i", because: "An added element needs content before the browser will draw it.", label: "The notice is set to a label added by CSS" }], hints: [{ level: 1, text: "The added-element rule is open; give it something to say." }, { level: 2, text: "Write 'Notice' after the colon, quotes included." }], xp: 55 }),
    s85({ id: "stall-3-color-before", task: "Colour the added label amber.", inputMode: "guided", files: solvedStall3(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n}\n\n.notice-banner::before {\n  content: 'Notice';\n  color: ;\n}"), activeFile: "styles.css", highlightToken: "color: ;", tests: [{ id: "stall-3-color-before-set", kind: "source-matches", file: "styles.css", pattern: "::before\\s*\\{[^}]*color\\s*:\\s*#b45309", flags: "i", because: "The added label takes a colour of its own.", label: "The notice shows its words in an amber label" }], hints: [{ level: 1, text: "Set the colour inside the added-element rule." }, { level: 2, text: "Write #b45309 after the colon." }], xp: 55 }),
    s85({ id: "stall-3-background-color", task: "Tint the notice to match its label.", inputMode: "guided", files: solvedStall3(".notice-banner {\n  position: relative;\n  padding-top: 32px;\n  background-color: ;\n}\n\n.notice-banner::before {\n  content: 'Notice';\n  color: #b45309;\n}"), activeFile: "styles.css", highlightToken: "background-color: ;", tests: [{ id: "stall-3-background-color-set", kind: "style", selector: ".notice-banner", prop: "background-color", equals: "rgb(255, 251, 235)", readable: "pale amber", label: "The notice has a background of pale amber" }], hints: [{ level: 1, text: "Use the pale amber code." }, { level: 2, text: "Write #fffbeb after the colon." }], xp: 45 }),
    s86({ id: "menu-2-display", task: "Lay the stalls out in a flexible row.", inputMode: "guided", files: solvedMenu2(".stall-grid {\n  display: ;\n}"), activeFile: "styles.css", highlightToken: "display: ;", tests: [{ id: "menu-2-display-set", kind: "style", selector: ".stall-grid", prop: "display", equals: "flex", readable: "a flex box", label: "The grid is laid out as a flex box" }], hints: [{ level: 1, text: "Use the display value that lays children out in a row." }, { level: 2, text: "Write flex after the colon." }], xp: 45 }),
    s86({ id: "menu-2-flex-wrap", task: "Let the stalls drop to the next line instead of squeezing.", inputMode: "guided", files: solvedMenu2(".stall-grid {\n  display: flex;\n  flex-wrap: ;\n}"), activeFile: "styles.css", highlightToken: "flex-wrap: ;", tests: [{ id: "menu-2-flex-wrap-set", kind: "style", selector: ".stall-grid", prop: "flex-wrap", equals: "wrap", readable: "wrapping onto new lines", label: "The grid is set to wrapping onto new lines" }], hints: [{ level: 1, text: "Use the value that allows a new line." }, { level: 2, text: "Write wrap after the colon." }], xp: 45 }),
    s86({ id: "menu-2-gap", task: "Space the stalls apart in both directions.", inputMode: "guided", files: solvedMenu2(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: ;\n}"), activeFile: "styles.css", highlightToken: "gap: ;", tests: [{ id: "menu-2-gap-set", kind: "style", selector: ".stall-grid", prop: "row-gap", equals: "12px", readable: "12 pixels", label: "The grid keeps a gap of 12 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the gap." }, { level: 2, text: "Write 12px after the colon." }], xp: 45 }),
    s86({ id: "menu-2-justify-content", task: "Keep the stalls packed to the left of each line.", inputMode: "guided", files: solvedMenu2(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 12px;\n  justify-content: ;\n}"), activeFile: "styles.css", highlightToken: "justify-content: ;", tests: [{ id: "menu-2-justify-content-set", kind: "style", selector: ".stall-grid", prop: "justify-content", equals: "flex-start", readable: "packed to the start", label: "The grid spaces its children packed to the start" }], hints: [{ level: 1, text: "Use the value that packs children at the start." }, { level: 2, text: "Write flex-start after the colon." }], xp: 45 }),
    s86({ id: "menu-2-align-content", task: "Keep the wrapped lines packed to the top.", inputMode: "guided", files: solvedMenu2(".stall-grid {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 12px;\n  justify-content: flex-start;\n  align-content: ;\n}"), activeFile: "styles.css", highlightToken: "align-content: ;", tests: [{ id: "menu-2-align-content-set", kind: "style", selector: ".stall-grid", prop: "align-content", equals: "flex-start", readable: "lines packed to the top", label: "The grid is set to lines packed to the top" }], hints: [{ level: 1, text: "Use the value that packs the lines at the start." }, { level: 2, text: "Write flex-start after the colon." }], xp: 45 }),
    s87({ id: "league-2-width", task: "Let the card fill a narrow screen but stop at 480 pixels on a wide one.", inputMode: "guided", files: solvedLeague2(".info-card {\n  width: ;\n}"), activeFile: "styles.css", highlightToken: "width: ;", tests: [{ id: "league-2-width-set", kind: "source-matches", file: "styles.css", pattern: "width\\s*:\\s*min\\(\\s*100%\\s*,\\s*480px\\s*\\)", flags: "i", because: "min takes whichever of the two is smaller, so the card fits a phone and stops at 480px on a laptop.", label: "The card takes up whichever is smaller" }], hints: [{ level: 1, text: "Use the function that takes whichever value is smaller." }, { level: 2, text: "Write min(100%, 480px) after the colon." }], xp: 55 }),
    s87({ id: "league-2-font-size", task: "Let the text grow with the screen but never below 14 or above 18 pixels.", inputMode: "guided", files: solvedLeague2(".info-card {\n  width: min(100%, 480px);\n  font-size: ;\n}"), activeFile: "styles.css", highlightToken: "font-size: ;", tests: [{ id: "league-2-font-size-set", kind: "source-matches", file: "styles.css", pattern: "font-size\\s*:\\s*clamp\\(\\s*14px\\s*,\\s*4vw\\s*,\\s*18px\\s*\\)", flags: "i", because: "clamp names a smallest size, a size that follows the screen, and a largest.", label: "The card sets its text at text between 14 and 18 pixels" }], hints: [{ level: 1, text: "Name the smallest size, the one that follows the screen, and the largest." }, { level: 2, text: "Write clamp(14px, 4vw, 18px) after the colon." }], xp: 55 }),
    s87({ id: "league-2-aspect-ratio", task: "Keep the card the same shape whatever width it takes.", inputMode: "guided", files: solvedLeague2(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: ;\n}"), activeFile: "styles.css", highlightToken: "aspect-ratio: ;", tests: [{ id: "league-2-aspect-ratio-set", kind: "source-matches", file: "styles.css", pattern: "aspect-ratio\\s*:\\s*3\\s*/\\s*2", flags: "i", because: "A ratio keeps the card's shape as its width changes.", label: "The card is set to a fixed shape" }], hints: [{ level: 1, text: "Write the width and height as a ratio with a slash." }, { level: 2, text: "Write 3 / 2 after the colon." }], xp: 55 }),
    s87({ id: "league-2-padding", task: "Give the card room inside.", inputMode: "guided", files: solvedLeague2(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: 3 / 2;\n  padding: ;\n}"), activeFile: "styles.css", highlightToken: "padding: ;", tests: [{ id: "league-2-padding-set", kind: "style", selector: ".info-card", prop: "padding-top", equals: "16px", readable: "16 pixels", label: "The card has room inside of 16 pixels" }], hints: [{ level: 1, text: "Use a pixel value for the inside room." }, { level: 2, text: "Write 16px after the colon." }], xp: 45 }),
    s87({ id: "league-2-box-sizing", task: "Count the padding inside the width rather than on top of it.", inputMode: "guided", files: solvedLeague2(".info-card {\n  width: min(100%, 480px);\n  font-size: clamp(14px, 4vw, 18px);\n  aspect-ratio: 3 / 2;\n  padding: 16px;\n  box-sizing: ;\n}"), activeFile: "styles.css", highlightToken: "box-sizing: ;", tests: [{ id: "league-2-box-sizing-set", kind: "style", selector: ".info-card", prop: "box-sizing", equals: "border-box", readable: "border box", label: "The card measures itself as border box" }], hints: [{ level: 1, text: "Use the sizing value that includes padding and border." }, { level: 2, text: "Write border-box after the colon." }], xp: 45 }),
  ],
};
