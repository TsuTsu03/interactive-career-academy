...
const references = {
  ...
  "fiesta-programme-justify-between": { estimatedMinutes: 4, solution: { "index.html": "<div class=\"flex justify-between\">Fiesta Fiesta - PHP 85</div>", "styles.css": ".justify-between {\n  justify-content: space-between;\n}" } },
  "fiesta-programme-items-center": { estimatedMinutes: 4, solution: { "index.html": "<div class=\"flex justify-between items-center\">Fiesta Fiesta - PHP 85</div>", "styles.css": ".items-center {\n  align-items: center;\n}" } },
  "fiesta-programme-gap-3": { estimatedMinutes: 4, solution: { "index.html": "<div class=\"flex justify-between items-center gap-3\">Fiesta Fiesta - PHP 85</div>", "styles.css": ".gap-3 {\n  gap: 0.75rem;\n}" } },
  "fiesta-programme-p-3": { estimatedMinutes: 4, solution: { "index.html": "<div class=\"flex justify-between items-center gap-3 p-3\">Fiesta Fiesta - PHP 85</div>", "styles.css": ".p-3 {\n  padding: 0.75rem;\n}" } },
  ...
  "rice-retailer-px-2": { estimatedMinutes: 4, solution: { "index.html": "<span class=\"inline-block px-2\">Rice Price: PHP 85</span>", "styles.css": ".px-2 {\n  padding-left: 0.5rem;\n  padding-right: 0.5rem;\n}" } },
  "rice-retailer-py-1": { estimatedMinutes: 4, solution: { "index.html": "<span class=\"inline-block px-2 py-1\">Rice Price: PHP 85</span>", "styles.css": ".py-1 {\n  padding-top: 0.25rem;\n  padding-bottom: 0.25rem;\n}" } },
  "rice-retailer-rounded-full": { estimatedMinutes: 4, solution: { "index.html": "<span class=\"inline-block px-2 py-1 rounded-full\">Rice Price: PHP 85</span>", "styles.css": ".rounded-full {\n  border-radius: 9999px;\n}" } },
  "rice-retailer-text-sm": { estimatedMinutes: 4, solution: { "index.html": "<span class=\"inline-block px-2 py-1 rounded-full text-sm\">Rice Price: PHP 85</span>", "styles.css": ".text-sm {\n  font-size: 0.875rem;\n}" } },
  ...
  "laundry-shop-p-4": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"max-w-sm p-4\">Wash Your Clothes Here</article>", "styles.css": ".p-4 {\n  padding: 1rem;\n}" } },
  "laundry-shop-mb-6": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"max-w-sm p-4 mb-6\">Wash Your Clothes Here</article>", "styles.css": ".mb-6 {\n  margin-bottom: 1.5rem;\n}" } },
  "laundry-shop-mt-2": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"max-w-sm p-4 mb-6 mt-2\">Wash Your Clothes Here</article>", "styles.css": ".mt-2 {\n  margin-top: 0.5rem;\n}" } },
  "laundry-shop-px-6": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"max-w-sm p-4 mb-6 mt-2 px-6\">Wash Your Clothes Here</article>", "styles.css": ".px-6 {\n  padding-left: 1.5rem;\n  padding-right: 1.5rem;\n}" } },
  ...
  "pharmacy-shelf-text-amber-900": { estimatedMinutes: 4, solution: { "index.html": "<aside class=\"bg-amber-50 text-amber-900\">Free shipping on orders over PHP 100</aside>", "styles.css": ".text-amber-900 {\n  color: #78350f;\n}" } },
  "pharmacy-shelf-p-4": { estimatedMinutes: 4, solution: { "index.html": "<aside class=\"bg-amber-50 text-amber-900 p-4\">Free shipping on orders over PHP 100</aside>", "styles.css": ".p-4 {\n  padding: 1rem;\n}" } },
  "pharmacy-shelf-rounded-lg": { estimatedMinutes: 4, solution: { "index.html": "<aside class=\"bg-amber-50 text-amber-900 p-4 rounded-lg\">Free shipping on orders over PHP 100</aside>", "styles.css": ".rounded-lg {\n  border-radius: 0.5rem;\n}" } },
  "pharmacy-shelf-border-amber-200": { estimatedMinutes: 4, solution: { "index.html": "<aside class=\"bg-amber-50 text-amber-900 p-4 rounded-lg border-amber-200\">Free shipping on orders over PHP 100</aside>", "styles.css": ".border-amber-200 {\n  border: 1px solid #fde68a;\n}" } },
  "sari-sari-text-xl": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"text-xl\">Fresh Produce</article>", "styles.css": ".text-xl {\n  font-size: 1.25rem;\n}" } },
  "sari-sari-font-semibold": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"text-xl font-semibold\">Fresh Produce</article>", "styles.css": ".font-semibold {\n  font-weight: 600;\n}" } },
  "sari-sari-leading-relaxed": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"text-xl font-semibold leading-relaxed\">Fresh Produce</article>", "styles.css": ".leading-relaxed {\n  line-height: 1.625;\n}" } },
  "sari-sari-tracking-wide": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"text-xl font-semibold leading-relaxed tracking-wide\">Fresh Produce</article>", "styles.css": ".tracking-wide {\n  letter-spacing: 0.025em;\n}" } },
  "sari-sari-text-center": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"text-xl font-semibold leading-relaxed tracking-wide text-center\">Fresh Produce</article>", "styles.css": ".text-center {\n  text-align: center;\n}" } },
  ...
  "barangay-health-justify-between": { estimatedMinutes: 4, solution: { "index.html": "<div class=\"flex justify-between\">Vaccination Drive - PHP 85 per dose</div>", "styles.css": ".justify-between {\n  justify-content: space-between;\n}" } },
  "barangay-health-items-center": { estimatedMinutes: 4, solution: { "index.html": "<div class=\"flex justify-between items-center\">Vaccination Drive - PHP 85 per dose</div>", "styles.css": ".items-center {\n  align-items: center;\n}" } },
  "barangay-health-gap-3": { estimatedMinutes: 4, solution: { "index.html": "<div class=\"flex justify-between items-center gap-3\">Vaccination Drive - PHP 85 per dose</div>", "styles.css": ".gap-3 {\n  gap: 0.75rem;\n}" } },
  "barangay-health-p-3": { estimatedMinutes: 4, solution: { "index.html": "<div class=\"flex justify-between items-center gap-3 p-3\">Vaccination Drive - PHP 85 per dose</div>", "styles.css": ".p-3 {\n  padding: 0.75rem;\n}" } },
  ...
  "jeepney-route-px-2": { estimatedMinutes: 4, solution: { "index.html": "<span class=\"inline-block px-2\">Route 123</span>", "styles.css": ".px-2 {\n  padding-left: 0.5rem;\n  padding-right: 0.5rem;\n}" } },
  "jeepney-route-py-1": { estimatedMinutes: 4, solution: { "index.html": "<span class=\"inline-block px-2 py-1\">Route 123</span>", "styles.css": ".py-1 {\n  padding-top: 0.25rem;\n  padding-bottom: 0.25rem;\n}" } },
  "jeepney-route-rounded-full": { estimatedMinutes: 4, solution: { "index.html": "<span class=\"inline-block px-2 py-1 rounded-full\">Route 123</span>", "styles.css": ".rounded-full {\n  border-radius: 9999px;\n}" } },
  "jeepney-route-text-sm": { estimatedMinutes: 4, solution: { "index.html": "<span class=\"inline-block px-2 py-1 rounded-full text-sm\">Route 123</span>", "styles.css": ".text-sm {\n  font-size: 0.875rem;\n}" } },
  ...
  "palengke-stall-p-4": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"max-w-sm p-4\">Spacing Guide</article>", "styles.css": ".p-4 {\n  padding: 1rem;\n}" } },
  "palengke-stall-mb-6": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"max-w-sm p-4 mb-6\">Spacing Guide</article>", "styles.css": ".mb-6 {\n  margin-bottom: 1.5rem;\n}" } },
  "palengke-stall-mt-2": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"max-w-sm p-4 mb-6 mt-2\">Spacing Guide</article>", "styles.css": ".mt-2 {\n  margin-top: 0.5rem;\n}" } },
  "palengke-stall-px-6": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"max-w-sm p-4 mb-6 mt-2 px-6\">Spacing Guide</article>", "styles.css": ".px-6 {\n  padding-left: 1.5rem;\n  padding-right: 1.5rem;\n}" } },
  ...
  "turo-turo-text-amber-900": { estimatedMinutes: 4, solution: { "index.html": "<aside class=\"bg-amber-50 text-amber-900\">Turo-turo Counter Notice</aside>", "styles.css": ".text-amber-900 {\n  color: #78350f;\n}" } },
  "turo-turo-p-4": { estimatedMinutes: 4, solution: { "index.html": "<aside class=\"bg-amber-50 text-amber-900 p-4\">Turo-turo Counter Notice</aside>", "styles.css": ".p-4 {\n  padding: 1rem;\n}" } },
  "turo-turo-rounded-lg": { estimatedMinutes: 4, solution: { "index.html": "<aside class=\"bg-amber-50 text-amber-900 p-4 rounded-lg\">Turo-turo Counter Notice</aside>", "styles.css": ".rounded-lg {\n  border-radius: 0.5rem;\n}" } },
  "turo-turo-border-amber-200": { estimatedMinutes: 4, solution: { "index.html": "<aside class=\"bg-amber-50 text-amber-900 p-4 rounded-lg border-amber-200\">Turo-turo Counter Notice</aside>", "styles.css": ".border-amber-200 {\n  border: 1px solid #fde68a;\n}" } },
  ...
  "school-notice-font-semibold": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"text-xl font-semibold\">Welcome Notice</article>", "styles.css": ".font-semibold {\n  font-weight: 600;\n}" } },
  "school-notice-leading-relaxed": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"text-xl font-semibold leading-relaxed\">Welcome Notice</article>", "styles.css": ".leading-relaxed {\n  line-height: 1.625;\n}" } },
  "school-notice-tracking-wide": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"text-xl font-semibold leading-relaxed tracking-wide\">Welcome Notice</article>", "styles.css": ".tracking-wide {\n  letter-spacing: 0.025em;\n}" } },
  "school-notice-text-center": { estimatedMinutes: 4, solution: { "index.html": "<article class=\"text-xl font-semibold leading-relaxed tracking-wide text-center\">Welcome Notice</article>", "styles.css": ".text-center {\n  text-align: center;\n}" } },
  "tricycle-terminal-flex": { estimatedMinutes: 4, solution: { "index.html": "<div class=\"flex\">Tricycle Fare - PHP 85</div>", "styles.css": ".flex {\n  display: flex;\n}" } },
  "tricycle-terminal-justify-between": { estimatedMinutes: 4, solution: { "index.html": "<div class=\"flex justify-between\">Tricycle Fare - PHP 85</div>", "styles.css": ".justify-between {\n  justify-content: space-between;\n}" } },
  "tricycle-terminal-items-center": { estimatedMinutes: 4, solution: { "index.html": "<div class=\"flex justify-between items-center\">Tricycle Fare - PHP 85</div>", "styles.css": ".items-center {\n  align-items: center;\n}" } },
  "tricycle-terminal-gap-3": { estimatedMinutes: 4, solution: { "index.html": "<div class=\"flex justify-between items-center gap-3\">Tricycle Fare - PHP 85</div>", "styles.css": ".gap-3 {\n  gap: 0.75rem;\n}" } },
  "tricycle-terminal-p-3": { estimatedMinutes: 4, solution: { "index.html": "<div class=\"flex justify-between items-center gap-3 p-3\">Tricycle Fare - PHP 85</div>", "styles.css": ".p-3 {\n  padding: 0.75rem;\n}" } },
  ...
  "bakery-display-px-2": { estimatedMinutes: 4, solution: { "index.html": "<span class=\"inline-block px-2\">Bakery Specials</span>", "styles.css": ".px-2 {\n  padding-left: 0.5rem;\n  padding-right: 0.5rem;\n}" } },
  "bakery-display-py-1": { estimatedMinutes: 4, solution: { "index.html": "<span class=\"inline-block px-2 py-1\">Bakery Specials</span>", "styles.css": ".py-1 {\n  padding-top: 0.25rem;\n  padding-bottom: 0.25rem;\n}" } },
  "bakery-display-rounded-full": { estimatedMinutes: 4, solution: { "index.html": "<span class=\"inline-block px-2 py-1 rounded-full\">Bakery Specials</span>", "styles.css": ".rounded-full {\n  border-radius: 9999px;\n}" } },
  "bakery-display-text-sm": { estimatedMinutes: 4, solution: { "index.html": "<span class=\"inline-block px-2 py-1 rounded-full text-sm\">Bakery Specials</span>", "styles.css": ".text-sm {\n  font-size: 0.875rem;\n}" } },
...
export const tailwindCourse: Course = {
  ...
  steps: [
    ...
    s13({ id: "fiesta-programme-justify-between", task: "Push the price to the far right.", inputMode: "guided", files: { "index.html": "<div class=\"flex\">Fiesta Fiesta - PHP 85</div>", "styles.css": ".justify-between {\n  justify-content: space-between;\n}" }, activeFile: "index.html", highlightToken: "flex", tests: [{ id: "fiesta-programme-justify-between-style", kind: "style", selector: ".justify-between", prop: "justify-content", equals: "space-between", readable: "pushed apart", label: "The row has pushed apart" }], hints: [{ level: 1, text: "Add the space-between utility. It goes after flex." }, { level: 2, text: "Add justify-between to the class list." }], xp: 40 }),
    s13({ id: "fiesta-programme-items-center", task: "Line the two up through their middles.", inputMode: "guided", files: { "index.html": "<div class=\"flex justify-between\">Fiesta Fiesta - PHP 85</div>", "styles.css": ".items-center {\n  align-items: center;\n}" }, activeFile: "index.html", highlightToken: "justify-between", tests: [{ id: "fiesta-programme-items-center-style", kind: "style", selector: ".items-center", prop: "align-items", equals: "center", readable: "centred across", label: "The row has centred across" }], hints: [{ level: 1, text: "Add the centred cross-axis utility. It goes after justify-between." }, { level: 2, text: "Add items-center to the class list." }], xp: 40 }),
    s13({ id: "fiesta-programme-gap-3", task: "Keep a minimum gap between them.", inputMode: "guided", files: { "index.html": "<div class=\"flex justify-between items-center\">Fiesta Fiesta - PHP 85</div>", "styles.css": ".gap-3 {\n  gap: 0.75rem;\n}" }, activeFile: "index.html", highlightToken: "items-center", tests: [{ id: "fiesta-programme-gap-3-style", kind: "style", selector: ".gap-3", prop: "column-gap", equals: "12px", readable: "12 pixels", label: "The row has 12 pixels" }], hints: [{ level: 1, text: "Add the three-step gap utility. It goes after items-center." }, { level: 2, text: "Add gap-3 to the class list." }], xp: 40 }),
    s13({ id: "fiesta-programme-p-3", task: "Give the row room inside.", inputMode: "guided", files: { "index.html": "<div class=\"flex justify-between items-center gap-3\">Fiesta Fiesta - PHP 85</div>", "styles.css": ".p-3 {\n  padding: 0.75rem;\n}" }, activeFile: "index.html", highlightToken: "gap-3", tests: [{ id: "fiesta-programme-p-3-style", kind: "style", selector: ".p-3", prop: "padding-top", equals: "12px", readable: "12 pixels", label: "The row has 12 pixels" }], hints: [{ level: 1, text: "Add the three-step padding utility. It goes after gap-3." }, { level: 2, text: "Add p-3 to the class list." }], xp: 40 }),
    ...
    s14({ id: "rice-retailer-px-2", task: "Give the badge room on its left and right.", inputMode: "guided", files: { "index.html": "<span class=\"inline-block\">Rice Price: PHP 85</span>", "styles.css": ".px-2 {\n  padding-left: 0.5rem;\n  padding-right: 0.5rem;\n}" }, activeFile: "index.html", highlightToken: "inline-block", tests: [{ id: "rice-retailer-px-2-class", kind: "source-matches", file: "index.html", pattern: "class=\\\"[^\\\"]*\\bpx-2\\b", flags: "i", because: "Add px-2 to the class list.", label: "The badge has side padding" }], hints: [{ level: 1, text: "Add the two-step horizontal padding utility. It goes after inline-block." }, { level: 2, text: "Add px-2 to the class list." }], xp: 40 }),
    s14({ id: "rice-retailer-py-1", task: "Give the badge a little room above and below.", inputMode: "guided", files: { "index.html": "<span class=\"inline-block px-2\">Rice Price: PHP 85</span>", "styles.css": ".py-1 {\n  padding-top: 0.25rem;\n  padding-bottom: 0.25rem;\n}" }, activeFile: "index.html", highlightToken: "px-2", tests: [{ id: "rice-retailer-py-1-class", kind: "source-matches", file: "index.html", pattern: "class=\\\"[^\\\"]*\\bpy-1\\b", flags: "i", because: "Add py-1 to the class list.", label: "The badge has top and bottom padding" }], hints: [{ level: 1, text: "Add the one-step vertical padding utility. It goes after px-2." }, { level: 2, text: "Add py-1 to the class list." }], xp: 40 }),
    s14({ id: "rice-retailer-rounded-full", task: "Round the badge into a pill shape.", inputMode: "guided", files: { "index.html": "<span class=\"inline-block px-2 py-1\">Rice Price: PHP 85</span>", "styles.css": ".rounded-full {\n  border-radius: 9999px;\n}" }, activeFile: "index.html", highlightToken: "py-1", tests: [{ id: "rice-retailer-rounded-full-style", kind: "style", selector: ".rounded-full", prop: "border-top-left-radius", equals: "9999px", readable: "fully rounded ends", label: "The badge has fully rounded ends" }], hints: [{ level: 1, text: "Add the fully-rounded utility. It goes after py-1." }, { level: 2, text: "Add rounded-full to the class list." }], xp: 40 }),
    s14({ id: "rice-retailer-text-sm", task: "Make the badge text smaller than the words around it.", inputMode: "guided", files: { "index.html": "<span class=\"inline-block px-2 py-1 rounded-full\">Rice Price: PHP 85</span>", "styles.css": ".text-sm {\n  font-size: 0.875rem;\n}" }, activeFile: "index.html", highlightToken: "rounded-full", tests: [{ id: "rice-retailer-text-sm-style", kind: "style", selector: ".text-sm", prop: "font-size", equals: "14px", readable: "14 pixels", label: "The badge has 14 pixels" }], hints: [{ level: 1, text: "Add the small text-size utility. It goes after rounded-full." }, { level: 2, text: "Add text-sm to the class list." }], xp: 40 }),
    ...
    s15({ id: "laundry-shop-p-4", task: "Give the card room inside.", inputMode: "guided", files: { "index.html": "<article class=\"max-w-sm\">Wash Your Clothes Here</article>", "styles.css": ".p-4 {\n  padding: 1rem;\n}" }, activeFile: "index.html", highlightToken: "max-w-sm", tests: [{ id: "laundry-shop-p-4-style", kind: "style", selector: ".p-4", prop: "padding-top", equals: "16px", readable: "16 pixels", label: "The card has 16 pixels" }], hints: [{ level: 1, text: "Add the four-step padding utility. It goes after max-w-sm." }, { level: 2, text: "Add p-4 to the class list." }], xp: 40 }),
    s15({ id: "laundry-shop-mb-6", task: "Leave space below the card.", inputMode: "guided", files: { "index.html": "<article class=\"max-w-sm p-4\">Wash Your Clothes Here</article>", "styles.css": ".mb-6 {\n  margin-bottom: 1.5rem;\n}" }, activeFile: "index.html", highlightToken: "p-4", tests: [{ id: "laundry-shop-mb-6-style", kind: "style", selector: ".mb-6", prop: "margin-bottom", equals: "24px", readable: "24 pixels", label: "The card has 24 pixels" }], hints: [{ level: 1, text: "Add the six-step bottom-margin utility. It goes after p-4." }, { level: 2, text: "Add mb-6 to the class list." }], xp: 40 }),
    s15({ id: "laundry-shop-mt-2", task: "Leave a small space above the card.", inputMode: "guided", files: { "index.html": "<article class=\"max-w-sm p-4 mb-6\">Wash Your Clothes Here</article>", "styles.css": ".mt-2 {\n  margin-top: 0.5rem;\n}" }, activeFile: "index.html", highlightToken: "mb-6", tests: [{ id: "laundry-shop-mt-2-style", kind: "style", selector: ".mt-2", prop: "margin-top", equals: "8px", readable: "8 pixels", label: "The card has 8 pixels" }], hints: [{ level: 1, text: "Add the two-step top-margin utility. It goes after mb-6." }, { level: 2, text: "Add mt-2 to the class list." }], xp: 40 }),
    s15({ id: "laundry-shop-px-6", task: "Widen the room on the left and right only.", inputMode: "guided", files: { "index.html": "<article class=\"max-w-sm p-4 mb-6 mt-2\">Wash Your Clothes Here</article>", "styles.css": ".px-6 {\n  padding-left: 1.5rem;\n  padding-right: 1.5rem;\n}" }, activeFile: "index.html", highlightToken: "mt-2", tests: [{ id: "laundry-shop-px-6-class", kind: "source-matches", file: "index.html", pattern: "class=\\\"[^\\\"]*\\bpx-6\\b", flags: "i", because: "Add px-6 to the class list.", label: "The card has wider side padding" }], hints: [{ level: 1, text: "Add the six-step horizontal padding utility. It goes after mt-2." }, { level: 2, text: "Add px-6 to the class list." }], xp: 40 }),
    ...
    s16({ id: "pharmacy-shelf-text-amber-900", task: "Darken the notice words so they have enough contrast.", inputMode: "guided", files: { "index.html": "<aside class=\"bg-amber-50\">Free shipping on orders over PHP 100</aside>", "styles.css": ".text-amber-900 {\n  color: #78350f;\n}" }, activeFile: "index.html", highlightToken: "bg-amber-50", tests: [{ id: "pharmacy-shelf-text-amber-900-style", kind: "style", selector: ".text-amber-900", prop: "color", equals: "rgb(120, 53, 15)", readable: "dark amber", label: "The notice has dark amber" }], hints: [{ level: 1, text: "Add the darkest amber text utility. It goes after bg-amber-50." }, { level: 2, text: "Add text-amber-900 to the class list." }], xp: 40 }),
    s16({ id: "pharmacy-shelf-p-4", task: "Give the notice room inside.", inputMode: "guided", files: { "index.html": "<aside class=\"bg-amber-50 text-amber-900\">Free shipping on orders over PHP 100</aside>", "styles.css": ".p-4 {\n  padding: 1rem;\n}" }, activeFile: "index.html", highlightToken: "text-amber-900", tests: [{ id: "pharmacy-shelf-p-4-style", kind: "style", selector: ".p-4", prop: "padding-top", equals: "16px", readable: "16 pixels", label: "The notice has 16 pixels" }], hints: [{ level: 1, text: "Add the four-step padding utility. It goes after text-amber-900." }, { level: 2, text: "Add p-4 to the class list." }], xp: 40 }),
    s16({ id: "pharmacy-shelf-rounded-lg", task: "Round the notice corners.", inputMode: "guided", files: { "index.html": "<aside class=\"bg-amber-50 text-amber-900 p-4\">Free shipping on orders over PHP 100</aside>", "styles.css": ".rounded-lg {\n  border-radius: 0.5rem;\n}" }, activeFile: "index.html", highlightToken: "p-4", tests: [{ id: "pharmacy-shelf-rounded-lg-style", kind: "style", selector: ".rounded-lg", prop: "border-top-left-radius", equals: "8px", readable: "8 pixels", label: "The notice has 8 pixels" }], hints: [{ level: 1, text: "Add the large corner-radius utility. It goes after p-4." }, { level: 2, text: "Add rounded-lg to the class list." }], xp: 40 }),
    s16({ id: "pharmacy-shelf-border-amber-200", task: "Give the notice a faint amber edge.", inputMode: "guided", files: { "index.html": "<aside class=\"bg-amber-50 text-amber-900 p-4 rounded-lg\">Free shipping on orders over PHP 100</aside>", "styles.css": ".border-amber-200 {\n  border: 1px solid #fde68a;\n}" }, activeFile: "index.html", highlightToken: "rounded-lg", tests: [{ id: "pharmacy-shelf-border-amber-200-class", kind: "source-matches", file: "index.html", pattern: "class=\\\"[^\\\"]*\\bborder-amber-200\\b", flags: "i", because: "Add border-amber-200 to the class list.", label: "The notice has a faint amber edge" }], hints: [{ level: 1, text: "Add the light amber border utility. It goes after rounded-lg." }, { level: 2, text: "Add border-amber-200 to the class list." }], xp: 40 }),
    ...
    s17({ id: "sari-sari-font-semibold", task: "Give the heading more weight.", inputMode: "guided", files: { "index.html": "<article class=\"text-xl\">Fresh Produce</article>", "styles.css": ".font-semibold {\n  font-weight: 600;\n}" }, activeFile: "index.html", highlightToken: "text-xl", tests: [{ id: "sari-sari-font-semibold-style", kind: "style", selector: ".font-semibold", prop: "font-weight", equals: "600", readable: "semibold", label: "The card has semibold" }], hints: [{ level: 1, text: "Add the semibold weight utility. It goes after text-xl." }, { level: 2, text: "Add font-semibold to the class list." }], xp: 40 }),
    s17({ id: "sari-sari-leading-relaxed", task: "Open up the space between lines.", inputMode: "guided", files: { "index.html": "<article class=\"text-xl font-semibold\">Fresh Produce</article>", "styles.css": ".leading-relaxed {\n  line-height: 1.625;\n}" }, activeFile: "index.html", highlightToken: "font-semibold", tests: [{ id: "sari-sari-leading-relaxed-style", kind: "style", selector: ".leading-relaxed", prop: "line-height", equals: "32.5px", readable: "relaxed line spacing", label: "The card has relaxed line spacing" }], hints: [{ level: 1, text: "Add the relaxed line-height utility. It goes after font-semibold." }, { level: 2, text: "Add leading-relaxed to the class list." }], xp: 40 }),
    s17({ id: "sari-sari-tracking-wide", task: "Loosen the letters slightly.", inputMode: "guided", files: { "index.html": "<article class=\"text-xl font-semibold leading-relaxed\">Fresh Produce</article>", "styles.css": ".tracking-wide {\n  letter-spacing: 0.025em;\n}" }, activeFile: "index.html", highlightToken: "leading-relaxed", tests: [{ id: "sari-sari-tracking-wide-style", kind: "style", selector: ".tracking-wide", prop: "letter-spacing", equals: "0.5px", readable: "wide letter spacing", label: "The card has wide letter spacing" }], hints: [{ level: 1, text: "Add the wide letter-spacing utility. It goes after leading-relaxed." }, { level: 2, text: "Add tracking-wide to the class list." }], xp: 40 }),
    s17({ id: "sari-sari-text-center", task: "Centre the heading.", inputMode: "guided", files: { "index.html": "<article class=\"text-xl font-semibold leading-relaxed tracking-wide\">Fresh Produce</article>", "styles.css": ".text-center {\n  text-align: center;\n}" }, activeFile: "index.html", highlightToken: "tracking-wide", tests: [{ id: "sari-sari-text-center-style", kind: "style", selector: ".text-center", prop: "text-align", equals: "center", readable: "centred", label: "The card has centred" }], hints: [{ level: 1, text: "Add the centred text utility. It goes after tracking-wide." }, { level: 2, text: "Add text-center to the class list." }], xp: 40 }),
    ...
    s18({ id: "barangay-health-justify-between", task: "Push the price to the far right.", inputMode: "guided", files: { "index.html": "<div class=\"flex\">Vaccination Drive - PHP 85 per dose</div>", "styles.css": ".justify-between {\n  justify-content: space-between;\n}" }, activeFile: "index.html", highlightToken: "flex", tests: [{ id: "barangay-health-justify-between-style", kind: "style", selector: ".justify-between", prop: "justify-content", equals: "space-between", readable: "pushed apart", label: "The row has pushed apart" }], hints: [{ level: 1, text: "Add the space-between utility. It goes after flex." }, { level: 2, text: "Add justify-between to the class list." }], xp: 40 }),
    s18({ id: "barangay-health-items-center", task: "Line the two up through their middles.", inputMode: "guided", files: { "index.html": "<div class=\"flex justify-between\">Vaccination Drive - PHP 85 per dose</div>", "styles.css": ".items-center {\n  align-items: center;\n}" }, activeFile: "index.html", highlightToken: "justify-between", tests: [{ id: "barangay-health-items-center-style", kind: "style", selector: ".items-center", prop: "align-items", equals: "center", readable: "centred across", label: "The row has centred across" }], hints: [{ level: 1, text: "Add the centred cross-axis utility. It goes after justify-between." }, { level: 2, text: "Add items-center to the class list." }], xp: 40 }),
    s18({ id: "barangay-health-gap-3", task: "Keep a minimum gap between them.", inputMode: "guided", files: { "index.html": "<div class=\"flex justify-between items-center\">Vaccination Drive - PHP 85 per dose</div>", "styles.css": ".gap-3 {\n  gap: 0.75rem;\n}" }, activeFile: "index.html", highlightToken: "items-center", tests: [{ id: "barangay-health-gap-3-style", kind: "style", selector: ".gap-3", prop: "column-gap", equals: "12px", readable: "12 pixels", label: "The row has 12 pixels" }], hints: [{ level: 1, text: "Add the three-step gap utility. It goes after items-center." }, { level: 2, text: "Add gap-3 to the class list." }], xp: 40 }),
    s18({ id: "barangay-health-p-3", task: "Give the row room inside.", inputMode: "guided", files: { "index.html": "<div class=\"flex justify-between items-center gap-3\">Vaccination Drive - PHP 85 per dose</div>", "styles.css": ".p-3 {\n  padding: 0.75rem;\n}" }, activeFile: "index.html", highlightToken: "gap-3", tests: [{ id: "barangay-health-p-3-style", kind: "style", selector: ".p-3", prop: "padding-top", equals: "12px", readable: "12 pixels", label: "The row has 12 pixels" }], hints: [{ level: 1, text: "Add the three-step padding utility. It goes after gap-3." }, { level: 2, text: "Add p-3 to the class list." }], xp: 40 }),
    ...
    s19({ id: "jeepney-route-px-2", task: "Give the badge room on its left and right.", inputMode: "guided", files: { "index.html": "<span class=\"inline-block\">Route 123</span>", "styles.css": ".px-2 {\n  padding-left: 0.5rem;\n  padding-right: 0.5rem;\n}" }, activeFile: "index.html", highlightToken: "inline-block", tests: [{ id: "jeepney-route-px-2-class", kind: "source-matches", file: "index.html", pattern: "class=\\\"[^\\\"]*\\bpx-2\\b", flags: "i", because: "Add px-2 to the class list.", label: "The badge has side padding" }], hints: [{ level: 1, text: "Add the two-step horizontal padding utility. It goes after inline-block." }, { level: 2, text: "Add px-2 to the class list." }], xp: 40 }),
    s19({ id: "jeepney-route-py-1", task: "Give the badge a little room above and below.", inputMode: "guided", files: { "index.html": "<span class=\"inline-block px-2\">Route 123</span>", "styles.css": ".py-1 {\n  padding-top: 0.25rem;\n  padding-bottom: 0.25rem;\n}" }, activeFile: "index.html", highlightToken: "px-2", tests: [{ id: "jeepney-route-py-1-class", kind: "source-matches", file: "index.html", pattern: "class=\\\"[^\\\"]*\\bpy-1\\b", flags: "i", because: "Add py-1 to the class list.", label: "The badge has top and bottom padding" }], hints: [{ level: 1, text: "Add the one-step vertical padding utility. It goes after px-2." }, { level: 2, text: "Add py-1 to the class list." }], xp: 40 }),
    s19({ id: "jeepney-route-rounded-full", task: "Round the badge into a pill shape.", inputMode: "guided", files: { "index.html": "<span class=\"inline-block px-2 py-1\">Route 123</span>", "styles.css": ".rounded-full {\n  border-radius: 9999px;\n}" }, activeFile: "index.html", highlightToken: "py-1", tests: [{ id: "jeepney-route-rounded-full-style", kind: "style", selector: ".rounded-full", prop: "border-top-left-radius", equals: "9999px", readable: "fully rounded ends", label: "The badge has fully rounded ends" }], hints: [{ level: 1, text: "Add the fully-rounded utility. It goes after py-1." }, { level: 2, text: "Add rounded-full to the class list." }], xp: 40 }),
    s19({ id: "jeepney-route-text-sm", task: "Make the badge text smaller than the words around it.", inputMode: "guided", files: { "index.html": "<span class=\"inline-block px-2 py-1 rounded-full\">Route 123</span>", "styles.css": ".text-sm {\n  font-size: 0.875rem;\n}" }, activeFile: "index.html", highlightToken: "rounded-full", tests: [{ id: "jeepney-route-text-sm-style", kind: "style", selector: ".text-sm", prop: "font-size", equals: "14px", readable: "14 pixels", label: "The badge has 14 pixels" }], hints: [{ level: 1, text: "Add the small text-size utility. It goes after rounded-full." }, { level: 2, text: "Add text-sm to the class list." }], xp: 40 }),
    ...
    s20({ id: "palengke-stall-p-4", task: "Give the card room inside.", inputMode: "guided", files: { "index.html": "<article class=\"max-w-sm\">Spacing Guide</article>", "styles.css": ".p-4 {\n  padding: 1rem;\n}" }, activeFile: "index.html", highlightToken: "max-w-sm", tests: [{ id: "palengke-stall-p-4-style", kind: "style", selector: ".p-4", prop: "padding-top", equals: "16px", readable: "16 pixels", label: "The card has 16 pixels" }], hints: [{ level: 1, text: "Add the four-step padding utility. It goes after max-w-sm." }, { level: 2, text: "Add p-4 to the class list." }], xp: 40 }),
    s20({ id: "palengke-stall-mb-6", task: "Leave space below the card.", inputMode: "guided", files: { "index.html": "<article class=\"max-w-sm p-4\">Spacing Guide</article>", "styles.css": ".mb-6 {\n  margin-bottom: 1.5rem;\n}" }, activeFile: "index.html", highlightToken: "p-4", tests: [{ id: "palengke-stall-mb-6-style", kind: "style", selector: ".mb-6", prop: "margin-bottom", equals: "24px", readable: "24 pixels", label: "The card has 24 pixels" }], hints: [{ level: 1, text: "Add the six-step bottom-margin utility. It goes after p-4." }, { level: 2, text: "Add mb-6 to the class list." }], xp: 40 }),
    s20({ id: "palengke-stall-mt-2", task: "Leave a small space above the card.", inputMode: "guided", files: { "index.html": "<article class=\"max-w-sm p-4 mb-6\">Spacing Guide</article>", "styles.css": ".mt-2 {\n  margin-top: 0.5rem;\n}" }, activeFile: "index.html", highlightToken: "mb-6", tests: [{ id: "palengke-stall-mt-2-style", kind: "style", selector: ".mt-2", prop: "margin-top", equals: "8px", readable: "8 pixels", label: "The card has 8 pixels" }], hints: [{ level: 1, text: "Add the two-step top-margin utility. It goes after mb-6." }, { level: 2, text: "Add mt-2 to the class list." }], xp: 40 }),
    s20({ id: "palengke-stall-px-6", task: "Widen the room on the left and right only.", inputMode: "guided", files: { "index.html": "<article class=\"max-w-sm p-4 mb-6 mt-2\">Spacing Guide</article>", "styles.css": ".px-6 {\n  padding-left: 1.5rem;\n  padding-right: 1.5rem;\n}" }, activeFile: "index.html", highlightToken: "mt-2", tests: [{ id: "palengke-stall-px-6-class", kind: "source-matches", file: "index.html", pattern: "class=\\\"[^\\\"]*\\bpx-6\\b", flags: "i", because: "Add px-6 to the class list.", label: "The card has wider side padding" }], hints: [{ level: 1, text: "Add the six-step horizontal padding utility. It goes after mt-2." }, { level: 2, text: "Add px-6 to the class list." }], xp: 40 }),
    ...
    s21({ id: "turo-turo-text-amber-900", task: "Darken the notice words so they have enough contrast.", inputMode: "guided", files: { "index.html": "<aside class=\"bg-amber-50\">Turo-turo Counter Notice</aside>", "styles.css": ".text-amber-900 {\n  color: #78350f;\n}" }, activeFile: "index.html", highlightToken: "bg-amber-50", tests: [{ id: "turo-turo-text-amber-900-style", kind: "style", selector: ".text-amber-900", prop: "color", equals: "rgb(120, 53, 15)", readable: "dark amber", label: "The notice has dark amber" }], hints: [{ level: 1, text: "Add the darkest amber text utility. It goes after bg-amber-50." }, { level: 2, text: "Add text-amber-900 to the class list." }], xp: 40 }),
    s21({ id: "turo-turo-p-4", task: "Give the notice room inside.", inputMode: "guided", files: { "index.html": "<aside class=\"bg-amber-50 text-amber-900\">Turo-turo Counter Notice</aside>", "styles.css": ".p-4 {\n  padding: 1rem;\n}" }, activeFile: "index.html", highlightToken: "text-amber-900", tests: [{ id: "turo-turo-p-4-style", kind: "style", selector: ".p-4", prop: "padding-top", equals: "16px", readable: "16 pixels", label: "The notice has 16 pixels" }], hints: [{ level: 1, text: "Add the four-step padding utility. It goes after text-amber-900." }, { level: 2, text: "Add p-4 to the class list." }], xp: 40 }),
    s21({ id: "turo-turo-rounded-lg", task: "Round the notice corners.", inputMode: "guided", files: { "index.html": "<aside class=\"bg-amber-50 text-amber-900 p-4\">Turo-turo Counter Notice</aside>", "styles.css": ".rounded-lg {\n  border-radius: 0.5rem;\n}" }, activeFile: "index.html", highlightToken: "p-4", tests: [{ id: "turo-turo-rounded-lg-style", kind: "style", selector: ".rounded-lg", prop: "border-top-left-radius", equals: "8px", readable: "8 pixels", label: "The notice has 8 pixels" }], hints: [{ level: 1, text: "Add the large corner-radius utility. It goes after p-4." }, { level: 2, text: "Add rounded-lg to the class list." }], xp: 40 }),
    s21({ id: "turo-turo-border-amber-200", task: "Give the notice a faint amber edge.", inputMode: "guided", files: { "index.html": "<aside class=\"bg-amber-50 text-amber-900 p-4 rounded-lg\">Turo-turo Counter Notice</aside>", "styles.css": ".border-amber-200 {\n  border: 1px solid #fde68a;\n}" }, activeFile: "index.html", highlightToken: "rounded-lg", tests: [{ id: "turo-turo-border-amber-200-class", kind: "source-matches", file: "index.html", pattern: "class=\\\"[^\\\"]*\\bborder-amber-200\\b", flags: "i", because: "Add border-amber-200 to the class list.", label: "The notice has a faint amber edge" }], hints: [{ level: 1, text: "Add the light amber border utility. It goes after rounded-lg." }, { level: 2, text: "Add border-amber-200 to the class list." }], xp: 40 }),
    ...
    s22({ id: "school-notice-font-semibold", task: "Give the heading more weight.", inputMode: "guided", files: { "index.html": "<article class=\"text-xl\">Welcome Notice</article>", "styles.css": ".font-semibold {\n  font-weight: 600;\n}" }, activeFile: "index.html", highlightToken: "text-xl", tests: [{ id: "school-notice-font-semibold-style", kind: "style", selector: ".font-semibold", prop: "font-weight", equals: "600", readable: "semibold", label: "The card has semibold" }], hints: [{ level: 1, text: "Add the semibold weight utility. It goes after text-xl." }, { level: 2, text: "Add font-semibold to the class list." }], xp: 40 }),
    s22({ id: "school-notice-leading-relaxed", task: "Open up the space between lines.", inputMode: "guided", files: { "index.html": "<article class=\"text-xl font-semibold\">Welcome Notice</article>", "styles.css": ".leading-relaxed {\n  line-height: 1.625;\n}" }, activeFile: "index.html", highlightToken: "font-semibold", tests: [{ id: "school-notice-leading-relaxed-style", kind: "style", selector: ".leading-relaxed", prop: "line-height", equals: "32.5px", readable: "relaxed line spacing", label: "The card has relaxed line spacing" }], hints: [{ level: 1, text: "Add the relaxed line-height utility. It goes after font-semibold." }, { level: 2, text: "Add leading-relaxed to the class list." }], xp: 40 }),
    s22({ id: "school-notice-tracking-wide", task: "Loosen the letters slightly.", inputMode: "guided", files: { "index.html": "<article class=\"text-xl font-semibold leading-relaxed\">Welcome Notice</article>", "styles.css": ".tracking-wide {\n  letter-spacing: 0.025em;\n}" }, activeFile: "index.html", highlightToken: "leading-relaxed", tests: [{ id: "school-notice-tracking-wide-style", kind: "style", selector: ".tracking-wide", prop: "letter-spacing", equals: "0.5px", readable: "wide letter spacing", label: "The card has wide letter spacing" }], hints: [{ level: 1, text: "Add the wide letter-spacing utility. It goes after leading-relaxed." }, { level: 2, text: "Add tracking-wide to the class list." }], xp: 40 }),
    s22({ id: "school-notice-text-center", task: "Centre the heading.", inputMode: "guided", files: { "index.html": "<article class=\"text-xl font-semibold leading-relaxed tracking-wide\">Welcome Notice</article>", "styles.css": ".text-center {\n  text-align: center;\n}" }, activeFile: "index.html", highlightToken: "tracking-wide", tests: [{ id: "school-notice-text-center-style", kind: "style", selector: ".text-center", prop: "text-align", equals: "center", readable: "centred", label: "The card has centred" }], hints: [{ level: 1, text: "Add the centred text utility. It goes after tracking-wide." }, { level: 2, text: "Add text-center to the class list." }], xp: 40 }),
    ...
    s23({ id: "tricycle-terminal-justify-between", task: "Push the price to the far right.", inputMode: "guided", files: { "index.html": "<div class=\"flex\">Tricycle Fare - PHP 85</div>", "styles.css": ".justify-between {\n  justify-content: space-between;\n}" }, activeFile: "index.html", highlightToken: "flex", tests: [{ id: "tricycle-terminal-justify-between-style", kind: "style", selector: ".justify-between", prop: "justify-content", equals: "space-between", readable: "pushed apart", label: "The row has pushed apart" }], hints: [{ level: 1, text: "Add the space-between utility. It goes after flex." }, { level: 2, text: "Add justify-between to the class list." }], xp: 40 }),
    s23({ id: "tricycle-terminal-items-center", task: "Line the two up through their middles.", inputMode: "guided", files: { "index.html": "<div class=\"flex justify-between\">Tricycle Fare - PHP 85</div>", "styles.css": ".items-center {\n  align-items: center;\n}" }, activeFile: "index.html", highlightToken: "justify-between", tests: [{ id: "tricycle-terminal-items-center-style", kind: "style", selector: ".items-center", prop: "align-items", equals: "center", readable: "centred across", label: "The row has centred across" }], hints: [{ level: 1, text: "Add the centred cross-axis utility. It goes after justify-between." }, { level: 2, text: "Add items-center to the class list." }], xp: 40 }),
    s23({ id: "tricycle-terminal-gap-3", task: "Keep a minimum gap between them.", inputMode: "guided", files: { "index.html": "<div class=\"flex justify-between items-center\">Tricycle Fare - PHP 85</div>", "styles.css": ".gap-3 {\n  gap: 0.75rem;\n}" }, activeFile: "index.html", highlightToken: "items-center", tests: [{ id: "tricycle-terminal-gap-3-style", kind: "style", selector: ".gap-3", prop: "column-gap", equals: "12px", readable: "12 pixels", label: "The row has 12 pixels" }], hints: [{ level: 1, text: "Add the three-step gap utility. It goes after items-center." }, { level: 2, text: "Add gap-3 to the class list." }], xp: 40 }),
    s23({ id: "tricycle-terminal-p-3", task: "Give the row room inside.", inputMode: "guided", files: { "index.html": "<div class=\"flex justify-between items-center gap-3\">Tricycle Fare - PHP 85</div>", "styles.css": ".p-3 {\n  padding: 0.75rem;\n}" }, activeFile: "index.html", highlightToken: "gap-3", tests: [{ id: "tricycle-terminal-p-3-style", kind: "style", selector: ".p-3", prop: "padding-top", equals: "12px", readable: "12 pixels", label: "The row has 12 pixels" }], hints: [{ level: 1, text: "Add the three-step padding utility. It goes after gap-3." }, { level: 2, text: "Add p-3 to the class list." }], xp: 40 }),
    ...
    s24({ id: "bakery-display-px-2", task: "Give the badge room on its left and right.", inputMode: "guided", files: { "index.html": "<span class=\"inline-block\">Bakery Specials</span>", "styles.css": ".px-2 {\n  padding-left: 0.5rem;\n  padding-right: 0.5rem;\n}" }, activeFile: "index.html", highlightToken: "inline-block", tests: [{ id: "bakery-display-px-2-class", kind: "source-matches", file: "index.html", pattern: "class=\\\"[^\\\"]*\\bpx-2\\b", flags: "i", because: "Add px-2 to the class list.", label: "The badge has side padding" }], hints: [{ level: 1, text: "Add the two-step horizontal padding utility. It goes after inline-block." }, { level: 2, text: "Add px-2 to the class list." }], xp: 40 }),
    s24({ id: "bakery-display-py-1", task: "Give the badge a little room above and below.", inputMode: "guided", files: { "index.html": "<span class=\"inline-block px-2\">Bakery Specials</span>", "styles.css": ".py-1 {\n  padding-top: 0.25rem;\n  padding-bottom: 0.25rem;\n}" }, activeFile: "index.html", highlightToken: "px-2", tests: [{ id: "bakery-display-py-1-class", kind: "source-matches", file: "index.html", pattern: "class=\\\"[^\\\"]*\\bpy-1\\b", flags: "i", because: "Add py-1 to the class list.", label: "The badge has top and bottom padding" }], hints: [{ level: 1, text: "Add the one-step vertical padding utility. It goes after px-2." }, { level: 2, text: "Add py-1 to the class list." }], xp: 40 }),
    s24({ id: "bakery-display-rounded-full", task: "Round the badge into a pill shape.", inputMode: "guided", files: { "index.html": "<span class=\"inline-block px-2 py-1\">Bakery Specials</span>", "styles.css": ".rounded-full {\n  border-radius: 9999px;\n}" }, activeFile: "index.html", highlightToken: "py-1", tests: [{ id: "bakery-display-rounded-full-style", kind: "style", selector: ".rounded-full", prop: "border-top-left-radius", equals: "9999px", readable: "fully rounded ends", label: "The badge has fully rounded ends" }], hints: [{ level: 1, text: "Add the fully-rounded utility. It goes after py-1." }, { level: 2, text: "Add rounded-full to the class list." }], xp: 40 }),
    s24({ id: "bakery-display-text-sm", task: "Make the badge text smaller than the words around it.", inputMode: "guided", files: { "index.html": "<span class=\"inline-block px-2 py-1 rounded-full\">Bakery Specials</span>", "styles.css": ".text-sm {\n  font-size: 0.875rem;\n}" }, activeFile: "index.html", highlightToken: "rounded-full", tests: [{ id: "bakery-display-text-sm-style", kind: "style", selector: ".text-sm", prop: "font-size", equals: "14px", readable: "14 pixels", label: "The badge has 14 pixels" }], hints: [{ level: 1, text: "Add the small text-size utility. It goes after rounded-full." }, { level: 2, text: "Add text-sm to the class list." }], xp: 40 }),
  ],
};
