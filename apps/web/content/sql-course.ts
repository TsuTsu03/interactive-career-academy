...
sqlCourse.steps.push(...([
  {
    "id": "sql-bakery-supplier-list-486",
    "index": 486,
    "task": "Count records for each group label",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use COUNT(*) with GROUP BY to count records per group label."
      },
      {
        "level": 2,
        "text": "The solution groups by group_info.label and counts all matching records."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-bakery-supplier-list-487",
    "index": 487,
    "task": "Sum amount for each group label",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use SUM(record.amount) to calculate total amount per group label."
      },
      {
        "level": 2,
        "text": "The solution groups by group_info.label and sums the amount column."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-bakery-supplier-list-488",
    "index": 488,
    "task": "Keep only group sums above 12 with HAVING",
    "kind": "sql",
    "inputMode": "free",
    ...
    "tests": [
      {
        "id": "result",
        "label": "The result shows only group sums above 12",
        "kind": "sql-rows-equal",
        "rows": [
          [
            "South Team",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Add HAVING to filter groups whose total amount exceeds 12."
      },
      {
        "level": 2,
        "text": "The solution keeps only South Team (25) because it’s the only group above 12."
  ...
  {
    "id": "sql-bakery-supplier-list-489",
    "index": 489,
    "task": "Remove HAVING to restore both groups and sort their sums descending",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Remove HAVING and add ORDER BY total_amount DESC to sort descending."
      },
      {
        "level": 2,
        "text": "The solution restores both groups and sorts South Team (25) first, then North Team (10)."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-bakery-supplier-list-490",
    "index": 490,
    "task": "Limit the restored grouped report to the largest group",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Add LIMIT 1 after ORDER BY to keep only the largest group."
      },
      {
        "level": 2,
        "text": "The solution returns only South Team (25) as the largest group."
...
// Validated local authoring batch: bakery-community-schedule.
sqlCourse.projects.push({"id":"bakery-community-schedule","title":"Bakery Community Schedule"});
sqlCourse.steps.push(...([
  {
    "id": "sql-bakery-community-schedule-491",
    "index": 491,
    "task": "Select the record name and group_id for all bakery items.",
    "kind": "sql",
    "inputMode": "free",
    "files": {
      "query.sql": ""
    ...
    "activeFile": "query.sql",
    "sqlSeed": "CREATE TABLE record (id INTEGER, name TEXT, category TEXT, amount INTEGER, status TEXT, group_id INTEGER);\nINSERT INTO record VALUES (1, 'Pandesal', 'Local', 8, 'Open', 1), (2, 'Ensaymada', 'Regional', 20, 'Done', 2), (3, 'Monay', 'Local', 2, 'Open', 1), (4, 'Hopia', 'Regional', 5, 'Done', NULL);\nCREATE TABLE group_info (id INTEGER, label TEXT);\nINSERT INTO group_info VALUES (1, 'North Team'), (2, 'South Team');",
    "tests": [
      {
        "id": "result",
        "label": "The result contains four rows with name and group_id",
    ...
    "hints": [
      ...
      {
        "level": 2,
        "text": "Use SELECT to fetch these two fields from the record table."
      }
    ],
    "xp": 10,
    "solution": {
    ...
    "estimatedMinutes": 4,
    "projectId": "bakery-community-schedule",
    "conceptIds": [
      "sql-select"
    ]
  },
  {
    "id": "sql-bakery-community-schedule-492",
    "index": 492,
    "task": "LEFT JOIN group_info to show every record with its group label.",
    "kind": "sql",
    "inputMode": "free",
  ...
  {
    "id": "sql-bakery-community-schedule-493",
    "index": 493,
    "task": "Use COALESCE to display 'Unassigned' for missing group labels.",
    "kind": "sql",
    "inputMode": "free",
  ...
  {
    "id": "sql-bakery-community-schedule-494",
    "index": 494,
    "task": "Filter for the row whose group_id is NULL.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "tests": [
      {
        "id": "result",
        "label": "The result contains one row with Hopia and Unassigned",
        "kind": "sql-rows-equal",
        "rows": [
          [
            "Hopia",
    ...
    "hints": [
      ...
      {
        "level": 2,
        "text": "Only Hopia matches this condition."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-bakery-community-schedule-495",
    "index": 495,
    "task": "Switch back to all rows and sort by the displayed group label.",
    "kind": "sql",
    "inputMode": "free",
...
sqlCourse.steps.push(...([
  {
    "id": "sql-bakery-community-schedule-496",
    "index": 496,
    "task": "Count every record after the LEFT JOIN.",
    "kind": "sql",
    "inputMode": "free",
  ...
  {
    "id": "sql-bakery-community-schedule-497",
    "index": 497,
    "task": "Count records per displayed group label.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      ...
      {
        "level": 2,
        "text": "Use COUNT(*) to count records per group, and alias the group_label."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-bakery-community-schedule-498",
    "index": 498,
    "task": "Sum amount per displayed group label.",
    "kind": "sql",
    "inputMode": "free",
  ...
  {
    "id": "sql-bakery-community-schedule-499",
    "index": 499,
    "task": "Keep displayed groups whose sum exceeds 8.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use HAVING to filter groups whose total amount exceeds 8."
      },
      {
        "level": 2,
        "text": "The HAVING clause must follow GROUP BY and use SUM(record.amount) > 8."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-bakery-community-schedule-500",
    "index": 500,
    "task": "Order those group sums descending.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Add ORDER BY total_amount DESC to sort the groups by their sums descending."
      },
      {
        "level": 2,
        "text": "The solution must include the HAVING clause and ORDER BY clause."
      }
    ],
    "xp": 10,
    "solution": {
...
sqlCourse.steps.push(...([
  {
    "id": "sql-bakery-delivery-log-506",
    "index": 506,
    "task": "Insert a new record with id 6, name 'Backup Record', category 'Local', amount 4, status 'Open', group_id 1, then read it.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "tests": [
      {
        "id": "result-6",
        "label": "The INSERT adds id 6 with name 'Backup Record', category 'Local', amount 4, status 'Open', group_id 1, and SELECT returns it.",
        "kind": "sql-row-contains",
        "row": [
          6,
          "Backup Record",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use INSERT INTO record VALUES to add the new row with id 6 and all its fields."
      },
      {
        "level": 2,
        "text": "Then use SELECT with WHERE id = 6 to verify the insertion."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-bakery-delivery-log-507",
    "index": 507,
    "task": "Update only id 6 category to 'Regional', then read it.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "tests": [
      {
        "id": "result-7",
        "label": "The UPDATE changes id 6 category to 'Regional', and SELECT returns it with that category.",
        "kind": "sql-row-contains",
        "row": [
          6,
          "Backup Record",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use UPDATE record SET category = 'Regional' WHERE id = 6 to change only the category of id 6."
      },
      {
        "level": 2,
        "text": "Then SELECT WHERE id = 6 to verify the change."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-bakery-delivery-log-508",
    "index": 508,
    "task": "Delete only id 1, then read remaining rows.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "tests": [
      {
        "id": "result-8",
        "label": "The DELETE removes id 1, and SELECT returns remaining rows: id 2, 3, 4, 6 with their data.",
        "kind": "sql-rows-equal",
        "rows": [
          [
            2,
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use DELETE FROM record WHERE id = 1 to remove only id 1."
      },
      {
        "level": 2,
        "text": "Then SELECT * to verify the deletion and remaining rows."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-bakery-delivery-log-509",
    "index": 509,
    "task": "Count all remaining rows after deletion.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "tests": [
      {
        "id": "result-9",
        "label": "The COUNT returns 4, matching the remaining rows after deleting id 1.",
        "kind": "sql-value-equals",
        "row": 0,
        "column": 0,
        "value": 4
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use SELECT COUNT(*) FROM record to count all rows after deletion."
      },
      {
        "level": 2,
        "text": "The result should be 4, since id 1 was removed from 5 original rows."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-bakery-delivery-log-510",
    "index": 510,
    "task": "Show remaining names and amounts sorted by amount ascending.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "tests": [
      {
        "id": "result-10",
        "label": "The SELECT returns names and amounts sorted by amount ascending: Monay 2, Backup Record 4, New Record 9, Ensaymada 20.",
        "kind": "sql-rows-equal",
        "rows": [
          [
            "Monay",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use SELECT name, amount FROM record ORDER BY amount ASC to sort by amount ascending."
      },
      {
        "level": 2,
        "text": "The result should list Monay (2), Backup Record (4), New Record (9), Ensaymada (20)."
      }
    ],
    "xp": 10,
    "solution": {
...
// Validated local authoring batch: rice-mill-service-queue.
sqlCourse.projects.push({"id":"rice-mill-service-queue","title":"Rice Mill Service Queue"});
sqlCourse.steps.push(...([
  {
    "id": "sql-rice-mill-service-queue-531",
    "index": 531,
    "task": "Select the name and status of all records in the rice mill service queue.",
    "kind": "sql",
    "inputMode": "free",
    "files": {
      "query.sql": ""
    ...
    "tests": [
      {
        "id": "result",
        "label": "The report shows name and status for all records",
        "kind": "sql-rows-equal",
        "rows": [
          [
            "Dinorado",
    ...
    "estimatedMinutes": 4,
    "projectId": "rice-mill-service-queue",
    "conceptIds": [
      "sql-select"
    ]
  },
  {
    "id": "sql-rice-mill-service-queue-532",
    "index": 532,
    "task": "Filter the report to show only records with status 'Open'.",
    "kind": "sql",
    "inputMode": "free",
    "files": {
      "query.sql": "SELECT name, status FROM record;"
    ...
    "tests": [
      {
        "id": "result",
        "label": "The report shows only Open records",
        "kind": "sql-rows-equal",
        "rows": [
          [
            "Dinorado",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use WHERE to filter rows by status."
      },
      {
        "level": 2,
        "text": "Only include rows where status equals 'Open'."
  ...
  {
    "id": "sql-rice-mill-service-queue-533",
    "index": 533,
    "task": "Filter the report to show only records with amount less than or equal to 8.",
    "kind": "sql",
    "inputMode": "free",
    "files": {
      "query.sql": "SELECT name, status FROM record WHERE status = 'Open';"
    ...
    "tests": [
      {
        "id": "result",
        "label": "The report shows only records with amount <= 8",
        "kind": "sql-rows-equal",
        "rows": [
          [
            "Dinorado",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use WHERE to filter rows by amount."
      },
      {
        "level": 2,
        "text": "Only include rows where amount is less than or equal to 8."
  ...
  {
    "id": "sql-rice-mill-service-queue-534",
    "index": 534,
    "task": "Filter the report to show only records that are 'Open' AND have amount <= 8.",
    "kind": "sql",
    "inputMode": "free",
    "files": {
      "query.sql": "SELECT name, status FROM record WHERE amount <= 8;"
    ...
    "tests": [
      {
        "id": "result",
        "label": "The report shows only Open records with amount <= 8",
        "kind": "sql-rows-equal",
        "rows": [
          [
            "Dinorado",
  ...
  {
    "id": "sql-rice-mill-service-queue-535",
    "index": 535,
    "task": "Filter the report to show records that are 'Done' OR have amount less than 3.",
    "kind": "sql",
    "inputMode": "free",
    "files": {
      "query.sql": "SELECT name, status FROM record WHERE status = 'Open' AND amount <= 8;"
    ...
    "tests": [
      {
        "id": "result",
        "label": "The report shows Done records or those with amount < 3",
        "kind": "sql-rows-equal",
        "rows": [
          [
            "Sinandomeng",
...
sqlCourse.steps.push(...([
  {
    "id": "sql-rice-mill-service-queue-536",
    "index": 536,
    "task": "Select the name and status of all records in the rice mill service queue.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "xp": 10,
    "solution": {
      "query.sql": "SELECT name FROM record WHERE name LIKE 'D%';"
    },
    "estimatedMinutes": 4,
    "projectId": "rice-mill-service-queue",
    "conceptIds": [
  ...
  {
    "id": "sql-rice-mill-service-queue-537",
    "index": 537,
    "task": "Filter the report to show only records with status 'Open'.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "tests": [
      {
        "id": "result",
        "label": "The report shows only records with status 'Open'",
        "kind": "sql-rows-equal",
        "rows": [
          [
            "Dinorado",
  ...
  {
    "id": "sql-rice-mill-service-queue-538",
    "index": 538,
    "task": "Filter the report to show only records with amount less than or equal to 8.",
    "kind": "sql",
    "inputMode": "free",
  ...
  {
    "id": "sql-rice-mill-service-queue-539",
    "index": 539,
    "task": "Filter the report to show only records that are 'Open' AND have amount <= 8.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "tests": [
      {
        "id": "result",
        "label": "The report shows only records that are 'Open' AND have amount <= 8",
        "kind": "sql-rows-equal",
        "rows": [
          [
            "Sinandomeng",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use the AND operator to combine two conditions."
      },
      {
        "level": 2,
        "text": "Only include rows where status is 'Open' AND amount is less than or equal to 8."
  ...
  {
    "id": "sql-rice-mill-service-queue-540",
    "index": 540,
    "task": "Filter the report to show records that are 'Done' OR have amount less than 3.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use the OR operator to combine two conditions."
      },
      {
        "level": 2,
        "text": "Only include rows where status is 'Done' OR amount is less than 3."
...
sqlCourse.projects.push({"id":"rice-mill-supplier-list","title":"Rice Mill Supplier List"});
sqlCourse.steps.push(...([
  {
    "id": "sql-rice-mill-supplier-list-541",
    "index": 541,
    "task": "Count all supplier records in the rice mill database.",
    "kind": "sql",
    "inputMode": "free",
    "files": {
      "query.sql": ""
    ...
    "hints": [
      ...
      {
        "level": 2,
        "text": "The result is a single scalar value, not a list of rows."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-rice-mill-supplier-list-542",
    "index": 542,
    "task": "Name the count as record_count for clarity in reports.",
    "kind": "sql",
    "inputMode": "free",
  ...
  {
    "id": "sql-rice-mill-supplier-list-543",
    "index": 543,
    "task": "Calculate the total amount spent by all suppliers.",
    "kind": "sql",
    "inputMode": "free",
    "files": {
      "query.sql": "SELECT COUNT(*) AS record_count FROM record;"
    ...
    "hints": [
      ...
      {
        "level": 2,
        "text": "The result is a single scalar value named total_amount."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-rice-mill-supplier-list-544",
    "index": 544,
    "task": "Calculate the average amount per supplier.",
    "kind": "sql",
    "inputMode": "free",
    "files": {
      "query.sql": "SELECT SUM(amount) AS total_amount FROM record;"
    ...
    "hints": [
      ...
      {
        "level": 2,
        "text": "The result is a single scalar value named average_amount."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-rice-mill-supplier-list-545",
    "index": 545,
    "task": "Group suppliers by category and count how many are in each category.",
    "kind": "sql",
    "inputMode": "free",
    "files": {
      "query.sql": "SELECT AVG(amount) AS average_amount FROM record;"
    ...
    "tests": [
      {
        "id": "grouped-count",
        "label": "Local has 2 suppliers and Regional has 2",
        "kind": "sql-rows-equal",
        "rows": [
          [
            "Local",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use GROUP BY category to group suppliers by their category."
      },
      {
        "level": 2,
        "text": "Use COUNT(*) to count suppliers in each group."
      }
    ],
    "xp": 10,
    "solution": {
...
// Validated local authoring batch: rice-mill-community-schedule.
sqlCourse.projects.push({"id":"rice-mill-community-schedule","title":"Rice Mill Community Schedule"});
sqlCourse.steps.push(...([
  {
    "id": "sql-rice-mill-community-schedule-551",
    "index": 551,
    "task": "Read record.name and record.group_id with qualified names",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use qualified column names like record.name and record.group_id."
      },
      {
        "level": 2,
        "text": "Select only the name and group_id columns from the record table."
    ...
    "estimatedMinutes": 4,
    "projectId": "rice-mill-community-schedule",
    "conceptIds": [
      "sql-select"
    ]
  },
  {
    "id": "sql-rice-mill-community-schedule-552",
    "index": 552,
    "task": "Join group_info on matching group ids and show record name plus group label",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      ...
      {
        "level": 2,
        "text": "Select record.name and group_info.label to show the name and group label."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-rice-mill-community-schedule-553",
    "index": 553,
    "task": "Add record.amount to the joined result",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Add record.amount to the SELECT list to include the amount."
      },
      {
        "level": 2,
        "text": "Keep the JOIN condition unchanged to maintain the relationship."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-rice-mill-community-schedule-554",
    "index": 554,
    "task": "Filter joined rows to amount <= 10",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      ...
      {
        "level": 2,
        "text": "Only rows with amount 8, 2, and 5 should remain."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-rice-mill-community-schedule-555",
    "index": 555,
    "task": "Sort filtered joined rows by amount ascending",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Add ORDER BY record.amount ASC to sort the filtered rows by amount ascending."
      },
      {
        "level": 2,
        "text": "The smallest amount (2) should come first, then 5, then 8."
      }
    ],
    "xp": 10,
    "solution": {
...
sqlCourse.steps.push(...([
  {
    "id": "sql-rice-mill-community-schedule-556",
    "index": 556,
    "task": "Count records for each group label",
    "kind": "sql",
    "inputMode": "free",
  ...
  {
    "id": "sql-rice-mill-community-schedule-557",
    "index": 557,
    "task": "Sum amount for each group label",
    "kind": "sql",
    "inputMode": "free",
  ...
  {
    "id": "sql-rice-mill-community-schedule-558",
    "index": 558,
    "task": "Keep only group sums above 12 with HAVING",
    "kind": "sql",
    "inputMode": "free",
  ...
  {
    "id": "sql-rice-mill-community-schedule-559",
    "index": 559,
    "task": "Remove HAVING to restore both groups and sort their sums descending",
    "kind": "sql",
    "inputMode": "free",
  ...
  {
    "id": "sql-rice-mill-community-schedule-560",
    "index": 560,
    "task": "Limit the restored grouped report to the largest group",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Add LIMIT 1 to return only the top row."
      },
      {
        "level": 2,
        "text": "The largest group is South Team with 25."
...
// Validated local authoring batch: rice-mill-delivery-log.
sqlCourse.projects.push({"id":"rice-mill-delivery-log","title":"Rice Mill Delivery Log"});
sqlCourse.steps.push(...([
  {
    "id": "sql-rice-mill-delivery-log-561",
    "index": 561,
    "task": "Select the record name and group_id for all delivery records.",
    "kind": "sql",
    "inputMode": "free",
    "files": {
      "query.sql": ""
    ...
    "activeFile": "query.sql",
    "sqlSeed": "CREATE TABLE record (id INTEGER, name TEXT, category TEXT, amount INTEGER, status TEXT, group_id INTEGER);\nINSERT INTO record VALUES (1, 'Dinorado', 'Local', 8, 'Open', 1), (2, 'Sinandomeng', 'Regional', 20, 'Done', 2), (3, 'Malagkit', 'Local', 2, 'Open', 1), (4, 'Brown Rice', 'Regional', 5, 'Done', NULL);\nCREATE TABLE group_info (id INTEGER, label TEXT);\nINSERT INTO group_info VALUES (1, 'North Team'), (2, 'South Team');",
    "tests": [
      {
        "id": "result",
        "label": "The result contains four rows with name and group_id",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Choose the name and group_id fields from the record table."
      },
      {
        "level": 2,
        "text": "Use SELECT to fetch these two columns from the record table."
    ...
    "estimatedMinutes": 4,
    "projectId": "rice-mill-delivery-log",
    "conceptIds": [
      "sql-select"
    ]
  },
  {
    "id": "sql-rice-mill-delivery-log-562",
    "index": 562,
    "task": "LEFT JOIN group_info to show every record with its group label.",
    "kind": "sql",
    "inputMode": "free",
  ...
  {
    "id": "sql-rice-mill-delivery-log-563",
    "index": 563,
    "task": "Use COALESCE to display 'Unassigned' for missing group labels.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use COALESCE to replace NULL with 'Unassigned' for missing labels."
      },
      {
        "level": 2,
        "text": "Alias the new column as group_label."
  ...
  {
    "id": "sql-rice-mill-delivery-log-564",
    "index": 564,
    "task": "Filter for the row whose group_id is NULL to show only unassigned records.",
    "kind": "sql",
    "inputMode": "free",
    "files": {
      "query.sql": "SELECT record.name, COALESCE(group_info.label, 'Unassigned') AS group_label FROM record LEFT JOIN group_info ON group_info.id = record.group_id;"
    ...
    "hints": [
      ...
      {
        "level": 2,
        "text": "Only Brown Rice should appear in the result."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-rice-mill-delivery-log-565",
    "index": 565,
    "task": "Switch back to all rows and sort by the displayed group label.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      ...
      {
        "level": 2,
        "text": "Add ORDER BY group_label ASC to sort the results alphabetically."
      }
    ],
    "xp": 10,
    "solution": {
...
sqlCourse.steps.push(...([
  {
    "id": "sql-rice-mill-delivery-log-566",
    "index": 566,
    "task": "Count every record after the LEFT JOIN.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      ...
      {
        "level": 2,
        "text": "The solution is a single SELECT with no WHERE or GROUP BY."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-rice-mill-delivery-log-567",
    "index": 567,
    "task": "Count records per displayed group label.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      ...
      {
        "level": 2,
        "text": "Use COUNT(*) to count records in each group, and alias it as record_count."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-rice-mill-delivery-log-568",
    "index": 568,
    "task": "Sum amount per displayed group label.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Use SUM(record.amount) to calculate the total amount for each group."
      },
      {
        "level": 2,
        "text": "Group by the displayed group label using GROUP BY group_label."
  ...
  {
    "id": "sql-rice-mill-delivery-log-569",
    "index": 569,
    "task": "Keep displayed groups whose sum exceeds 8.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "tests": [
      {
        "id": "result",
        "label": "The result contains two rows: North Team 10, South Team 20",
        "kind": "sql-rows-equal",
        "rows": [
          [
            "North Team",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Add HAVING SUM(record.amount) > 8 to filter groups whose total exceeds 8."
      },
      {
        "level": 2,
        "text": "The HAVING clause filters groups after GROUP BY, not before."
      }
    ],
    "xp": 10,
    "solution": {
  ...
  {
    "id": "sql-rice-mill-delivery-log-570",
    "index": 570,
    "task": "Order those group sums descending.",
    "kind": "sql",
    "inputMode": "free",
    ...
    "tests": [
      {
        "id": "result",
        "label": "The result contains two rows: South Team 20, North Team 10",
        "kind": "sql-rows-equal",
        "rows": [
          [
            "South Team",
    ...
    "hints": [
      {
        "level": 1,
        "text": "Add ORDER BY total_amount DESC to sort the groups by total amount descending."
      },
      {
        "level": 2,
        "text": "The ORDER BY clause sorts the final result after HAVING and GROUP BY."
      }
    ],
    "xp": 10,
    "solution": {
